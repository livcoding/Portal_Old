...
int SrNo=0;
	...
	{
		SrNo++;
		qrydebar="SELECT 'Y' FROM DEBARSTUDENTDETAIL WHERE INSTITUTECODE ='"+ mInst +"'   and STUDENTID='"+mChkMemID+"'  AND EXAMCODE='"+mPrevExmCode+"'   AND  SUBJECTID='"+StudentRecordSet.getString("subjectid")+"'  AND NVL(DEBAR,'N')='Y'   AND NVL(REGISTEREDSTATUS,'N')='N'";
