...
<html>
		<head>
            ...
            <script src="../js/IQTest/WorkshopReport.js"></script>
            </head>
        <body>
        <!-- Above Is  to handle  the session values   -->
				<div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:95px" >
                    <FONT SIZE="2" COLOR="black" style="margin-left:70%">
                         ...
                         <FONT SIZE="2" COLOR="black" style="margin-left:14%" >Frequency-Every Semester Jan/July</FONT><br>
                          ...
                          <B><FONT SIZE="4" COLOR="black" >Performa for approval of VC for Conducting Workshops/Courses/Guest Lectures/FDP</FONT></B>
                ...
                <tr>
                    ...
                    <td>
                    <select  name='department' id='department'  class='combo' style='width:100%'  title='Department Code'>
