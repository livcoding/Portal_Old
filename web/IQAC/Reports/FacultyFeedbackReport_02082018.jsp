<%-- 
    Document   : FacultyFeedbackReport
    Created on : Apr 29, 2015, 12:51:07 PM
...
<html>
    ...
    <body>
        ...
        <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:95px;" >
            ...
            <B><FONT SIZE="4" COLOR="black" style="margin-left:30%;">Academic(Teaching and Learning)</FONT><FONT SIZE="2" COLOR="black" style="margin-left:18%">Date-<%=mTime1%></FONT></B><br>
        ...
        <div style="width: 90%; padding: 10px ;border: .3em solid;border-radius: 25px;margin-left:4%" >
            <table  id="commonmasterid" style="text-align: left;font-size: 18px; border:1px;width:90%">
                <tr>
                    ...
                    <td width="40%">
                        <select  name='facultyfeedbackid' id='facultyfeedbackid'  class='combo' style='width:100%'  title='Feedback ID'>
                            <option value="">Select Feedback ID</option>
                            <%
        qry = "select distinct nvl(feedbackid,' ') feedbackid from AP#FACULTYFEEDBACK b where entryby='" + mDMemberID + "' ";
        rs = db.getRowset(qry);
        while (rs.next()) {
                            %>
                            <option value="<%=rs.getString("feedbackid")%>"><%=rs.getString("feedbackid")%></option>
                            <%
        }
                            %>
                        </select>
                    </td>
                    <td width="10%" align="right" nowrap>Examcode<span class="req"> *</span> :</td>
                    <td width="40%">
                        <select  name='examcode' id='examcode'  class='combo' style='width:100%'  title='Feedback ID'>
                ...
                <tr>
                    ...
                    <td width="40%">
                        <select  name='subject' id='facultyfeedbacksubject'  class='combo' style='width:100%'  title='Subject'>
                ...
                <tr>
                    <td style="text-align: right;" width="100%" colspan="4" nowrap>
                        <button name="submitbutton_FacultyFeedback" id="submitbutton_FacultyFeedback"  class="button" style="width:120px;height:25px;margin-left:140px;">Generate Report</button>
                    </td>
                </tr>
            </table>
        </div>
