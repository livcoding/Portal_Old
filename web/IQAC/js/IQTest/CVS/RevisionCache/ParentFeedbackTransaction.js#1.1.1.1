   ...
   $.ajax({
        ...
        success:function(p){
            ...
            try{
                ...
                {
                   //alert(JSON.stringify(e[k].userremarks));
                   ...
                   if(heading=="N"){
                        ...
                        if(e[k].subjective=='Y')
                        {
                           // alert(JSON.stringify(e[k]));
                            ...
                            grid=grid+"<input type='hidden' name='ratingid"+k+"' id='ratingid"+(k+1)+"' value="+e[k].ratingid+">";
                        }
                        ...
                        ratingcombo=ratingcombo+"<option   value=''>Select Rating</option>";
                            ...
                            grid=grid+"<td style='width: 20%' align='left'>"+ratingcombo+"<input type='hidden' name='ratingid"+k+"' id='ratingid"+(k+1)+"' value="+e[k].ratingid+"></td>";
...
function saveData(){
    ...
    for(var i=1;i<=eval(len.l);i++){
      ...
      //  alert("Quest ID >>>> "+mdata["questid"]+"RATING ID >>>> "+mdata["ratingid"]+"");
        jdata[i]=mdata;
...
//return false;
  ...
  var encoded = encodeURIComponent(JSON.stringify(jdata));
         ...
         //var jsondata=JSON.stringify(jdata).replace(/{/g,"opencurly");
         //    jsondata=jsondata.replace(/}/g,"closecurly");

//alert(jsondata);

$.ajax({
        url:"/rest/IQACFormServices/saverecords?griddata="+encoded+"",
        type:"put",
