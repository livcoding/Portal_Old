        ...
        <form name="masterform" >
            ...
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    ...
                    <tr>
                         <td style="text-align: right">First Year(Amount) :</td><td style="text-align: left"><input type='text' name='one' id='one'  value='' maxlength='5' class='number' style='width: 90px;' title='first Year'/></td>
                        <td style="text-align: right">Second Year(Amount) :</td><td style="text-align: left"><input type='text' name='two' id='two'  value='' maxlength='5' class='number' style='width: 90px;' title='Second Year'/></td>
                        <td style="text-align: right">Third Year(Amount) :</td><td style="text-align: left"><input type='text' name='three' id='three'  value='' maxlength='5' class='number' style='width: 90px;' title='Third Year'/></td>
