...
$(document).ajaxComplete(function(event, xhr, settings) {
    switch (settings.handller) {
        case 'selectDataForUpgrade':
           ...
           // $("#semester").val(SelectData["semester"]);
...
{
    jData = {};
    jData.service = "TrusteeFeedbackTransactionServlet";
...
function getGridData()
{
   ...
   $("#gridhead").html("");
    ...
    for (var key in gridData) {
       ...
       // table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 10%'>" + gridData[key]["questionid"] + "</td><td  style='width: 32%'>" + gridData[key]["questionbody"] + "</td><td  style='width: 28%'></td><td  style='width: 20%'></td>";   
        table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 50%'>" + gridData[key]["questionbody"] + "</td><td  style='width: 45%'></td>";   
        }else{
        //table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 10%'>" + gridData[key]["questionid"] + "</td><td  style='width: 32%'>" + gridData[key]["questionbody"] + "</td><td  style='width: 28%'>"+getRating(gridData["rating"][gridData[key]["ratingid"]],key)+"</td><td  style='width: 20%'><input type='text' class='textbox' id='remarks"+key+"' style='width:75%' maxlength='100'></td>";
         if(gridData[key]["color"]=="blue"){
              if(gridData[key]["mandatoryQuestion"]=='Y'){
         table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 50%;color:blue'>" + gridData[key]["questionbody"] + "<span class='req'> *</span></td><td  style='width: 45%'>"+getRating(gridData["rating"][gridData[key]["ratingid"]],key)+"</td></td>";
              }else
                  {
          table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 50%;color:blue'>" + gridData[key]["questionbody"] + "</td><td  style='width: 45%'>"+getRating(gridData["rating"][gridData[key]["ratingid"]],key)+"</td></td>";             
                  }
                    }else
             {
                  if(gridData[key]["mandatoryQuestion"]=='Y'){
          table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 50%'>" + gridData[key]["questionbody"] + "<span class='req'> *</span></td><td  style='width: 45%'>"+getRating(gridData["rating"][gridData[key]["ratingid"]],key)+"</td></td>";       
                  }else{
          table = table + "<tr><td  style='width: 5%'>" + gridData[key]["slno"] + "</td><td  style='width: 50%'>" + gridData[key]["questionbody"] + "</td><td  style='width: 45%'>"+getRating(gridData["rating"][gridData[key]["ratingid"]],key)+"</td></td>";                   
                  }
                    }
...
function formsubmit()
{
    ...
    if (jQuery.trim($('#programName').val()) == 0) {
        alert("Please Select the Program Name.");
        $('#programName').focus();
        return false;
    }
...
function getSelectGridData()
{
  $("#lowerGrid").yattable({
    ...
    var table = "";
   $("#gridLower").html("");
     // $("#gridLower").html("<th style='width: 19%'>Feedback ID</th><th style='width: 19%'>Program Name</th><th style='width: 19%'>Semester</th><th style='width: 19%'>Academic Year</th><th style='width: 19%'>Remarks</th><th style='width: 5%'></th>");
      $("#gridLower").html("<th style='width: 33%'>Feedback ID</th><th style='width: 31%'>Academic Year</th><th style='width: 31%'>Remarks</th><th style='width: 5%'></th>");
    for (var key in lowerGridData) {
        ...
        table = table + "<tr><td  style='width: 33%'>" + lowerGridData[key]["feedbackid"] + "</td><td  style='width: 31%'>"+lowerGridData[key]["academicyear"]+"</td><td  style='width: 31%'>"+rMarks+"</td>";   
