<%-- 
    ...
    Created on : Jun 26, 2015, 10:30:25 AM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/eventMasterJS.js"></script>
        <script>
...
$("#eventFromDate").datepicker({
        ...
        onSelect: function(selected) {
          ...
          $("#eventToDate").datepicker("option","minDate", selected)
        }
    });
    $("#eventToDate").datepicker({ 
       ...
       dateFormat: 'dd-mm-yy',
        onSelect: function(selected) {
           $("#eventFromDate").datepicker("option","maxDate", selected)
        }
    });  
            });
        </script>
    ...
    <body >
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
        ...
        <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:28px " >Event Master</div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        <td style="text-align: right">Category Name<span class="req"> *</span> :</td><td style="text-align: left"><select  name='categoryName' id='categoryName'  class='combo' style=''  title='Category Name' onchange="getFormInfo()"><%=ccd.commonJspCombo("{\"comboId\":\"categorycombo\"}")%></select></td>
                        <td style="text-align: right">Form Name<span class="req"> *</span> :</td><td style="text-align: left"><select  name='formName' id='formName'  class='combo' style=''  title='Form Name'></select></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: right">Event Code<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='eventCode' id='eventCode' value='' maxlength='20' class='textbox'  title='Event Code'/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">Event From Date<span class="req"> *</span> :</td><td style="text-align: left"><input type='text' name='eventFromDate' id='eventFromDate'  value='' maxlength='100' class='textbox' style='width: 90px;' title='Event From Date' readonly /></td>
                        <td style="text-align: right">Event To Date<span class="req"> *</span> :</td><td style="text-align: left"><input type='text' name='eventToDate' id='eventToDate'  value='' maxlength='100' class='textbox' style='width: 90px;' title='Event To Date' readonly /></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">Event Description<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='eventDescription' id='eventDescription' value='' maxlength='100' class='textbox'  title='Event Description'/></td>
