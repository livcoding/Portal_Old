<%--
    Document   : publicationTransaction
    Created on : Apr 24, 2015, 2:13:45 PM
    Author     : nipun.gupta
--%>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            #lowerGrid :hover, .applicantclass:focus, .applicantclass:active   {
                background: skyblue !important;}
            #authorNameTable  tr:nth-child(even) {background: #F8F8F8;cursor:pointer;padding:8px; border:#999 1px solid; }
            #authorNameTable tr:nth-child(odd) {background: 	#EBF5FF;cursor:pointer;padding:8px; border:#999 1px solid; }
            #authorNameTable :hover, .highlight:focus,highlight:active   {
                background: skyblue !important;}
        </style>
        ...
        <script src="../js/IQTest/publicationTransactionJS.js"></script>
        <script>
    ...
    <body >
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
        ...
        <form name="masterform" >
            ...
            <input type="hidden" id="staffType"  value=""/>
            <input type="hidden" id="entryBy"  value="<%=mChkMemID%>"/>

            <!-- Above Is  to handle  the session values   -->
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 60%;float: left;text-align: right;font-size: large">Publication Transaction(Summary)Details</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-AR-1]</div></div>
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" >
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        <td style="text-align: right">Transaction Date<span class="req"> *</span> :</td><td style="text-align: left"><input type='text' name='transactionDate' id='transactionDate'  value='' maxlength='100' class='date' style='' title='Transaction Date' onchange="getLowerGridData()" readonly/></td>
                        <td style="text-align: right">Publication Type<span class="req"> *</span> :</td><td style="text-align: left"><select  name='publicationType' id='publicationType'  class='combo' style=''  title='Publication Type' ><%=ccd.commonJspCombo("{\"comboId\":\"publicationTypeCombo1\"}")%></select></td>
                    </tr>

                   <tr>
                     <td style="text-align: right">Complete Reference <span class="req"> *</span>:</td><td style="text-align: left"><input type="text"  name='completeReference' id='completeReference' maxlength="500"  class='textbox' style=''  title='Complete Reference' onKeyPress="return charMax()"></td>  
                     
                    </tr>

                    <tr>
                        <td style="text-align: right">Indexing Body<span class="req"> *</span> :</td><td style="text-align: left"><select  name='indexingBody' id='indexingBody'  class='combo' style=''  title='Indexing Body'><%=ccd.commonJspCombo("{\"comboId\":\"indexingBodyCombo\"}")%></select></td>
                        <td style="text-align: right">Publication Year<span class="req"> *</span> :</td><td style="text-align: left"><input type="text"  name='publicationYear' id='publicationYear' maxlength="4"  class='nondecimal' style=''  title='Publication Year' /></td>
                    </tr>

                    <tr>
                        <td style="text-align: right">Impact Factor<span class="req"> *</span> :</td><td style="text-align: left"><select  name='impactFactor' id='impactFactor'  class='combo' style=''  title='Impact Factor' >
                                <option value="0">Select Impact Factor</option>
                                <option value="J">JCR</option>
                                <option value="S">SJR</option>
                                <option value="P">SNIP</option>
                            </select></td>
                            <td style="text-align: right">Impact Factor Value<span class="req"> *</span>:</td><td style="text-align: left"><input type="text"  name='impactFactorValue' id='impactFactorValue' maxlength="7"  class='number' style=''  title='Impact Factor Value'></td>
                  
                      </tr>

                  <tr>
                      <td style="text-align: right">ISSN/ISBN :</td><td style="text-align: left"><input type="text"  name='intpub' id='intpub' maxlength="100"  class='textbox' style=''  title='ISSN' /></td>
                       <td style="text-align: right">H-index For Journal Conf.<span class="req"> *</span> :</td><td style="text-align: left"><input type="text"  name='hindex' id='hindex' maxlength="20"   style=''  title='IndexName' /></td>
                      </tr>
                        ...
                        <div style="height: 150px;" >
                            <table id="PublicationTransactionTable" style="width: 100%;font-size: 18px;text-align: center;">
                                <tr class="_thead">

                                    <th style="width:5%;word-spacing:normal">S No.</th>
                                    <th style="width:30%">Author Names</th>
                                    <th style="width:30%">Department Name</th>
                                    <th style="width:30%">Author Type</th>
                                    <th style="width:5%"><img src="../js/jquery/add.png" title="Add New Row" style="cursor:pointer" class="addPublicationTransactionRow" id="addPublicationTransactionRow1"/></th>

                                </tr>
                                <tbody class="publicationTransactionRow1">
                                    <tr>
                                        <td id="row1">1.</td>
                                <input type="hidden" name="staffID" id="staffID1" value="0" maxlength="20" class="textbox" style="width:90%" />
                                <input type="hidden" name="departmentCode" id="departmentCode1" value="" maxlength="20" class="textbox" style="width:90%" />
                                <input type="hidden" name="staffType" id="staffType1" value="" maxlength="20" class="textbox" style="width:90%" />
                                <td><input type="text" name="authorName" id="authorName1" value="" maxlength="100" class="textbox" style="width:90%" readonly /></td>
                                <td><input type="text" name="departmentName" id="departmentName1" value="" maxlength="100" class="textbox" style="width:85%" readonly /></td>
                                <td><input type="text" name="authorType" id="authorType1" value="" maxlength="100" class="textbox" style="width:85%" readonly /></td>
                                <td><img src="../js/jquery/minus.png"  title="Delete Current Row" style="cursor:pointer" class="dPublicationTransactionRow" id="dPublicationTransactionRow1"/></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
            <div class="ui-widget-header ui-corner-all" style="text-align:left;width:100%;" id="finaldivsave">
                ...
                <input type="button" title='Save Record'  class="button" id="okForm" style="cursor:pointer;margin-left: 70%" onclick="validateData()" value="OK">
           ...
           <div id="authorNames" title="Author Names" style="overflow: auto;height: 300px">
                ...
                Search:<input type="text" id="searchNames">
                     <select name="member" id="member" style="text-align:left" onchange="getOtherFacInfo()">
                    <option value="F">Faculty</option>
                    <option value="O">Others</option>
                </select>
                <span id="TOTAL" style="font-size:13px;alignment-adjust: auto;padding-left: 20%"> </span>
                <span id="TOTAL" style="font-size:13px;alignment-adjust: auto;padding-left: 20%"> </span>
                <select id="paggingPopUp"   onchange="getAuthorNames(0)"  style="text-align:left" ></select>
            </div>
                <table style="width: 100%;font-size: 18px;text-align: center;" id="popupHeaderTable">
                <thead id="popupHeader">
                </thead>
            </table>
                <table style="width: 100%;font-size: 18px;" id="authorNameTable">
                <tbody id="authorNameBody">
                    <tr></tr>
                </tbody>
            </table>
        </div>
