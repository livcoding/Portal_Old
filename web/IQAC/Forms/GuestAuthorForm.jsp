<%-- 
    Document   : GuestAuthorForm
    Created on : Jun 30, 2017, 11:27:14 AM
...
<html>
    <head>
        ...
        <script src="../js/IQTest/GuestAuthorFormJS.js"></script>>
        <script>
            $(document).ready(function(){
                getCommanMasterTable();
          // alert("JSP");
            } );
    ...
    <%
        ...
        String mMemberCode = "";
        String mRightsID = "";
        //mInst InstituteCode mComp CompanyCode mLoginComp LoginComp mMemberID MemberID mMemberType MemberType  mMemberName MemberName mMemberCode MemberCode mSrcType SrcType
    ...
    %>
    <body>
        <!--  <h1>LET US PLAY THE GAME</h1> -->
        <%
        if (!mMemberID.equals("") && !mMemberName.equals("") && !mMemberCode.equals("")) {
        ...
        %><form name="masterform">
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:28px " >Guest Author Form</div>
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" >
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        <td style="text-align:left">Guest Name<span class="req">*</span>:</td><td style="text-align:right"><input type="text" name="gName" id="gName" value="" class="textbox" maxlength="20" title="GuestName"/></td>
                    </tr>
                    <tr>
                        <td style="text-align:left">Designation Name <span class="req">*</span>:</td><td style="text-align:right"><input type="text" id="dName" name="dName" value="" class="textbox" maxlength="20" title="Designamtion"/></td>
                    </tr>

                    <tr>
                        <td style="text-align:left">Institute Name<span class="req">*</span>:</td><td style="text-align:right"><input type="text" id="instName" name="instName" value="" class="textbox" maxlength="20" title="Institute Name"/></td>

                    </tr>
                    <tr>
                        <td style="text-align:right">Dactive Y/N</td><td style="text-align:left"><input type="radio" name="active" id="activeY" value="Y"/>YES<input type="radio" name="active" id="activeN" value="N" title="Active Y/N"/>No</td>>
                    </tr>
                </table>
            </div>
