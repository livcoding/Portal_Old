<%--
    Document   : sFacultyFeedbackTransaction
    Created on : Apr 3, 2015, 5:09:23 PM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/sFacultyFeedbackTransactionJS.js"></script>
        <script>
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
        ...
        <form name="masterform" >
            ...
            <!-- Above Is  to handle  the session values   -->
             <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 60%;float: left;text-align: right;font-size: large">Faculty Feedback Transaction</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-SR-1]</div></div>
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" >
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    ...
                    <tr>
                        ...
                        <!-- <td style="text-align: right">Program Name<span class="req"> *</span> :</td><td style="text-align: left"><select  name='programName' id='programName' class='combo' multiple="multiple" style=''  title='Program Name'></select></td>-->
                         <%--<td style="text-align: right">Program Name<span class="req"> *</span> :</td><td style="text-align: left" id="abc"></td>--%>
                    ...
                    <tr>
                       ...
                       <%--<td style="text-align: right">Department Name<span class="req"> *</span> :</td><td style="text-align: left"><select  name='departmentName' id='departmentName'  class='combo' style=''  title='Department Name'><%=ccd.commonJspCombo("{\"comboId\":\"departmentComboShortNameisNull\",\"selectedValue\":\""+departmentCode+"\"}")%></select></td> --%>
