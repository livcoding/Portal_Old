<%-- 
    Document   : studentFeedbackTransaction
    Created on : Apr 8, 2015, 10:53:40 AM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/studentFeedbackTransactionJS.js"></script>
        <script>
       ...
       DBHandler db=new DBHandler();
        CommonComboData ccd=new CommonComboData();
         ...
         String mMemberCode = "";
         String mRightsID = "";
         String academicYear="",programCode="",MemberName="",programName="";
...
else
{
    ...
    <body >
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
         ...
         academicYear=session.getAttribute("AcademicYearCode").toString().trim();
         programCode=session.getAttribute("ProgramCode").toString().trim();
         MemberName=session.getAttribute("MemberName").toString().trim();
         String query="select programname from programmaster where programcode='"+programCode+"'";
         rs1 = db.getRowset(query);
         if(rs1.next())
         {
          programName=rs1.getString(1);
         }
         RsChk = null;
         
         
         
         String qry = "Select WEBKIOSK.ShowLink('1','" + mChkMemID + "','" + mChkMType + "','" + mRole + "','" + mIPAddress + "') SL from dual";
         //out.print(qry);
        ...
        <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 60%;float: left;text-align: right;font-size: large">Student Feedback</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-SR-4]</div></div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        ...
                        <td style="text-align: right">Student Name<span class="req"> *</span> :</td><td style="text-align: left"><input type="text"  name='studentName' id='studentName'  class='textbox' value='<%=MemberName%>' style=''  title='Student Name' readonly></td>
                    </tr> 
                    <tr>
                        ...
                        <td style="text-align: right">Program Name<span class="req"> *</span> :</td><td style="text-align: left"><input type="text"  name='programName' id='programName'  class='textbox' value="<%=programName%>" style=''  title='Program Name' readonly></td>
                    </tr> 
                    <tr>
                    <td style="text-align: right">Academic Year<span class="req"> *</span> :</td><td style="text-align: left"><input type="text"  name='academicYear' id='academicYear'  class='textbox' value='<%=academicYear%>' style=''  title='Academic Year' readonly></td>
            ...
            <!--<div id="studentNames" title="Student Names" style="overflow: auto;height: 300px">
                ...
                <select id="paggingPopUp"   onchange="getStudentNames(0)"  style="text-align:left" ></select>
            </div>  
                <table style="width: 100%;font-size: 18px;text-align: center;" id="popupHeaderTable">
                    <thead id="popupHeader">
                </thead>
            </table>
                <table style="width: 100%;font-size: 18px;" id="studentNamesTable">
                <tbody id="studentNamesBody">
                    <tr><td style="text-align: left">Search:<input type="text" id="searchStudentNames"></td></tr>
                </tbody>
            </table>
        </div>-->
        </form>
