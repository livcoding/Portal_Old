<%-- 
    Document   : trusteeFeedbackTransaction
    Created on : Mar 27, 2015, 4:32:04 PM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/TrusteeFeedbackTransactionJS.js"></script>
        <script>
    ...
    <body >
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
        ...
        <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 60%;float: left;text-align: right;font-size: large">Trustee Feedback Transaction</div><div style="width: 35%;float: left;text-align: right;font-size: large">[FORM:QA-SR-2]</div></div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    ...
                    <tr>
                         ...
                         <!--<td style="text-align: right">Semester<span class="req"> *</span> :</td><td style="text-align: left"><select  name='semester' id='semester'  class='combo' style=''  title='Semester'><%=ccd.commonJspCombo("{\"comboId\":\"semestercombo\"}")%></select></td>-->
