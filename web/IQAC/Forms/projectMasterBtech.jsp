<%-- 
    Document   : projectMasterBtech
    Created on : May 8, 2015, 10:27:42 AM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #facultyNameTable  tr:nth-child(even) {background: #F8F8F8;cursor:pointer;padding:8px; border:#999 1px solid; }
            #facultyNameTable tr:nth-child(odd) {background: 	#EBF5FF;cursor:pointer;padding:8px; border:#999 1px solid; }
            #facultyNameTable :hover, .highlight:focus,highlight:active   {
                background: skyblue !important;}
            ...
            <script src="../js/IQTest/projectMasterBtechJS.js"></script>
            <script>
        ...
        <body >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 60%;float: left;text-align: right;font-size: large">B.Tech Major Project</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-AR-6]</div></div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">Faculty Name<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='facultyName' id='facultyName' value='' maxlength='100' class='textbox'  title='Faculty Name' readonly/></td>
                    </tr> 
                    <tr>
                        ...
                        <td style="text-align: right" >Publications<span class="req"> *</span> :</td>
                        <td  style="text-align: left">
                            <select name="publications" class='combo' id="publications" title="Publications" >
                                <%=ccd.commonJspCombo("{\"comboId\":\"publicationTypeCombo1\"}")%>
                            </select>
                        </td>
                    </tr> 
                    <tr>
        ...
        <div id="facultyNames" title="Faculty Names" style="overflow: auto;height: 300px">
            ...
            <table style="width: 100%;font-size: 18px;" id="facultyNameTable">
                <tbody id="facultyNameBody">
                    <tr></tr>
                </tbody>
            </table>
        </div>
