...
<br>
<table align=center cellpadding=0 border=1 cellspacing=0 width=90%  class="sort-table" id="table-1" >
<THEAD>
<tr bgcolor="#ff8c00">
	<td align=center><font color="white" SIZE=2><b>Interaction Date</b></td>
		<td align=center><font color="white" SIZE=2><b>Sl No.</b></td>
			<td align=center><font color="white" SIZE=2><b>Related To</b></td>
				<td align=center><font color="white" SIZE=2><b>Remarks Type</b></td>
				<td align=center><font color="white" SIZE=2><b>Student Name (Enrollment No.)</b></td>
</tr>
</THEAD>
<%
