...
*/
		...
		ResultSet rsq=null,rsb=null;
			...
			qry="select distinct A.Studentid Studentid, A.StudentName StudentName, A.EnrollmentNo EnrollmentNo, " +
                    ...
                    " A.LTP LTP, A.SEMESTER SEMESTER, A.SECTIONBRANCH SECBR, A.SUBSECTIONCODE SUBSEC,a.ACADEMICYEAR ACADEMICYEAR From" +
...
qry1=" SELECT   sum (tcount) tcount from(select count(CLASSTIMEFROM)Tcount from V#STUDENTATTENDANCE where SubjectID='"+mSubject+"' and LTP IN ("+QryLTPVal+")  and ACADEMICYEAR='"+QryAcadYr+"' and PROGRAMCODE='"+QryProgCode+"' ";
...
qry1=qry1+" and STUDENTID='"+rs.getString("studentid")+"' and SECTIONBRANCH='"+rs.getString("SECBR")+"' and SUBSECTIONCODE='"+rs.getString("SUBSEC")+"' ";
//  qry1=qry1+" GROUP BY EXAMCODE, SubjectID";
qry1=qry1+" union all select count(CLASSTIMEFROM)Tcount from STUDENTPREVATTENDENCE where SubjectID='"+mSubject+"' and EXAMCODE='"+QryExam+"' and LTP IN ("+QryLTPVal+") and SECTIONBRANCH='"+rs.getString("SECBR")+"' and SUBSECTIONCODE='"+rs.getString("SUBSEC")+"' and STUDENTID='"+rs.getString("studentid")+"'  and ACADEMICYEAR='"+QryAcadYr+"' and PROGRAMCODE='"+QryProgCode+"' ";
if(rs.getInt("Semester")==1 && !mREGCONFIRMATIONDATE.equals(""))
{
qry1=qry1+"   and trunc(ATTENDANCEDATE)>=TO_Date('"+mREGCONFIRMATIONDATE+"','dd-mm-yyyy')";
}
qry1=qry1+" and  INSTITUTECODE='"+mInst+"' and nvl(DEACTIVE,'N')='N') ";
			...
			//	out.print(qry1);
				...
				qry1="SELECT   sum (Pcount) Pcount from( select count(*)Pcount from V#STUDENTATTENDANCE where SubjectID='"+mSubject+"' and LTP IN ("+QryLTPVal+") and EXAMCODE='"+QryExam+"'  and ACADEMICYEAR='"+QryAcadYr+"' and PROGRAMCODE='"+QryProgCode+"' ";
				//qry1=qry1+" and FSTID='"+rs.getString("Fstid")+"'";
					if(rs.getInt("SEMESTER")==1 && !mREGCONFIRMATIONDATE.equals(""))
		{
		qry1=qry1+" and trunc(ATTENDANCEDATE)>=TO_Date('"+mREGCONFIRMATIONDATE+"','dd-mm-yyyy')";
				...
				//qry1=qry1+" GROUP BY EXAMCODE, SubjectID";
qry1=qry1+" union all select  count(*)Pcount from STUDENTPREVATTENDENCE where SubjectID='"+mSubject+"' and EXAMCODE='"+QryExam+"' and LTP IN ("+QryLTPVal+")  and ACADEMICYEAR='"+QryAcadYr+"' and PROGRAMCODE='"+QryProgCode+"' and SECTIONBRANCH='"+rs.getString("SECBR")+"' and SUBSECTIONCODE='"+rs.getString("SUBSEC")+"'  ";
		if(rs.getInt("Semester")==1 && !mREGCONFIRMATIONDATE.equals(""))
		{
		qry1=qry1+" and trunc(ATTENDANCEDATE)>=TO_Date('"+mREGCONFIRMATIONDATE+"','dd-mm-yyyy')";
		}
