...
{  //2
  ...
  //----------------------
	...
	<tr>
	<TD align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>Student Grade Card </b></font></td>
	</tr>
	</table>
...
*/
	...
	%>
	<form Method=POST Name="SaveGrades" Action="AdminStudGradesChangeAction.jsp">
	...
	while(rs1.next())
	{
		...
		<%
		qry="Select GRADE From GRADEMASTER Where INSTITUTECODE='"+mINSTITUTECODE+"' and GRADE is not null And EXAMCODE='"+QryExam+"' And  nvl(DEACTIVE,'N')='N'";
	...
	<Input Type="Submit" Value="Save New Grades">
