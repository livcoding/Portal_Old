...
<tr>
<TD colspan=0 align=middle ><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>Student Tutorial Attendance Detail</b></font></td>
</tr>
</TABLE>
<%
String mSnm="", mENo="";
...
<table width="100%">
<tr><td align=center>
 <font color="#00008b">Subject Code: <b><%=mSubj%></B> &nbsp; &nbsp;Student Name: <B><%=GlobalFunctions.toTtitleCase(mSnm)%> [<%=mENo%>]</B> &nbsp; &nbsp; LTP: <B><%=GlobalFunctions.getLTPDescWSQ(mLTP)%></B>
 </font>
</td></tr></table>
