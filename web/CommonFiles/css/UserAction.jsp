...
String mBASEADMINPWD="",mDeactive="";
int MAXHINT =0;
...
{ 
	...
	{  
		...
		mECode=enc.encode(mCode);	
	      ...
	      qry="Select PARAMETERID, PARAMETERVALUE,MINRANGE, MAXRANGE,LOGINTIMELIMIT From PARAMETERS Where MODULENAME='SIS' And PARAMETERID IN ('B1.1','B1.2','B1.3','B1.4','B1.5','A1.1') and nvl(DEACTIVE,'N')='N' ";
  		rs=db.getRowset(qry);
		while(rs.next())
		{
	...
	//out.print(mMinPass+"mMinPass"+mMaxPass+"mMaxPass");


				//out.print(enc.decode("dLv2bIpp40RohY8zthkRMQ=="));
...
qry1="select  FLAC from Membermaster where trim(ORACD)='"+mECode+"' and trim(ORATYP)='"+mEMemberType+"' ";
	//out.print(qry1);
