...
qrydetail=" select  nvl(quota,'NA')quota, institutecode,enrollmentno, semester ,branchcode,academicyear,programcode,STUDENTNAME from studentmaster_g where studentid='"+mMemberID+"'   ";
...
qry6=" select distinct 'Y' from studentmaster_g a , "+rs4.getString("CRITERIATABLE")+"_g"+" b,TP#ELIGIBILITYCRITERIAVALUE c where c.criteriaid='"+rs2.getString("CRITERIAID")+"' and b."+rs4.getString("CRITERIAFIELD")+"  "+rs2.getString("criteriaoperatorbefore")+" ("+value+") and b.studentid='"+mMemberID+"' and a.INSTITUTECODE='"+mInst+"' " +
        " AND B.studentid = A.STUDENTID and c.cset='"+cSet+"' " ;

if(rs4.getString("CRITERIAFIELD").equals("CGPA"))
	{
qry6=qry6 +" And b.Semester =(select max(c.semester) from  v#studentsgpacgpa_g c where c.institutecode = b.institutecode and   c.studentid = b.studentid) ";
}
...
if(reason.equals("YEAROFPASSING"))
  ...
  //out.print(qry11);
        ...
        if(rs11.next()){
        qry9=" select distinct 'Y' from "+rs11.getString("CRITERIATABLE")+"_g"+" where  to_number('"+rs11.getString("ENTRYDATE")+"') -"+rs11.getString("CRITERIAFIELD")+"" +rs11.getString("criteriaoperatorbefore")+"'"+rs11.getString("CRITERIAVALUE")+"' and Upper(qualificationcode) = '12TH' and studentid='"+mMemberID+"' and INSTITUTECODE='"+mInst+"' ";
    //  out.print(qry9);
...
mprint="Y";
 ...
 //out.print(qry11);
		rs11=db.getRowset(qry11);
        if(rs11.next()){
qry9=" select 'Y' from "+rs11.getString("CRITERIATABLE")+"_g "+" where institutecode = '"+mInst+"' and nvl("+rs11.getString("CRITERIAFIELD")+",'N') = 'Y' and studentid = '"+mMemberID+"' having count(*)"+rs11.getString("criteriaoperatorbefore")+""+rs11.getString("CRITERIAVALUE")+"  ";
// out.print(qry9);
