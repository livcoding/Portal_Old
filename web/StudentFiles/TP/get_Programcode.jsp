...
try{
qry= "select distinct NVL(PROGRAMCODE,' ') p FROM v#studentmaster where " +
        "nvl(Deactive,'N')='N' and ACADEMICYEAR='"+academicyear+"'";

	System.out.print("Program qry : "+academicyear);
	rs2=db.getRowset(qry);
	while(rs2.next()) {
		result=result+rs2.getString("p")+"$";
	}
