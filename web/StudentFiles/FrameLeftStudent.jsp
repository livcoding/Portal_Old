...
<tr><td><img height=2 src="../Images/ColorBar.gif" width=110>
   ...
   <span class="submenu" id="sub1">
	...
	%>
		<img src="../Images/bullet4.gif">&nbsp;<a  target="NEW" title="Change eMailID/Contact Numbers"
        href="PersonalFiles/StudModifyEmailIDTelephoneNEW.jsp"><FONT face="Arial" color =white size=2>Edit Info.</font></a><br>
	<%
   ...
   qry="Select WEBKIOSK.ShowLink('268','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
    ...
    qry="Select WEBKIOSK.ShowLink('247','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
	//out.print(qry);
	Rs = db.getRowset(qry);
	if (Rs.next() && Rs.getString("SL").equals("Y"))
	{
	...
	<%
		      ...
		      qry="Select WEBKIOSK.ShowLink('273','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
	//out.print(qry);
	Rs = db.getRowset(qry);
	if (Rs.next() && Rs.getString("SL").equals("Y"))
	{
	%>
	<!--	<img src="../Images/bullet4.gif">&nbsp;<a  target="DetailSection" title="View Your Provisional Hostel detail" href="PersonalFiles/PROVHOSTDETREP.jsp"><FONT face="Arial" color =white size=2>Hostel detail(Provisional)</font></a><br>-->
...
qry="Select WEBKIOSK.ShowLink('258','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
	 Rs = db.getRowset(qry);
	 if (Rs.next() && Rs.getString("SL").equals("Y") )
	   {
		%>
		...
		<%
		 ...
		 qry="Select WEBKIOSK.ShowLink('271','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
	 Rs = db.getRowset(qry);
	 if (Rs.next() && Rs.getString("SL").equals("Y") || 1==1)
	   {
...
if(1==1)
 ...
 qry="Select WEBKIOSK.ShowLink('270','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
	    Rs = db.getRowset(qry);
	    if (Rs.next() && Rs.getString("SL").equals("Y"))
		{//out.print(mAcad);
		/*	if(mAcad.equals("1213")||mAcad.equals("1112")||mAcad.equals("1011"))
          {*/
                     %>
