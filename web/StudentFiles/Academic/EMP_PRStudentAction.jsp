...
<%
			...
			{	//3
				...
				for (int TT1=1;TT1<=mTotalRec;TT1++)
				{
					...
					{
						//out.println("d");
						if(mBasket.equals("B") && mDF==0 && request.getParameter("Selectf1")!=null)
						{
...
//					if(request.getParameter("Select11")!=null)
					if(request.getParameter("Select11")!=null && (((studelecchoise < mMinBasketD && (a <=mMaxCrLmt)) || studelecchoise >mMaxBasketD ) || (b <= mMaxCrLmt && studelecchoise < mMinBasketD ))) 
