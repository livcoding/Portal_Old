...
try
{
	...
	<table  align=center >
			...
			<tr><td align=center class="labelcell">Employee : <%=mMemberName%>-(<%=mDMemberCode%>)</td></tr>
        </table>
	<%
...
if(request.getParameter("Submit1")==null &&  request.getParameter("Freeze")==null )
		{
		response.sendRedirect("DepartmentLinks.jsp?ShowStatus="+mShow+"&Vacancy="+mVacCode+"&DeptCode="+mDeptCode+" ");
		}
		else 
		{	
