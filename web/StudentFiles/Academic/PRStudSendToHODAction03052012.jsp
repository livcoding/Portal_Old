...
qry=qry+"nvl(B.CHOICE,0) CHOICE,nvl(B.SUBJECTRUNNING,' ')SUBJECTRUNNING,decode(c.ELECTIVECODE,  'B-1','Elective(PDE)','E-1', 'Elective(DE)','PD','Elective(PD)','DE','Elective',c.ELECTIVECODE)ELECTIVECODE, ";
