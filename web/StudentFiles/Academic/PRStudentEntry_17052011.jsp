...
function test(){
	...
	//alert(document.frm1.mSem.value+"cc");
	
	if(document.frm1.mSem.value=='8' || (document.frm1.mProg.value=='M.T.' &&  document.frm1.mSem.value=='4'))
		{
...
qry1="select sem, cgpa from(       select  max(Semester) as sem,cgpa       from STUDENTSGPACGPA where institutecode='"+mInst+"' and studentid='"+mChkMemID+"'       group by semester ,cgpa order by semester desc)       where rownum =1";
//out.print(qry1);
...
qry="";
				...
				if(mCGPA < 6 )
				{
				qry=qry+" and a.subjectid not in ( '090316'  , '100116' , '100117' , '090317') ";
				}
				else if(mCGPA < 7 )
				{
					qry=qry+" and a.subjectid not in (  '100111'  ) ";
				}
//out.println(qry);
...
//---------new added ----------------------
				...
				qry=qry+" and A.semester="+mSem+" AND A.BASKET in ('D','E') AND A.institutecode=B.institutecode and A.subjectID=B.subjectID)";					
				qry=qry+" ) order by SUBJECTTYPE,ELECTIVECODE, Subject";
...
//---------------------------------------
				...
				<tr>
				<td align="left">
				<font color=red><b>NOTE:-
				# Once choices are sent to HOD, you can not enter or modify your choice.</b>
				</font>
				<br>
				<br>
		
		
CGPA :- 6 Or Above  Eligible To Take Subjects 	<br>	
1) Information And Coding Theory (10M11EC213) <br> 
2) FPGA Based System Design (11B1WEC231)  <br>
3) Software Defined Radio (11B1WEC232)  <br>
4) Advanced Wireless And Mobile Communication (10M11EC212)<br><br>
CGPA :- 7 Or Above  Eligible To Take Subject <br>
1) Linux And Its Application   (11B1WEC831) <br>
				</font>
				</td>
				</tr>
				<%
