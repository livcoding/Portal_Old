...
qry=qry+"nvl(B.CHOICE,0) CHOICE,nvl(B.SUBJECTRUNNING,' ')SUBJECTRUNNING,decode(c.ELECTIVECODE,  'B-1','Elective(B-1)','E-1', 'Elective(E-1)','E-2', 'Elective(E-2)','E-3', 'Elective(E-3)','PD','Elective(PD)','DE','Elective',c.ELECTIVECODE)ELECTIVECODE, ";
