...
<tr>
<TD align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>Registered Subjects of Student</b></font>
</td>
</tr>
</table>
...
<%
    ...
    <%
			mTotalCrLmtTkn=mTotalCrLmtTkn+Float.parseFloat(rs1.getString("COURSECREDITPOINT"));

	}
%>
<tr><td colspan=2 align=right><b>Total Course Credit:</b> </td><td ><b><%=mTotalCrLmtTkn%></b></td><td>&nbsp;</td>
 </table>		
<%	 		        
//}					
