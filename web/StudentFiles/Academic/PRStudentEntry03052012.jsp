		...
		if(parseInt(cr)+3<=total){		
			...
			//	for(k=1;k<=ec;k++){
				...
				for(i=1;i<=ec;i++)
				{
					...
					//--------------------------
	//	alert(document.getElementById("SUBJID"+i).value+"LLLL"+i);  //document.getElementById("SUBJID"+i).value=="090311" || .frm1["CHK"+i]

	//alert(k+"LL"+document.frm1["SUBJID"+k].value+"KKKKK"+document.frm1["Select"+i].value);
					if(cgpa >= 6 )
					{
...
<%
	...
	%>
<tr>
<td colspan=6> <font color=green face=verdana size=2> <b>
Your CGPA is <%=mCGPA%> , therefore these subjects are Compulsory to give higher Choice.

	<LI>10M11EC112(ADVANCED SATELLITE AND FIBRE OPTIC COMMUNCIATIOS)

	<LI>12M1WEC131(MULTIMEDIA COMMUNICATION THEORY AND STANDARDS)

	<LI>10M11EC111(ADVANCED COMMUNICATION SYSTEMS)
