...
<%
            qry = "select nvl(PERCENTAGEEQUIVALENT,0)PERCENTAGEEQUIVALENT from CGPAConversionChart where INSTITUTECODE='" + mInst + "' and CGPA='" + mCGP + "' and nvl(deactive,'N')='N'";
            rs = db.getRowset(qry);
            rs.next();

%>
<center><FONT color=black face=Arial size=2> * The CGPA of <%=mCGP%> on the scale of 10 equates to <%=rs.getString(1)%> percent as per Conversion Table -2005,approved by the Academic Council of the University.</FONT></center>
