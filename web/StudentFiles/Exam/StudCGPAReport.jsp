...
qry="select StudentName, Enrollmentno ,semester from StudentMaster where institutecode='"+mInstitute+"'  and StudentID='"+mChkMemID+"'  ";
...
//	out.print(qry);
	...
	//	out.print(rs1.getInt("SEMESTER")+"dd");
