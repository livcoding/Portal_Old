...
qrys="SELECT distinct FEEAMOUNT FROM FEESTRUCTUREINDIVIDUAL WHERE INSTITUTECODE='"+mInst+"' AND FEEHEAD LIKE '%SEF%' AND  STUDENTID='"+mChkMemID+"' AND REGCODE= '"+mSupRegcode+"' AND SEMESTER='"+mSems+"' ";
			//	out.print(qrys);
...
qry1=" UPDATE FEESTRUCTUREINDIVIDUAL SET   FEEAMOUNT=0 WHERE 				INSTITUTECODE  = '"+mInst+"' AND    FEEHEAD  ='"+mFEEHEAD+"' AND STUDENTID ='"+mChkMemID+"' and COMPANYCODE='"+mComp+"'  AND SEMESTER='"+mSems+"' ";
						 //out.print(qry);
						int NN=db.update(qry1);
        ...
        StudentRecordSet = db.getRowset(qry); 	
			...
			//	out.print(mTot + "  -- ");
				...
				if(!rss.next())
					...
					{
						qry=" UPDATE FEESTRUCTUREINDIVIDUAL SET   FEEAMOUNT='"+mTot+"' WHERE 				INSTITUTECODE  = '"+mInst+"' AND    FEEHEAD  ='"+mFEEHEAD+"' AND STUDENTID ='"+mChkMemID+"' and COMPANYCODE='"+mComp+"'  AND SEMESTER='"+mSems+"' ";
					//	 out.print(qry);
						int xx=db.update(qry);
...
qry="DELETE FROM SUPPLEMENTARYSUBJECTTAGGING WHERE studentid='"+mSID+"' and examcode='"+SupExamCode+"' and SUBJECTID='"+msubject+"'  AND INSTITUTECODE='"+mInst+"'  ";
//out.print(qry);
int b=db.update(qry);
