...
String mSem="",mObjName="",mexamcode="",QryExam="";
...
<form name="frm" method=post>
			...
			<br>LAST DATE OF RECIEPT IN REGISTRAR OFFICE ---
			</b></U>
			</font>
			</td>
			</tr>
			...
			<tr><td><font color=#00008b face=arial size=2><STRONG>&nbsp; Name:&nbsp;</STRONG></font><font face="Verdana" size=2><b><%=GlobalFunctions.toTtitleCase(mName)%> [<%=mDMemberCode%>]</b></font>
			&nbsp;&nbsp;<font color=#00008b face=arial size=2><STRONG>Course/Branch:&nbsp;</STRONG></font><font face="Verdana" size=2><b><%=mProg%>(<%=mBranch%>)</b></font>
			&nbsp;&nbsp;<font color=#00008b face=arial size=2><STRONG>Current Semester:&nbsp;</STRONG></font><font face="Verdana" size=2><b><%=mSem%></font></td></tr>
			...
			qry=qry+" and nvl(deactive,'N')='N' and EXAMCODE IN (SELECT EXAMCODE FROM STUDENTWISEGRADE where studentid='"+mChkMemID+"' AND  institutecode='"+mInst+"'  ) order by examcode Desc";
			//out.println(qry);
			rs=db.getRowset(qry);
			%>
		...
		qry="Select EnrollmentNo enrollmentno,Studentname Name, StudentID , Semester, nvl(ProgramCODE,'UNK') ProgramCode, nvl(BranchCode,'UNK') BranchCode From StudentMaster where studentid='"+mChkMemID+"' and InstiTuteCode='"+mInst+"'";
//out.print(qry);
...
%>
	...
	<hr>
	<p align=left>I Mr./Ms. <b><%=mSname%></b> hereby apply for the Supplementary Examination <B><%=QryExam%></B>. <br>I am enclosing a receipt of payment/demand draft of Rs. ................................... for .......................................... number of subjects @ Rs. <%=FeeAmt%>/- per subject.
	<br><br>
...
<tr><td colspan=2 align=Right>Relationship with Student:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td></tr>
	...
	<p Align=Left>Received Registration Fee for Supplementary Examination (<B><%=QryExam%></B>) and receipt of Payment/DD form.
	<br>
