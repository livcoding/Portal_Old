...
<p align=center >
 <input type="button" value="Click here for Company Registration"
 onClick="window.open('https://webkiosk.jiit.ac.in/StudentFiles/TP/forstudent_Wk.jsp?value=<%=mChkMemID%>','_self')"/> <br>
</p>
<%
		...
		//	qry="SELECT  distinct COUNT(*)  FROM studentmaster a, PG#TAGGINGFORONLINEFEE b WHERE a.studentid = b.TOUSERID    and a.STUDENTID= and a.INSTITUTECODE='"+mInst+"' and a.INSTITUTECODE=b.INSTITUTECODE ";
			...
			<b>
             ...
             <br>
			 NOTE: HOSTEL CHARGES WILL BE NOTIFIED LATER DEPENDING UPON OPENING OF "ON CAMPUS"
             ACADEMIC ACTIVITY FOR STUDENTS AND OCCUPATION OF HOSTEL FACILITIES AS PER DIRECTIVES
             OF MHA/STATE GOVT./HPPERC 
