...
<p align=center>
<font color=darkbrown size=3 face='verdana'><b><U>View Medical Form</U></b></font>
</p>
<center>
	...
	if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals(""))
	{
	  ...
	  //-----------------------------
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
			...
			<%
			qry="Select A.StudentName SName, A.EnrollmentNo EnrollNo, nvl(B.HOSTELROOMNO,' ') RoomNo, NVL(B.PRS_HOALLERGICTODRUG,'No')PRS_HOALLERGICTODRUG,";
