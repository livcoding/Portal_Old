...
try
{
	if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals(""))
	{
	  ...
	  //-----------------------------
		...
		{
			%>
			<form name=frm id=frm Action="PersonalStudentMedicalHistoryEntryAction.jsp">
			...
			<%
				...
				{
					%>
					<CENTER><b><font size=3 face='Arial' color='Green'>Your Medical Form is updated successfully...</font></b><br><br>
					</CENTER>
					<%
				}
