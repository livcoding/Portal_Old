...
if(!mMemberID.equals("") && !mMemberCode.equals("") ) 
{
  ...
  //----------------------
		...
		<form name=frm1 method=Post>
			...
			<font size=4 face=arial color=#a52a2a><b>Program Fee Details</b> </font>
			</td></tr>
			...
			<td><b><font color="white" size=2>Academic Year</font></b></td>
			<td><b><font color="white" size=2>Program</font></b></td>
				<td><b><font color="white" size=2>Branch</font></b></td>
					<td><b><font color="white" size=2> Fee Source</font></b></td>
	...
	//out.print(qry);	
		...
		%>
		 <td colspan=8 align=right valign=top>
			&nbsp;&nbsp;&nbsp;	 
		 <font size=2 color=blue face=arial><b>Total Fees :&nbsp; <%=Total%></b></font></td>
		  </tr>
		</tbody>
		</TABLE>
		</form>
