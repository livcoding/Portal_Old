...
*/
	...
	try
	{
		...
		session.setAttribute("Mtype101117", hVal );
	    session.setAttribute("cptid", "" );
...
function forDate() {
var p = document.getElementById("UserType101117").value;
//alert(p);
	...
	$(document).ready(function(){
			$("#Password").keyup(function(){
             $("#MemberCode").val();
              $("#DATE1").val();
             // $("#UserType").val();
		//if(this.id=="Password101117" &&  $("#UserType").val()=="S"|| $("#UserType").val()=="P"){
...
if(y=='Y')
  {
  ...
  else
    {
      ...
      document.getElementById("Password101117").value="";
      alert(y);
        return (false) ;
    }
  }
...
{
	var mUserType;
	mUserType=LoginForm.UserType101117.value;
	...
	{
            var x='Enrollment No';
            document.getElementById("txtCode").value = "Enrollment No";
	  // LoginForm.txtCode.value  ="Enrollment No";
	}
	else if (mUserType=='E')
	{
            var x='Employee Code';
	    document.getElementById("txtCode").value = "Employee Code";
            //LoginForm.txtCode.value  ="a";

	}
	else
	{
            document.getElementById("txtCode").value = "Guest ID";
...
function  Validate()
{
    var mUserType=LoginForm.UserType101117.value;
if(mUserType == 'S'||mUserType == 'P')
            {
...
if(mUserType == 'S'||mUserType == 'P')
          {
               LoginForm.DATE1.focus();
               LoginForm.Password101117.value='';
                return(false);
          }
}
...
if(document.LoginForm.MemberCode.value=='')
  ...
  if(document.LoginForm.txtcap.value==''){
                alert("Please Enter Captcha");
                LoginForm.txtcap.focus();
                return(false);
            }
if(mUserType == 'S'||mUserType == 'P')
            {
                var chkdate = document.LoginForm.DATE1.value;
                if(document.LoginForm.DATE1.value==''){
                alert("Date Of Birth Should not be blank");
                LoginForm.DATE1.focus();
                return(false);
...
if(document.LoginForm.Password101117.value=='')
            {
                alert("Password Should not be blank");
                LoginForm.Password101117.focus();
                return(false);
            }
}
...
<body  id="top" bgcolor="white"  >
    <FORM NAME="LoginForm" method=post action="CommonFiles/UseValid.jsp">
	<input type="hidden" name="x" id="x">
	 <input type="hidden" id="utypet"  value="xyz"/>
  ...
  <center><font face="COMIC SANS MS" color='blue' size=4 ><U><br><br>LOGIN</U></font></center><br>
	...
	<b><INPUT id=txtUType style="BORDER-BOTTOM: medium none; BORDER-LEFT-STYLE: none; BORDER-RIGHT-STYLE: none; background-color:#D5D6D8;BORDER-TOP-STYLE: none; FONT-FAMILY: sans-serif; FONT-SIZE: x-small; FONT-STYLE: normal; HEIGHT: 19px; TEXT-ALIGN: right; VERTICAL-ALIGN: middle; WIDTH: 79px"
     ...
     <select size="1" name="UserType101117" id="UserType101117" tabindex="1" language="Javascript" onchange="forDate();UserType_onchange();"  onkeypress="return UserType_onchange();" style="VERTICAL-ALIGN: middle; WIDTH: 85px">
   ...
   <b><INPUT Readonly name=txtCode id=txtCode value="Enrollment No" style ="BORDER-BOTTOM: medium none; BORDER-LEFT-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; FONT-FAMILY: sans-serif; FONT-SIZE: x-small; FONT-STYLE: normal; HEIGHT: 22px; TEXT-ALIGN: right;background-color:#D5D6D8;
	...
	<input   name="MemberCode" id="MemberCode" size="11" tabindex="2" LANGUAGE=javascript onchange="MemberCode_onchange();" style="VERTICAL-ALIGN: middle; WIDTH: 85px"></b> <FONT color=red><sub>*</sub></FONT>
		...
		<INPUT Readonly name="DOB" id="DOB" value="DOB" style ="BORDER-BOTTOM: medium none; BORDER-LEFT-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-TOP-STYLE: none; FONT-FAMILY: sans-serif; FONT-SIZE: x-small; FONT-STYLE: normal; HEIGHT: 22px; TEXT-ALIGN: right;background-color:d5d6d8;
...
<input type="password" name="Password101117"  id="Password101117" size="12" tabindex="2" style="HEIGHT: 22px; VERTICAL-ALIGN: middle; WIDTH: 85px"  onkeypress=" return Validate();"  ><font color="red">&nbsp;<sub>*</sub></font>
<br>
...
<td align=right valign=middle>
 ...
 <!-- uv  -->
          <table>
              <tr>
              <A Target=_New href="testStudent.jsp"><FONT size=3 color=blue><B>test</B></FONT></A>
              </tr>
