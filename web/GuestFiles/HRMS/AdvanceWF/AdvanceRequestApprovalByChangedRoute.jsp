...
//-------------------------------------------------------
			...
			{
			%>
			<form name="frm" method="POST" ACTION="AdvanceRequestApprovalByChangedRouteActionForIndvReq.jsp">
...
//---------------Start Of Approval Authority for if(rsFrIndv.next())----
				...
				while(rs.next())
				{
					...
					{
						%>
						<a target=_new href="AddWorkFlowLevel.jsp?EID=<%=QryFaculty%>&amp;DeptCode=<%=mSelfDeptCode%>&amp;WFC=<%=QryWFCode%>&amp;WFT=<%=QryWFType%>&amp;WFL=<%=CTR%>&amp;RID=<%=QryRID%>&amp;TRV=<%=QryTotReqVal%>&amp;DOA=<%=QryDOA%>&amp;DOR=<%=QryDOR%>" title="Click to add more Approval Level"><marquee behavior=alternate scrolldelay=100 width=300px% style="cursor:hand"><font color="blue" face=arial size=2><STRONG>Next Approval Authority Required ?</STRONG></font></marquee></a>
						<%
					}
					else
					{
...
//---------------Start Of Approval Authority for if(rsFrEmp.next())----
				...
				while(rs.next())
				{
					...
					{
						%>
						<a target=_new href="AddWorkFlowLevel.jsp?EID=<%=QryFaculty%>&amp;DeptCode=<%=mDeptCode%>&amp;WFC=<%=QryWFCode%>&amp;WFT=<%=QryWFType%>&amp;WFL=<%=CTR%>&amp;RID=<%=QryRID%>&amp;TRV=<%=QryTotReqVal%>&amp;DOA=<%=QryDOA%>&amp;DOR=<%=QryDOR%>" title="Click to add more Approval Level"><marquee behavior=alternate scrolldelay=100 width=300px% style="cursor:hand"><font color="blue" face=arial size=2><STRONG>Next Approval Authority Required ?</STRONG></font></marquee></a>
						<%
					}
					else
					{
...
//---------------Start Of Approval Authority for if(rsFrDept.next())----
				...
				while(rs.next())
				{
					...
					{
						%>
						<a target=_new href="AddWorkFlowLevel.jsp?DeptCode=<%=mSelfDeptCode%>&amp;WFC=<%=QryWFCode%>&amp;WFT=<%=QryWFType%>&amp;WFL=<%=CTR%>&amp;RID=<%=QryRID%>&amp;TLD=<%=QryTotReqVal%>&amp;DOA=<%=QryDOA%>&amp;DOR=<%=QryDOR%>" title="Click to add more Approval Level"><marquee behavior=alternate scrolldelay=100 width=300px% style="cursor:hand"><font color="blue" face=arial size=2><STRONG>Next Approval Authority Required ?</STRONG></font></marquee></a>
						<%
					}
					else
					{
...
//-------------------------------------------------------
			...
			{
				RequestDispatcher rd=request.getRequestDispatcher("AdvanceRequestApprovalByChangedRouteEmpwise.jsp");
...
//-------------------------------------------------------
			...
			{
				//response.sendRedirect("AdvanceRequestApprovalByChangedRouteDeptwise.jsp");
				RequestDispatcher rd=request.getRequestDispatcher("AdvanceRequestApprovalByChangedRouteDeptwise.jsp");
				rd.forward(request,response);
			}
	//-----------------------------
	//---Enable Security Page Level  
