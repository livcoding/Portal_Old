...
try
{
	String mPageHeader="Edit Advance Leave Request", mMarqMsg="", CurrDate="";
...
//		out.print(qry);
	...
	%>
		...
		<td nowrap align=center><a Title="Click to Edit <%=rs.getString("EMPLOYEENAME")%>'s Advance Leave Request" href='AdvanceRequestEditDetail.jsp?EID=<%=rs.getString("MEMBERID")%>&amp;RID=<%=rs.getString("REQUESTID")%>'><FONT COLOR=blue>Edit </FONT></a>
		</td>
		</tr>
		</tbody>
		<%
