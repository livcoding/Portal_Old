	  ...
	  //-----------------------------
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
			...
			//--------------------------------------------------
						else if(mActCurr.equals("D") && mChk.equals("Checked"))
						{
							...
							if(n1>0)
							{
								// Log Entry
								//-----------------
							      db.saveTransLog(mInst,mLogEntryMemberID,mLogEntryMemberType ,"DISCARD "+QryWFCode+" WORK FLOW LEVEL", "WFCode:"+QryWFCode+" WFType:"+QryWFType+" Req Dept:"+QryDept+" WFSeq:"+mWFSeq, "NO MAC Address" , mIPAddress);
								//-----------------
								mDelFlag++;
								mDelWFLvl=mWFLevel;
			...
			//--------------------------------------------------
					...
					{
						%><BR><CENTER><%
						out.print(" &nbsp;&nbsp;&nbsp <b><font size=3 face='Arial' color='green'>"+QryWFCode+" Work Flow Route has been changed successfully...</font></b><br>");
						%></CENTER><%
					}
					if(mTotal==ChkFlag)
					{
					...
					{
						%><BR><CENTER><%
						out.print(" &nbsp;&nbsp;&nbsp <b><font size=3 face='Arial' color='green'>"+QryWFCode+" Work Flow Level has been discarded successfully...</font></b><br>");
						%></CENTER><%
					}
				}
			//-----Use Iterator Here------
			/*
				if(AL1!=null)
				{
					...
					{
						%><CENTER><br><%
						out.print("&nbsp;&nbsp;&nbsp <b><font size=3 face='Arial' color='Green'>"+QryWFCode+" WorkFlow Level Addition Successful...</font> <br>");
						%></CENTER><%
