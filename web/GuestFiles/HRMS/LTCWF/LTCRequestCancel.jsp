...
try
{
	String mPageHeader="Cancel LTC Leave Request", mMarqMsg="", CurrDate="";
...
<%
	...
	try
	{
		...
		<td nowrap align=center><a Title="Click to Cancel <%=rs.getString("EMPLOYEENAME")%>'s LTC Leave Request" href='LTCRequestCancelDetail.jsp?EID=<%=rs.getString("MEMBERID")%>&amp;RID=<%=rs.getString("REQUESTID")%>'><FONT COLOR=Red >Click To Cancel</FONT></a>
		</td>
		</tr>
		</tbody>
		<%
