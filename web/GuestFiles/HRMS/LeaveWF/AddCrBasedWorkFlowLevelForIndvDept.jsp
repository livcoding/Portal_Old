...
{
	mTotalLvDays=Double.parseDouble(request.getParameter("TLD").toString().trim());
}

//out.print("RID-"+QryRID+" WFC-"+QryWFCode+" WFT-"+QryWFType+" WFL-"+QryWFLevel+" LvDateFr-"+QryLvDateFr+" LvDateTo-"+QryLvDateTo+" TotalLvDays-"+mTotalLvDays);
String mHead="";
		...
		if(mChkLevel.equals("Required"))
		{
		   if(!mApprAuth.equals(""))
		   {
			...
			if(!rs.next())
			{
				...
				{
					%><CENTER><br><%
					out.print("&nbsp;&nbsp;&nbsp <b><font size=3 face='Arial' color='Green'>Leave WorkFlow Criteria Addition Successful...</font> <br>");
					%></CENTER><%
