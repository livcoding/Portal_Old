	   ...
	   //-----------------------------
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
			...
			while(rs.next())
			{
				...
				<td nowrap align=center><A Title="Click to View Leave Request" target="_New" href='ReadInfoMessageFirstTime.jsp?RID=<%=rs.getString("RID")%>&amp;WFS=<%=rs.getInt("WFS")%>'><FONT COLOR=BLUE face=verdana size=2><%=rs.getString("RID")%></FONT></a>
