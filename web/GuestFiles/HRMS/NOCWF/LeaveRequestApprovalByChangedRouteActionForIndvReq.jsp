...
String mApprAuth="", mApprBy="", mApprovalById="", mWFCode="";
	  ...
	  //-----------------------------
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
						...
						else if(mActCurr.equals("D") && mChk.equals("Checked"))
						{
							...
							if(rs.next())
							{
								...
								if(n1>0)
								{
									// Log Entry
									//-----------------
								      db.saveTransLog(mInstitute,mLogEntryMemberID,mLogEntryMemberType ,"DISCARD NOC WORK FLOW LEVEL", "WFCode:"+mWFCode+" WFType:"+QryWFType+" Req Dept:"+mDepartmentCode+" WFSeq:"+mWFSeq, "NO MAC Address" , mIPAddress);
									//-----------------
									mDelFlag++;
									mDelWFLvl=mWFLevel;
			...
			//--------------------------------------------------
					...
					{
						%><BR><CENTER><%
						out.print(" &nbsp;&nbsp;&nbsp <b><font size=3 face='Arial' color='green'>NOC Work Flow Level has been discarded successfully...</font></b><br>");
						%></CENTER><%
					}
				}
			//-----Use Iterator Here------
