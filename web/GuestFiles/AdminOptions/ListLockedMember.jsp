...
String mMemberName="",mMType="",Mid="",MType="",mtype="",men="",mec="",Mtype="",DMid="";
int kk=0;
String mCurDate1="";
...
if(!mMemberID.equals("") && !mMemberType.equals("") && !mMemberCode.equals("") && !mMemberName.equals("")) 
{
  ...
  //-----------------------------
	qry="Select WEBKIOSK.ShowLink('81','"+ mChkMemID+"','"+mChkMType+"','"+mRole+"','"+ mIPAddress +"') SL from dual";
...
<center>
	...
	<form name="frm1"  method="post" action="ListLockedMemberAction.jsp"> 
	<thead>
	<tr bgcolor="#ff8c00">
