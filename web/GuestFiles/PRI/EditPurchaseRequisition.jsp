...
<tr>
<td align=center>
<b>Edit Purchase Requisition</b>
</td>
</tr>
<tr>
<td align=right>
<a href="PurchaseRequisition.jsp"><font><b>BACK</b></font><a> &nbsp; &nbsp; &nbsp;
</td>
</tr>
</table>
<br>
...
qry=qry+" PRNO='"+mPRNO+"' and nvl(DOCMODE,'N')='D' and nvl(DEACTIVE,'N')='N' ";
...
%>
	<form name="frm1"  method="post" action="EditPurchaseRequisitionAction.jsp">
...
<form name="frm3"  method="post" action="PurchaseFinalizeAct.jsp">
...
int ctr=0;
	...
	%>
		...
		<td NOWRAP><a href="EditPurchaseRequisitionDet.jsp?PRNO=<%=mPRNO%>&amp;ITEMCODE=<%=rs.getString("ItemCode")%>&amp;POCKETCODE=<%=rs.getString("POCKETCODE")%>&amp;COMPANYCODE=<%=mCompanyCode%>">Edit</a></td>
		<td NOWRAP><a href="EditPurchaseRequisitionDeactive.jsp?PRNO=<%=mPRNO%>&amp;ITEMCODE=<%=rs.getString("ItemCode")%>&amp;POCKETCODE=<%=rs.getString("POCKETCODE")%>&amp;COMPANYCODE=<%=mCompanyCode%>">Delete</a></td>
		</tr>
	<%
		} // closing of while
	%>
...
<input type=radio name=Final value="Y"><b>Yes</b>
<input type=radio name=Final checked=true value="N"><b>No</b>&nbsp;&nbsp;
	<input type=submit value="Finalize Selected PR">
</td>
</tr>
