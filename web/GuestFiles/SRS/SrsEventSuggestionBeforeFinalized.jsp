...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Student Reaction Survey Report (SRS Suggestions) ] </TITLE>
...
<tr>
<TD colspan=0 align=middle bgcolor="#00008b"><font color="white" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>SRS Event Suggestions</b></font></td>
</tr>
</TABLE>
<%
String mEnm="";
...
qry=qry+" and SUBJECTCODE='"+mSubj+"' And EmployeeID='"+mEMPID+"' and '"+mLTP+"' like '%'||ltp||'%'  and SUGGESTION is not null and nvl(deactive,'N')='N' and nvl(IsAbusing, 'N')='N'";
