...
<tr>
<TD colspan=0 align=middle ><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>SRS Submitted by Students</b></font></td>
</tr>
</TABLE>
<%
String mEnm="";
...
<%
	...
	qry=qry+" and (FSTID, studentid) IN(select FSTID, studentid from V#SRSEVENTDETAIL";
	qry=qry+" where PROGRAMCODE='"+mProg+"'";
	qry=qry+" and SECTIONBRANCH='"+mSec+"'";
	qry=qry+" and SUBSECTIONCODE='"+mSubs+"'";
	qry=qry+" and SUBJECTID='"+mSubjID+"'";
