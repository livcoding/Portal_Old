...
//*********************************************************************
			...
			qry=qry+" subjectmaster B where (A.LTP='L' OR A.PROJECTSUBJECT='Y') and A.employeeid='"+mDMemberID+"' and A.examcode='"+mExamCode+"' and A.facultytype=decode('"+mDMemberType+"','E','I','E') ";
			...
			qry=qry+" SUBJECTMASTER B where A.LTP='L' and A.COORDINATORID='"+mDMemberID+"' and A.EXAMCODE='"+mExamCode+"' and A.COORDINATORTYPE=decode('"+mDMemberType+"','E','I','E') ";
