...
String mMemberType="";
String mDMemberType="";
String mMemberCode="", mFaculty="", mFacCode="", mEvent="", mSubevent="",mSubjID="";
String mDMemberCode="";
...
long mAvailable=0, mWeight=0, mTotPerm=100, mAbcd=0;
	...
	if (request.getParameter("SUBJECTID").toString().trim()==null)
	{
		mSubjID="";
	}
	else
...
<table bgcolor=#fce9c5 class="sort-table" id="table-1" bottommargin=0 rules=columns topmargin=0 cellspacing=0 cellpadding=0 border=1 align=center width="90%">
	...
	<%
		...
		qry=qry+" AND A.SUBJECTID='"+mSubjID+"' and A.EMPLOYEEID='"+mChkMemID+"'";
...
qry1=qry1+" AND A.SUBJECTID='"+mSubjID+"' and A.EMPLOYEEID='"+mChkMemID+"'";
...
<%
		if(request.getParameter("x")!=null)
		{
			...
			//---------------
				...
				qry2=qry2+" and EXAMCODE='"+mECode+"' and SUBJECTID='"+mSubjID+"' and EMPLOYEEID='"+mChkMemID+"')";
			//	out.print(qry2);
