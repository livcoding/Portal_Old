...
qry=qry+" (Select FF.subjectID from facultysubjecttagging FF where FF.InstituteCode='"+mInst+"' And FF.examcode in (Select DD.ExamCode from DATESHEET DD ";
...
//	{
	...
	qry=qry+" nvl(A.subjectID,' ')subjectID,nvl(B.subject,' ')||' ('||nvl(B.subjectcode,' ')||')' subject from DATESHEETDATA A, ";
	qry=qry+" SUBJECTMASTER B where A.institutecode='"+mInst+"' and  ";
