...
//------------------End of 'L' Percentage--------------------
%>
                        <td ALIGN=left>&nbsp;<a Title="View Date wise Student 'L' Attendance" target=_New href="ViewAttendanceSummaryReportDet.jsp?RightsID=<%=mRightsID%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=L&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>"><font color=""><b><%=QryPercDecimal%></b> %</font></a></td>
                        <%
                           }
                           //else
                           //{
...
//------------------End of 'T' Percentage--------------------
%>
                        <td ALIGN=left>&nbsp;<a Title="View Date wise Student 'T' Attendance" target=_New href="ViewAttendanceSummaryReportDet.jsp?RightsID=<%=mRightsID%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=T&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>"><font color=""><b><%=QryPercDecimal%></b> %</font></a></td>
                        <%
                           }
                           //else
                           //{
%>
                        ...
                        %>
                        <td ALIGN=CENTER>&nbsp;<a Title="View Date wise Student 'P' Attendance" target=_New href="ViewAttendanceSummaryReportDet.jsp?RightsID=<%=mRightsID%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=LT&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>"><font color=""><b><%=QryPracPercDecimal%></b> %</font></a></td>
                        <%	
                           }
                           //else
                           //{
...
//------------------End of 'P' Percentage--------------------
%>
                        <td ALIGN=left>&nbsp;<a Title="View Date wise Student 'P' Attendance" target=_New href="ViewAttendanceSummaryReportDet.jsp?RightsID=<%=mRightsID%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=P&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>"><font color=""><b><%=QryPercDecimal%></b> %</font></a></td>
                        <%
                           }
                       //else
                       //{
