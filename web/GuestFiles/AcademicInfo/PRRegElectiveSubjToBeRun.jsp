	...
	if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals(""))
	{
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
			...
			qry=" SELECT  a.EXAMCODE,ENDATE from PREVENTMASTER a WHERE a.INSTITUTECODE='"+ mInstitute +"' and a.ExamCode in (Select PREREGEXAMID exam from COMPANYINSTITUTETAGGING Where COMPANYCODE='"+mComp+"' And INSTITUTECODE='"+mInst+"') and nvl(a.PRCOMPLETED,'N')='N' and ENDate is not null and fromdate is not null and nvl(a.PRBROADCAST,'N')='Y'";
qry=qry+" AND NVL(PRREQUIREDFOR,'S')<>'S' AND NVL(a.DEACTIVE,'N')='N' And (a.INSTITUTECODE, a.PREVENTCODE) In ";
			...
			{		
				...
				try
				{
					qry="Select PREREGEXAMID exam from DEFAULTVALUES";
				...
				rs=db.getRowset(qry);
					...
					if (mST.equals("E"))
						...
						qry=qry+" Group By BDT.PROGRAMCODE ,BDT.ACADEMICYEAR,BDT.TAGGINGFOR, BDT.SECTIONBRANCH,B.ElectiveCode,A.SubjectCode,B.SubjectID,nvl(A.Subject,A.SubjectCode), nvl(C.SubjectRunning,'N')";
