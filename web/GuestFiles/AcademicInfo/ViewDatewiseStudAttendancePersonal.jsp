...
<tbody>
<%
	qry="select distinct nvl(FSTID,' ')FSTID, to_char(ATTENDANCEDATE,'DD-MM-YYYY')ADate, to_char(classtimefrom,'HH:MI PM')Classf, to_char(classtimeupto,'HH:MI PM')Classt, nvl(ATTENDANCETYPE,' ')CType, nvl(Programcode,' ')Prog, nvl(Sectionbranch,' ')Sec, nvl(Subsectioncode,' ')Sub from V#STUDENTATTENDANCE ";
