...
<table id=id2 cellpadding=1 cellspacing=0 width="90%" align=center rules=groups border=3>
<!--Institute****-->
...
<marquee behavior=alternate scrolldelay=200 width=50%><a href='AttendanceofPreviousDay.jsp'>
<font color=blue><b>Excuse/Remarks for previous day Attendance</b></font></a></marquee>
...
&nbsp; &nbsp; <INPUT Type="submit" Value="Show/Refresh">
	...
	<font color=red><b># Once you submit the attendance, you can not change the same.</b></font>
	<thead>
	<tr bgcolor="#ff8c00">
