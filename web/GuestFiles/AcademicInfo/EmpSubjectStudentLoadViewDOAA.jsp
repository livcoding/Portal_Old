...
try
{
	...
	qry=qry+" nvl(Deactive,'N')='N' and INSTITUTECODE='"+mInstitute+"' and Nvl(LOCKEXAM,'N')='N' and Nvl(FINALIZED,'N')='N' order by EXAMPERIODFROM DESC";
	//out.print(qry);
	rs=db.getRowset(qry);
...
{ 
	...
	qry=qry+" and nvl(FINALIZED,'N')='Y' and NVL(DEACTIVE,'N')='Y' ) AND A.INSTITUTECODE='"+mInstitute+"' AND A.SUBJECTID=B.SUBJECTID"; 
...
%>
	...
	&nbsp;
	<marquee  scrolldelay=225 width=55% behavior=alternate><A href="../../Images/PageSetupXL.bmp" Title="Instruction before print a Students List" Target=_New><font size=3 color=Blue><b>Recommended Page Setup: Paper Size - A4 and Top/Bottom Margin - 0.25</b></font></a></marquee>
	</td ></tr>
	</table>
	</form>
