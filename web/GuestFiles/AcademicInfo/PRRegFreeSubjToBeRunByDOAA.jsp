...
qry=" SELECT  a.EXAMCODE,ENDATE from PREVENTMASTER a WHERE a.INSTITUTECODE='"+ mInstitute +"' and nvl(a.PRCOMPLETED,'N')='N' and ENDate is not null and fromdate is not null and nvl(a.PRBROADCAST,'N')='Y'";
			...
			{		
				...
				try
				{
					qry="Select PREREGEXAMID exam from COMPANYINSTITUTETAGGING Where COMPANYCODE='"+mComp+"' And INSTITUTECODE='"+mInst+"'";
					rs=db.getRowset(qry);
