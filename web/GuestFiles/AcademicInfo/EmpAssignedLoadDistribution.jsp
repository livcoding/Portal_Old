	...
	if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals(""))
	{
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
				...
				<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>Assigned Load List</B></TD>
				</font></td></tr>
				</TABLE>
...
//--------------------------------------------SELF-------------------------------------
				...
				<table width=100%>
				<tr><td align=right><B>JIIT/DEPT/FT/03<b></td></tr>
				<%
...
//--------------------------------------------HOD-------------------------------------
					if(mType.equals("H"))
					{
						qry=" select Distinct A.FACULTYID, A.FACULTYTYPE, B.EMPLOYEENAME||' ['||B.EMPLOYEECODE||']' EMPLOYEENAME,";
...
//--------------------------------------------DOAA-------------------------------------
					else if(mType.equals("D"))
					{
						...
						qry=qry+" and A.COMPANYCODE=b.COMPANYCODE and A.facultyTYPE=b.EMPLOYEETYPE and ";
						qry=qry+" B.DEPARTMENTCODE=C.DEPARTMENTCODE AND B.DESIGNATIONCODE=D.DESIGNATIONCODE AND A.SUBJECTID=E.SUBJECTID and a.institutecode=e.institutecode";
						qry=qry+" and A.INSTITUTECODE='"+mInstitute+"' and a.COMPANYCODE='"+mCompany+"' And EXAMCODE='"+mE+"' and STATUS='"+mShowLoadOn+"' and B.DEPARTMENTCODE='"+QryDept+"' Order By EMPLOYEENAME";
					}
//--------------------------------------------SELF-------------------------------------
					else
					{
						...
						qry=qry+" B.DEPARTMENTCODE=C.DEPARTMENTCODE AND B.DESIGNATIONCODE=D.DESIGNATIONCODE AND A.SUBJECTID=E.SUBJECTID and a.institutecode=e.institutecode";
						qry=qry+" and A.INSTITUTECODE='"+mInstitute+"' and a.COMPANYCODE='"+mCompany+"' And EXAMCODE='"+mE+"' and STATUS='"+mShowLoadOn+"' and B.DEPARTMENTCODE='"+QryDept+"'";
						qry=qry+" And A.FACULTYID='"+mChkMemID+"' Order By EMPLOYEENAME";
					}
					//out.print(qry);
					rs=db.getRowset(qry);
					while(rs.next())
				...
				<tr>
				<td align=center><b><font size=2>Head, SMCA</font></b></td>
				<td align=center><b><font size=2>Member</font></b></td>
				<td align=center><b><font size=2>Member</font></b></td>
				</tr>
				<tr>
				<td colspan=3 align=center>*<font size=2>Basic Maths of M.Sc. (Bio tech) and M.Sc. (Chemistry) to be clubbed in lecture.</font></td>
				</tr>
				<tr>
