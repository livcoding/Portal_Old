...
//192.168.4.221   juet4guna
		...
		<tr>
		<td class="labelcell" >
		<a href="DepartmentLinksPage.jsp?ShowStatus=ALL&amp;VacancyCode=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>"> <font  size=2><b>* Resumes to be reviewed </td><td> <%=mALLSum%> </td>
		</tr>
		
		<tr bgColor="lightgreen">
		<td class="labelcell">
		<a href="DepartmentLinksPage.jsp?ShowStatus=S&amp;VacancyCode=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>"> 	<font color=green size=2><b>* Resumes Shortlisted  </a></td><td> <%=mTSelected%> </td>
		</tr>

		<tr bgColor="pink">
		<td class="labelcell">
		<a href="DepartmentLinksPage.jsp?ShowStatus=R&amp;VacancyCode=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>"><font color=red size=2><b>* Resumes Not Shortlisted </a> </td><td> <%=mTReject%> 		</td>
		</tr>
	
		
		<tr bgColor="white">
		<td class="labelcell">
		<a href="DepartmentLinksPage.jsp?ShowStatus=N&amp;VacancyCode=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>">	<font color=blue size=2><b>* Resume Yet to be Processed  </a></td><td> <%=mTNotProcess%> 		</td>
		</tr>
		</table>
		</form>
