...
//		mTNotProcess=mALLSum-(mTReject+mTSelected);
		...
		<tr>
		<td class="labelcell" >
		<a href="HodLinks.jsp?ShowStatus=ALL&amp;Vacancy=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>"> <font  size=2><b>*	Resumes to be reviewed </td><td> <%=mALLSum%> </td>
		</tr>
		
		<tr bgColor="lightgreen">
		<td class="labelcell">
		<a href="HodLinks.jsp?ShowStatus=S&amp;Vacancy=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>"> 	<font color=green size=2><b>* Resumes Shortlisted  </a></td><td> <%=mTSelected%> </td>
		</tr>

		<tr bgColor="pink">
		<td class="labelcell">
		<a href="HodLinks.jsp?ShowStatus=R&amp;Vacancy=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>"><font color=red size=2><b>*	Resumes Not Shortlisted </a> </td><td> <%=mTReject%> 		</td>
		</tr>
	
		
		<tr bgColor="white">
		<td class="labelcell">
		<a href="HodLinks.jsp?ShowStatus=N&amp;Vacancy=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>">	<font color=blue size=2><b>* Resume Yet to be Processed  </a></td><td> <%=mTNotProcess%> 		</td>
		</tr>
		...
		<a href="HodLinks.jsp?ShowStatus=ALLSR&amp;Vacancy=<%=mVacCode%>&amp;DeptCode=<%=mDeptCode%>&amp;INSTITUTECODE=<%=mInst%>&amp;COMPANYCODE=<%=mComp%>">	<font color=blue size=2><b>* All Rejected Resume Processed in Inital/Final Level  ---  <%=mALLSRSum%> </a>
		</P>
		</form>
