...
memailid=rs.getString("EMAILID").toString().trim();
	...
	//out.print(mStatus+"sdsss"+rs.getString("STATUS").toString().trim());		
				...
				qry1="SELECT  nvl(SHORTLISTSEQNO,0)SHORTLISTSEQNO ,  nvl(STATUS,' ')STATUS,nvl(REMARKS,' ')REMARKS    FROM HR#APPLICANTSHORTLISTMASTER a WHERE INSTITUTECODE='"+mInst+"' AND  VACANCYCODE='" + mVacCode + "' AND APPLICANTID ='"+mApplicantID+"'  and ";
				if(mShow.equals("ALL"))
		{
