...
//out.print(mSHORTLISTSEQNO+"mSHORTLISTSEQNO");
	...
	//out.print(mStatus+"sdsss"+rs.getString("STATUS").toString().trim());
				...
				qry1="SELECT  nvl(SHORTLISTSEQNO,0)SHORTLISTSEQNO," +
                        " nvl(STATUS,' ')STATUS,nvl(REMARKS,' ')REMARKS  FROM HR#APPLICANTSHORTLISTMASTER a WHERE INSTITUTECODE='"+mInst+"' AND  VACANCYCODE='" + mVacCode + "' AND APPLICANTID ='"+mApplicantID+"' and  status =decode  ('"+mShow+"' ,'ALL',nvl(status,'N'),'"+mShow+"' ) and ";
				if(mShow.equals("ALL"))
		{
