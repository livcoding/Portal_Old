...
if(hht==1) {
	...
	qry2+=" "+rstu.getString("AA")+"  NVL (SUM (DECODE (xyz.eventsubevent, '"+rstu.getString("SUBEVENTCODE")+"', total, 0)),  '0'  )    ";
	 ...
	 qry2+="  ) T1T2T3Total from ( select ";
					...
					qry2+=" a.studentid='"+mStudidInit+"' and a.fstid in ("+xFSTID+" ) and a.examcode='"+mExamCode+"' and a.INSTITUTECODE='"+mInst+"'  AND A.INSTITUTECODE=B.INSTITUTECODE and a.examcode=b.examcode  and ";
...
Qrycut="select ATTENDANCEPERCENTAGE,MASSCUTS,TATOTAL, NVL ( ( (CASE WHEN (TATOTAL - Masscuts) < 0 THEN TATOTAL  ELSE  Masscuts  END)),0       )NETMARKSCUT from STUDENTGRADEMASSCUTS where fstid  IN ("+xFSTID+" ) and studentid='"+mStudidInit+"'";
