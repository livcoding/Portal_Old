...
String  Qryapimr="";  ResultSet rsiimr=null; int APIMCA=0 ,hhhh=0,hhh=0;
...
<TABLE bgcolor=#fce9c5  class="sort-table" id="table-11"  ALIGN=CENTER rules=COLUMNS     BORDER=1> 
<tr>
...
while (x < mTotalStudents+1) 
{
 ...
 %>
	...
	<td><b><font color=white >Sub-Section</font></b></td>
...
<td align=right><b><font color=white >Total Final<br>Marks</font></b></td>
...
// out.print(Qryapimr);
 ...
 if(rsiimr.next()   &&( mGrad.equals("A+") || mGrad.equals("A")) && !mGradInit.equals("F")  )
	{
hhhh=8;
		mGrad="B+";
	%>
...
<td>F</td>
	...
	qryttt=" Select 'Y' from  debarstudentdetail where studentid IN  ('"+rs.getString("studentid")+"') and (UFM='Y' OR ABSENTCASE='Y' OR DEBAR='Y') and examcode='"+mExamCode+"' and institutecode='"+mInst+"' and fstid in ("+mCheckFstid+")  ";
rsttt=db.getRowset(qryttt);
//out.print(qryttt);
	if(rsttt.next())
	{
