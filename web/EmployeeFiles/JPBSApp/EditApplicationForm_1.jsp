...
String mCHKCMAT="",mCMATDATE="",mSCORECMAT="",mPERCMAT="";
...
<tr><td ALIGN=middle><FONT 
      face=Verdana><STRONG><FONT size=4>MBA APPLICATION FORM - 2013 </font><br><FONT size=2>(Do not submit without copy of CAT/MAT/CMAT/GMAT score card)</FONT></STRONG>
      <BR>
</FONT>                         
</td></tr>
</table>
...
if(rs3.next())
	...
	String  mCALL2="",mCATDATE="",mMATDATE="",mGMATDATE="",mCMATRANK="";
	qry5="SELECT  TESTCODE, PERCENTAGE PERCENTAGE,COMPOSITESCORE COMPOSITESCORE,CHECKSCORE,CALL1,CALL2,CALL3,to_char(RESULTVALIDUPTO,'dd-mm-yyyy')RESULTVALIDUPTO,NVL(RANK,'')CMATRANK FROM  c#MBATESTSCORE where  APPLICATIONSLNO ='"+mAppSlno+"' and APPLICATIONSLNO like '"+mAppYear+"%' ";
out.println(qry5);
...
while(rs5.next() )
	...
	mPERCAT=(mPERCAT==null)?"":mPERCAT.trim();
		mSCORECAT=(mSCORECAT==null)?"":mSCORECAT.trim();
...
mCMATRANK=rs5.getString("CMATRANK");
...
<%
qry4="SELECT  nvl(QUALIFICATIONCODE,' ')QUALIFICATIONCODE,nvl(QUALIFICATIONDESC,' ')QUALIFICATIONDESC,NVL(BOARD,' ')BOARD, NVL(PASSINGYEAR,'')PASSINGYEAR, NVL(STREAM,' ')STREAM,nvl(percentage,0) percentage, nvl(DOCUMENT,' ')DOCUMENT FROM  c#QUALIFICATION where  APPLICATIONSLNO ='"+mAppSlno+"'  and APPLICATIONSLNO like '"+mAppYear+"%' ";
  ...
  <br>
	<TABLE BORDER=1 ALIGN=center cellspacing=2 cellpadding=2>
			...
			<td><font face='Verdana' size=1 ><b>Percentile/Total Percentile	</b></td>
				<td><font face='Verdana' size=1 ><b>Rank
...
<INPUT TYPE="text" NAME="CMATRANK" value="<%=mCMATRANK%>"   SIZE=6 MAXLENGTH=8 tabIndex=44>
&nbsp;</TD>
...
<!-- <a href="javascript:NewCal('GMATDATE','ddmmyyyy')"><img src="../images/cal.gif" width="16" height="16" border="0" alt="Pick a Date"></a> -->
			...
			<INPUT Type="hidden" ID="GMAT" Name="GMAT" Value="GMAT" >
				...
				<TD><INPUT TYPE="text" NAME="GMATCOMP" onkeypress="return isNumber(event)"  value="<%=mSCOREGMAT%>"  SIZE=3 MAXLENGTH=6 tabIndex=44></TD>
				<TD><INPUT TYPE="text" NAME="GMATPER" value="<%=mPERGMAT%>"   SIZE=3 MAXLENGTH=5 tabIndex=44></TD>
				
<TD>&nbsp;</TD>

				<TD><INPUT TYPE="text" NAME="GMATDATE"  id="GMATDATE"  value="<%=mGMATDATE%>"  onClick="return ValidGMATDATE(GMATDATE.value) " onChange="return ValidGMATDATE(GMATDATE.value) "    tabIndex=44  SIZE=8 MAXLENGTH=10><font color=green face=arialblack  size=1><b> (DD-MM-YYYY)&nbsp;</b></font>
<!-- <a href="javascript:NewCal('GMATDATE','ddmmyyyy')"><img src="../images/cal.gif" width="16" height="16" border="0" alt="Pick a Date"></a> -->
</TD>	</TABLE>
...
String qrycomp="SELECT APPLICATIONSLNO, EXPSLNO, COMPANYNAME,    DESIGNATION,to_char(nvl(WORKDATEFROM,SYSDATE),'dd-MM-yyyy')  WORKDATEFROM,to_char(nvl(WORKDATETO,SYSDATE),'dd-MM-yyyy')   WORKDATETO,    WORKINGAREA FROM  c#MBAAPPLICANTWORKEXP WHERE APPLICATIONSLNO='"+mAppSlno+"' and APPLICATIONSLNO like '"+mAppYear+"%' order by EXPSLNO";
...
qry="SELECT APPLICATIONSLNO, OBJECTIVESLNO, CAREEROBJECTIVE,    JBSHELP FROM  c#MBAOBJECTIVE where APPLICATIONSLNO='"+mAppSlno+"' and APPLICATIONSLNO like '"+mAppYear+"%' ";
rs=db.getRowset(qry);
if(rs.next())
	{
...
&nbsp; &nbsp;&nbsp; &nbsp;
	...
	%>	 
	 <br>
	 e) Score Card of CAT/MAT/CMAT/GMAT :
		   <%
