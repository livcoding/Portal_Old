...
function ChangeCase()
	{
		...
		LoginForm.ADDRESS2.value = LoginForm.ADDRESS2.value.toUpperCase();
                ...
                LoginForm.PADDRESS1.value = LoginForm.PADDRESS1.value.toUpperCase();
		LoginForm.PADDRESS2.value = LoginForm.PADDRESS2.value.toUpperCase();

                LoginForm.Religion.value = LoginForm.Religion.value.toUpperCase();
                LoginForm.MotherName.value = LoginForm.MotherName.value.toUpperCase();

		LoginForm.CITY.value = LoginForm.CITY.value.toUpperCase();
                LoginForm.PCITY.value = LoginForm.PCITY.value.toUpperCase();
		Other();
		Grad();
	}
...
if(currdate>GG)
	...
	*/
		...
		if((document.LoginForm.DDAMT.value)<1000)
				{
					alert('DD Amount should be 1000');
					LoginForm.DDAMT.focus();
					return(false);
		}
...
<tr><td ALIGN=middle><FONT
      face=Verdana><STRONG><FONT size=4>MBA APPLICATION FORM - 2020-22 . </font><br><FONT size=2>(Do not submit without copy of CAT/MAT/CMAT/GMAT score card)</FONT></STRONG>
      <BR>
</FONT>
</td></tr>
</table>
...
if(mFlag==1 )
{
qry="select 'Y' from C#MBAAPPLICATIONMASTER where APPLICATIONNO='"+mIntApplication+"' and nvl(deactive,'N')='N'  and APPLICATIONSLNO like '2020%' ";
//out.print(qry);
rs=db.getRowset(qry);
...
<INPUT Type="radio" ID="Gender" Name="Gender" Value="F"  tabIndex=5>Female
<INPUT Type="radio" ID="Gender" Name="Gender" Value="T"  tabIndex=5>Transgender
    </FONT>
      </SELECT>
<FONT face=Verdana>
</FONT>
...
<td colspan=3 align=left><FONT face=Verdana>7. Religion (i.e. Hindu/Muslim/Sikh/Jain/Christian/Other)
      :  &nbsp;   &nbsp; &nbsp;&nbsp;   &nbsp; &nbsp;&nbsp;   &nbsp; &nbsp;</FONT>   <INPUT size=15 maxlength=20 Id="Religion" Name="Religion"
      tabIndex=3  LANGUAGE=javascript onfocusout="return ChangeCase()"><FONT
      face=Verdana><FONT       color=#ff4500>*</FONT> </FONT>
</td>
</tr>
...
<tr>
    <td colspan=3>
<FONT face=Verdana size=2>9.Aadhar No:<input ID="AadharNo" Name="AadharNo"  onkeypress="return isNumber(event)" MaxLength=20 Size=15 tabIndex=19  ></FONT>
    </td>
</tr>
<tr>
<td colspan=3><FONT face=Verdana size=2>10. Current Residential Address</FONT>
<br>
...
</FONT><FONT face=Verdana size=2>Land Line No:<input ID="LANDLINENO" Name="LANDLINENO"  onkeypress="return isNumber(event)" MaxLength=20 Size=15 tabIndex=19  ></FONT>
</td>
</tr>
<tr>
<td colspan=3>
<FONT face=Verdana> 11. Email Address (Mandatory	):&nbsp; <INPUT ID="email" Name="email" maxLength=50 size=50 tabIndex=20> <FONT  color=#ff4500>*</FONT>
</FONT>
</td>
</tr>
...
<tr>
<td colspan=3>
<FONT face=Verdana>12. Nationality: &nbsp;&nbsp;&nbsp;&nbsp; <INPUT Type="radio" ID="Nationality" Name="Nationality" Value="INDIAN" Checked tabIndex=21>Indian
...
<td colspan=4 align=left><br><FONT face=Verdana>16. Describe your most important Career Objectives (Max 200 Words) <br>
  &nbsp;&nbsp;&nbsp; <INPUT TYPE="text" NAME="Career" id="Career" maxlength=200 tabIndex=45  size=120 >
...
<td colspan=4 align=left><br><FONT face=Verdana>17. Describe how will the JBS MBA help you in achieving the above career goal ? <br>
...
<tr>
<td colspan=4 align=left><br><FONT face=Verdana>18.Bank Details: (Required in case of Refund) (ONLY PARENT/SELF) <br>
  &nbsp;&nbsp;&nbsp;
  <tr>
      <td>&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp
          <font face=Verdana>Name of Account Holder
            &nbsp;&nbsp;&nbsp;</font> <INPUT TYPE="text" NAME="NAMEOFACHOLDER" id="NAMEOFACHOLDER" maxlength=1000 tabIndex=45  size=50 >
            &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp
          <font face=Verdana>Bank Name
            &nbsp;&nbsp;&nbsp;</font> <INPUT TYPE="text" NAME="NAMEOFBANK" id="NAMEOFBANK" onkeypress="return isNotNumber(event)" maxlength=1000 tabIndex=45  size=50 >
      </td>
  </tr>
  <tr>
      <td>&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp
          <font face=Verdana>Account Number
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font> <INPUT TYPE="text" NAME="BANKACCOUNTNO" id="BANKACCOUNTNO"  maxlength=1000 tabIndex=45  size=50 >
            &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp
          <font face=Verdana>Branch Name
            &nbsp;</font> <INPUT TYPE="text" NAME="BRANCHNAME" id="BRANCHNAME" maxlength=1000 tabIndex=45  size=50 >
      </td>
  </tr>
  <tr>
      <td>&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp
          <font face=Verdana>Address of Bank
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font> <INPUT TYPE="text" NAME="BANKADDRESS" id="BANKADDRESS" maxlength=1000 tabIndex=45  size=50 >
            &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp
          <font face=Verdana>IFSC Code
            &nbsp;&nbsp;&nbsp;</font> <INPUT TYPE="text" NAME="IFSCCODE" id="IFSCCODE" maxlength=1000 tabIndex=45  size=50 >
      </td>
  </tr>
...
19. Documents Attached :  CheckSheet <br>
a) 10TH  :  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
...
<%
 ...
 <tr><td><font size="03%"> 21. Mention three GD/PI Center preferences, where you would like to attend. &nbsp;(1=First choice, 2=Second Choice and 3=Third Choice) </font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                             <%
