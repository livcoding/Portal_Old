...
function button1_onclick(currdate) 
	{
		...
		if(document.LoginForm.CATPER.value=="" && document.LoginForm.MATCOMP.value=="" && document.LoginForm.GMATCOMP.value=="")
				{
...
if(currdate>GG)
		...
		if((document.LoginForm.DDAMT.value)<1200)
				{
					alert('DD Amount should be 1200');
					LoginForm.DDAMT.focus();
					return(false);
		}
...
<tr><td ALIGN=middle><FONT 
      face=Verdana><STRONG><FONT size=4>MBA APPLICATION FORM - 2011 </font><br><FONT size=2>(For Working Executives)</FONT></STRONG>
      <BR>
</FONT>                         
</td></tr>
</table>
...
<form method=post action="WorkExpApplicationFormAction.jsp" name="LoginForm">
...
mIntApplication=mIntApplication+"W";
//out.print(mIntApplication+"mIntApplication");
//if(!mIntApplication.equals(" ") )
if(mFlag==1 )
{
qry="select 'Y' from C#MBAAPPLICATIONMASTER where APPLICATIONNO='"+mIntApplication+"' AND APPLICATIONSLNO like '2011MBAWE%' and nvl(deactive,'N')='N'  ";
//out.print(qry);
rs=db.getRowset(qry);
...
<td colspan=3 align=left><br><FONT face=Verdana>10. Work Experience <br>
  <br>
	<TABLE BORDER=1 ALIGN=center cellspacing=2 cellpadding=2>
			<tr>
			...
			<TR>
				<TD valign="top">
				<INPUT TYPE="text" NAME="COMPANY<%=i%>" id="COMPANY<%=i%>"  tabIndex=39  SIZE=25 MAXLENGTH=200>
				</TD>
				<TD valign="top">
				<INPUT TYPE="text" NAME="AREA<%=i%>" id="AREA<%=i%>"    tabIndex=39  SIZE=25 MAXLENGTH=200>
				</TD>
				<TD valign="top"> <INPUT TYPE="text" NAME="DESIGNATION<%=i%>" id="DESIGNATION<%=i%>"  tabIndex=39 SIZE=25 MAXLENGTH=200>
				</TD>
				<TD >
				<INPUT TYPE="text" NAME="WORKDATEFROM<%=i%>" id="WORKDATEFROM<%=i%>"   tabIndex=39  SIZE=8 MAXLENGTH=10>
				<font color=green face=arialblack> <font size=1><b> <Br>(DD-MM-YYYY)&nbsp;</b></font>
				</TD>
				<TD>
				<INPUT TYPE="text" NAME="WORKDATETO<%=i%>" id="WORKDATETO<%=i%>"   tabIndex=39  SIZE=8 MAXLENGTH=10>
				<font color=green face=arialblack> <font size=1><b> <br>(DD-MM-YYYY)&nbsp;</b></font>
				</TD>
			</TR>
			<%
