...
<tr><td ALIGN=middle><FONT 
      face=Verdana><STRONG><FONT size=4>MBA APPLICATION FORM - <%=mYear%>-<%=mNextYear%> </font><br><FONT size=2>(Do not submit without copy of  CAT/MAT/CMAT/GMAT/XAT score card)</FONT></STRONG>
      <BR>
</FONT>                         
</td></tr>
</table>
...
if(rs1.next())
	...
	%>
<td colspan=4 align=left><br><FONT face=Verdana>12. Describe how will the JBS MBA help you in achieving the above career goal ? <br>
...
<%
	...
	%>	
15. Registration fee of Rs. 1,250/- by a Demand Draft favoring Jaypee Business
