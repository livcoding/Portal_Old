...
if (RsChk.next() && RsChk.getString("SL").equals("Y"))
   {
	...
	<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana">Center cum Subjectwise Students Strength</font></td></tr>
	</TABLE>
	<table width=100% bottommargin=0 rules=groups border=1 topmargin=0 cellspacing=0 cellpadding=0>
	<!--************Institute*************-->
