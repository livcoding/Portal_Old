...
<table align=center width="100%" bottommargin=0 topmargin=0>
 <tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana"><b><u><FONT SIZE=4>Leave/Timeee Prefernce on Invigilation Duty [Self]</FONT></u></b></font></td></tr>
</table>
...
qry="SELECT NVL(EXAMCODE, ' ') Exam, EXAMPERIODFROM,EXAMPERIODTO, EXCLUDEINATTENDANCE FROM EXAMMASTER WHERE  NVL (Deactive, 'N') = 'N' " +
        " AND institutecode = '"+ mInst +"' AND NVL (LOCKEXAM, 'N') = 'N' AND NVL(EXCLUDEININVIGDUTYSEATPLAN, 'N') = 'N' " +
        "AND NVL(excludeinattendance, ' ') = 'N' AND EXAMPERIODTO >= SYSDATE  ORDER BY examperiodfrom DESC";
//out.print(qry);
	rs=db.getRowset(qry);
