...
int pregraded=0;
String del2="",del1="",del3="",del4="",del5="",xBRK="";
...
function isIntegerD(s)
{
	...
	s = s.toString();
      ...
      //{
         ...
         if (s<27) 
	   {
		alert(" D Marks Can not be less then 27");
		return(false);
...
qry=qry+" and subjectID='"+mSubjectCode+"'  and nvl(DEACTIVE,'N')='N'  AND  STUDENTID NOT IN (SELECT STUDENTID FROM DEBARSTUDENTDETAIL WHERE EXAMCODE='"+mExamCode+"' AND NVL(MEDICALWITHDRAWAL,'N')='Y')  and studentid in (select studentid from studentregistration x where x.examcode='"+mExamCode+"' and NVL(regallow,'N')='Y') ";
rs=db.getRowset(qry);
// out.print(qry);
if(rs.next())
{
