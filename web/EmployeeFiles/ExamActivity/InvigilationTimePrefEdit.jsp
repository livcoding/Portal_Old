...
//
mComp=mComp.equals("J128")?"UNIV":mComp;
//out.print(mComp);
...
function fn_DateCompare()
{
    var mDate1=document.getElementById("TXT1").value;
     ...
     var newdate1 = mDate1.split("-").reverse().join("-");
     var newdate2 = mDate2.split("-").reverse().join("-");
...
<input Name=TXT2 Id=TXT2 Type=text Value='<%=mDate2%>' maxlength=10 size=10></b>
