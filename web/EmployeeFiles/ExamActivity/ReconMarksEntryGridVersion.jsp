				   ...
				   <!-- <INPUT NAME="Excel" id="Excel" Type="button" Value="Click to Export in Excel" onclick="submitForm(this.id)">-->
                          <%}%>
                            ...
                            <td>
                                 ...
                                 <font color="green">Reconcile From Server:<input type="button" value="Reconcile" id="excelUpload" name="excelUpload" onclick="uploadExcel()" ></font>
                         <%}else{%>
                                 <font color="green">Reconcile From Server:<input type="button" value="Reconcile" id="excelUpload" name="excelUpload" onclick="uploadExcel()" disabled></font>
                                <%}%>
                                <!-- <input type="button" id="reconcile" name="reconcile" value="Reconcile Now" onclick="reconcileReport()"> -->
                            </td>
                            </tr>
                            </form>
                                 <tr><td nowrap>&nbsp;</td></tr>
