...
del2="delete from gradecalculationgrades where BREAK#SLNO='"+mBreakSlno+"' and examcode='"+mExamCode+"'  ";
 int a2=db.update(del2);


del1="delete from gradecalculation where BREAK#SLNO='"+mBreakSlno+"' and examcode='"+mExamCode+"'   ";
