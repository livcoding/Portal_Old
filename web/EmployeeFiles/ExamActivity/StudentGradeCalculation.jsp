<%
String  Qryim ="",mSemestertype=""; ResultSet  rsim=null; int  ctim=0;
//mDebarStudID="";

qry2="select distinct a.institutecode,a.fstid fstid,a.ExamCode,nvl(a.Semester,0)Semester,a.semestertype,a.subjectID, a.studentid studentid,";
...
mSemestertype=rs2.getString("semestertype");
//if(mSemestertype.equals("GIP"))
                        //{
                           // System.out.println("--"+mSemestertype);
                           // System.out.println("--"+rs2.getString("studentname"));
...
//System.out.println("1---"+mSemestertype+"--1--"+mGrad1+"--upar--"+mCheckRadio);
if(mCheckRadio.equals("Y"))
{
//System.out.println("2---"+mSemestertype+"--1--"+mGrad1+"--upar--"+mCheckRadio);

if(mDebarGrade.equals("F")  )
	{
//System.out.println("3---"+mSemestertype+"--1--"+mGrad1+"--upar--"+mCheckRadio);
	StudentGradeCalculationMarks2=""+StudentGradeCalculationMarks;
	//mGrad1=rs1.getString("GRADE");
         if(mSemestertype.equals("GIP"))
         {mGrad1="D";
         //System.out.println("344---"+mSemestertype+"--1--"+mGrad1);
         }
        else
        {
            mGrad1="F";
	...
	GradeMatserStudentIDChecked=Studid+"*****"+StudentGradeCalculationMarks2+"$$$$$"+mGrad1+"?????"+mWeigh+"#####"+StudentGradeCalculationMarksAwarded1+"/////"+mMassCut+"%%%%%"+mFst;
		GradeMatserStudentIDArray.add(GradeMatserStudentIDChecked);
                //System.out.println("GradeMatserStudentIDChecked--"+GradeMatserStudentIDChecked);
	}
...
//System.out.println(StudentGradeCalculationMarks+"===11=="+GradeMasterLowerLimit+"====="+mPrevValueNew);
...
//System.out.println("2---"+mSemestertype+"--1--"+mGrad1+"--upar--"+mCheckRadio);
    	...
    	if(StudentGradeCalculationMarks<mPrevValueNew)
				...
				{
//System.out.print("3--"+mSemestertype+"=="+mGrad1+"=="+mPrevValueNew+"--StudentGradeCalculationMarks--"+StudentGradeCalculationMarks);
...
//StudidOLAP=StudidOLAP+"'"+rs2.getString("studentid")+"' , ";
                        ...
                        //added by anoop as discussed with sajjad 27-12-2018 start
                        //System.out.println("1---"+mSemestertype+"--1--"+mGrad1);
                        if(mGrad1.equals("F")&&mSemestertype.equals("GIP"))
                        {
                           mGrad1="D";
                          //System.out.println("2---"+mSemestertype+"--2--"+mGrad1);
                        }
//added by anoop as discussed with sajjad 27-12-2018 end
			mWeigh=rs2.getString("weightage");
...
if(mDebarGrade.equals("F"))
	{
		//mGrad1=rs1.getString("GRADE");
                //System.out.println("mSemestertype--"+mSemestertype);
                 if(mSemestertype.equals("GIP"))
                {
                     mGrad1="D";
                 }
...
//System.out.println("GradeMatserStudentIDInitial--"+GradeMatserStudentIDInitial);
	}
...
mGrad1=rs1.getString("GRADE");
//added by anoop as discussed with sajjad 27-12-2018 start
if(rs1.getString("GRADE").equals("F")&&mSemestertype.equals("GIP"))
                        {
                           mGrad1="D";
                          // System.out.println("3---"+mSemestertype+"--3--"+mGrad1);
                        }
//added by anoop as discussed with sajjad 27-12-2018 end
