...
String 	Studid="",mDetained="",QryPaths="";
...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Grade Subjects PDF Generation ]</TITLE>
...
try
{
	...
	if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals(""))
	{
		...
		mInstitute=  mInst;
				...
				<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><STRONG>Grade Subject PDF Generation </STRONG></TD>
				</font></td></tr>
				</TABLE>
...
<tr>
			...
			<!--*********Pending/Approved**********-->
				...
				*/
				...
				qry=qry+" Where A.INSTITUTECODE=B.INSTITUTECODE AND  A.SUBJECTID=B.SUBJECTID AND A.EXAMCODE='"+QryExam+"' AND  A.INSTITUTECODE ='"+mInstitute+"' AND nvl(A.STATUS,'N') ='A' ";
				...
				{
				%>
				<form Name=frm1 ID=frm1 Action="GradeSubjectPDFAction.jsp" Method=Post>
				...
				<td align=left Title="Student Count" ><font color="white"><b>Total Students</b></font></td>
				
		
				<td align=left ><b><font color="white">&nbsp;<input onClick="un_check()" type="checkbox" id='allbox' name='allbox' value='Y'></font><font color="white">Checked?</font></b></td>
				</tr>
				</thead>
				<tbody>
		...
		<td nowrap><%=rss.getString("TOTALSTUDENT")%></td>
						...
						<td align=left nowrap><input type='checkbox' name='<%=mName1%>' id='<%=mName1%>'  value='A'><FONT COLOR=GREEN>Approved</FONT></td>
				...
				<TR BGCOLOR='#e68a06'><TD colspan=5 ALIGN=CENTER><INPUT Type="submit" Value="Submit"></TD></TR>
				</table>
