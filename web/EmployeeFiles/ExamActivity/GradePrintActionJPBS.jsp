...
int ctr=0;
String mHead="";
String mysubjcode="",mETOD="",mDet="",qryDebar="";
String qrysub="",mNam="",mSc="",mCheckFstid="",mWeightageInit="",qry2="",qryi=""; 
ResultSet rssub=null,rs2=null,rsi=null,rsDebar=null;
...
<TABLE bgcolor=#fce9c5 width="65%" class="sort-table" id="table-1" ALIGN=CENTER rules=COLUMNS CELLSPACING=0 BORDER=1> 
<thead>
<tr bgcolor="#ff8c00">
...
%>
</tr></table><BR><CENTER><B><U>Student Grade Sheet</U></B></CENTER><BR>
<TABLE  width="65%"  bgcolor=#fce9c5 class="sort-table" id="table-1" ALIGN=CENTER rules=COLUMNS CELLSPACING=0 BORDER=1> 
<thead>
<tr bgcolor="#ff8c00">
...
while(rsi.next())
{
	...
	//mDet=rsi.getString("FINALGRADE");
        qryDebar="select * from debarstudentdetail  where EXAMCODE='"+mEC+"' and INSTITUTECODE='"+mInst+"' and studentid='"+rsi.getString("STUDENTID")+"' and subjectid='"+mSC+"' and debar='Y'";
