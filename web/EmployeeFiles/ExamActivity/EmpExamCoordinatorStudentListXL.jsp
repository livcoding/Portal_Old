...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Coordinator Wise Student List in XL ] </TITLE>
...
String mSubjname="",mSubjcode="";

qry="select subject,subjectcode from subjectmaster where institutecode='"+mInst+"' and subjectid='"+mSubj+"' ";
rs=db.getRowset(qry);
if(rs.next())
			{
	mSubjname=rs.getString("subject");
	mSubjcode=rs.getString("subjectcode");
			}
	...
	<form name="frm" method="post" >
			...
			<tr><TD colspan=4 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana"><B>Coordinator Wise Student List in XL </B></TD>
			</font></td></tr>
		...
		<tr>
		<td colspan=4><FONT color=black><FONT face=Arial size=2><STRONG>Exam Code</STRONG>&nbsp;:<%=mExamID%>
		</td>
		</tr>
		<tr>
		<td colspan=4><FONT color=black><FONT face=Arial size=2><STRONG>Subject</STRONG>&nbsp;:<%=mSubjname%>  (<%=mSubjcode%>)
		</td>
		</tr>
