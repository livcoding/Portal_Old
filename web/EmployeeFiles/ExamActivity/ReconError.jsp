<%-- 
    Document   : ReconError
    Created on : 20 Mar, 2017, 3:23:31 PM
    Author     : VIVEK.SONI
--%>
	  ...
	  //-----------------------------
            ...
            if (RsChk1.next() && RsChk1.getString("SL").equals("Y"))
            {
             ...
             if(!Status.equalsIgnoreCase("c")){%>
                 ...
                 <tbody>
                     <tr> <td> File is in Use by another person Please try again Later.....</td> </tr>
                 </tbody>
            </table>
            ...
            <% }else{%>
                 ...
                 <tbody>
                       <tr> <td> File Name is missing........ Please contact to ERP               </td>   </tr>
                 </tbody>
            </table>
