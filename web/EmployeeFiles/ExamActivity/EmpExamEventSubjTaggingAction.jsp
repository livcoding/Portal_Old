...
String mFType="";
String mCurDate="",mAPPLICABLEFOR="";
...
if (session.getAttribute("APPLICABLEFOR")==null)
{
	mAPPLICABLEFOR="";
}
else
{
	mAPPLICABLEFOR=session.getAttribute("APPLICABLEFOR").toString().trim();
}
		...
		if (EXPWEIGHTAGE > 0 && request.getParameter("ExamCode")!=null && request.getParameter("EventSubEventCode")!=null && request.getParameter("SubjectID")!=null)
		{
			if (GlobalFunctions.iSValidDate(mDate1)==true && GlobalFunctions.iSValidDate(mDate2))
			{
				...
				if(EXPWEIGHTAGE>0 && EXPWEIGHTAGE>=WEIGHTAGE && MAXMARKS>0) 
				{
					...
					qry=qry+" and EXAMCODE='"+mExamID+"' and SUBJECTID='"+mSubj+"' and (LTP='L' OR (LTP='P' ) OR LTP='P') and EVENTSUBEVENT='"+mEventCode+"'";
					...
					if(rs.next())
					{
						...
						qry=qry+" and EXAMCODE='"+mExamID+"' and SUBJECTID='"+mSubj+"' and ( LTP='L' OR (LTP='P' ) OR LTP='P')";
...
*/
						...
						qry=qry+" subjectmaster B where (A.LTP='"+mAPPLICABLEFOR+"') and A.employeeid='"+mDMemberID+"' and A.examcode='"+mExamID+"' and A.facultytype=decode('"+mDMemberType+"','E','I','E') ";
						...
						qry=qry+" SUBJECTMASTER B where A.LTP='"+mAPPLICABLEFOR+"' and A.COORDINATORID='"+mDMemberID+"' and A.EXAMCODE='"+mExamID+"' and A.COORDINATORTYPE=decode('"+mDMemberType+"','E','I','E') ";
						...
						while(rs.next())
						{
							...
							qry=qry+" VALUES ('"+rs.getString("FSTID")+"','"+ mEventCode +"','"+mDualMarks+"',to_date('"+mDate1+"','dd-mm-yyyy'),to_date('"+mDate2+"','dd-mm-yyyy'),"+WEIGHTAGE+",'"+MOM+"',"+ MAXMARKS+",Sysdate,'"+mDMemberID+"','"+mDMemberID+"','"+mFType+"',"+mSequenceNo+")";
