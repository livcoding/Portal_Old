...
String mInst="",mCurExamCode="",mMemberID="" ,STUDID="",STUDENTID="";
int  mSemesterNo=0;
...
window.history.forward(1);
	...
	<body  topmargin=0 rightmargin=0 leftmargin=0 bottommargin=0  bgcolor=#fce9c5 background="../Images/Speciman.jpg">
	<br>
<%
try{
  ...
  //-----------------------------
	...
	qry="Select WEBKIOSK.ShowLink('263','"+ mChkMemID+"','"+mChkMType+"','"+mRole+"','"+ mIPAddress +"') SL from dual";
	...
	String mSnm="",mENo="";
	qry="Select StudentName, Enrollmentno from StudentMaster where StudentID='"+STUDENTID+"'";
	//out.print(qry);
...
<%
	qry = "Select  decode(nvl(INDUSTRIALPROJECTGRADE,'F'),'F','Not Completed','Completed') INDUSTRIALPROJECTGRADE from studentindustrialgrade Where InstituteCode='" + mInst + "' and studentid='" + STUDENTID.toString().trim() + "'"; // and  SEMESTER=" + mSemesterNo;
   // out.print(qry);
	  Rs1 = db.getRowset(qry);
      if( Rs1.next())	 
...
<center>
<table width=60%> 
<tr><td valign=bottom><INPUT TYPE="image" SRC="CampusLynx.png"></td>
