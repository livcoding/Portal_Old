...
<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana"><b>Student Wise Grade</b></TD>
</font></td></tr>
</TABLE>
<%
try
{
	...
	if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals("")) 
	{
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
			...
			//out.print(mBreakSlno+"mBreakSlno");
...
//out.print(mCount+"mCount:::mStudentCount"+mStudentCount);
