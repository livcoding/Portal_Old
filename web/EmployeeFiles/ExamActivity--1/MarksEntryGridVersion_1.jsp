			...
			if(rsmm.next())
				    ...
				    mMaxMarks=mMaxmarks+"";
					  ...
					  <CENTER><FONT face=Arial size=2 color=navy><STRONG>Maximum Marks (Full Marks for Evaluation) : </STRONG><%=mMaxmarks%></FONT>
                            ...
                            <CENTER>
							<font size=2 color="RED" face=verdana><B>'A' - for Absent &nbsp; &nbsp; 'M' - for Medical &nbsp; &nbsp; 'U' - for UFM &nbsp; &nbsp;'0' - for UFMarks &nbsp;&nbsp; 'D' - for Debar   &nbsp; &nbsp; 'P' - for Prorata &nbsp; &nbsp;<br>Enter Marks between '0' to '<%=mMaxmarks%>'</B></font></td>
							</CENTER>
...
var myColumn=  nitobi.getComponent('SimpleGrid1').cell.getColumn();
...
//alert( myMasterGrid.getCellObject(myRow,3).getValue().toUpperCase() )
//alert(value);

//alert(myMasterGrid.getCellObject(myColumn,10).getValue().toUpperCase() +"ccc");
/*
...
<font  face="Arial" size="2"><STRONG>No of records changed since last saved:</STRONG></font> <input type="text" readonly="true" size="3" value="0" style="border:none;background-color:#fce9c5;font-weight:bold;font-size:11px;"  id="updated"/>
 ...
 <ntb:textcolumn sortenabled="false" width="100" align="center" label="TotalSum" xdatafld="Sum1" editable="false"></ntb:textcolumn>
						...
						<ntb:textcolumn sortenabled="false" width="150" align="center" label="DebarReadOnly " xdatafld="DebarReadOnly" editable="false"></ntb:textcolumn>
