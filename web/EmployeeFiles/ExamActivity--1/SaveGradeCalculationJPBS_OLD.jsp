...
try
{
	...
	String qrysl="";
		...
		String marks="",MassCuts="",TotalMarks="";
...
if(mStatus==1)
{
	...
	for(int yy =1; yy<=sno;yy++)
	{
		...
		else
		{
			...
			if(rsk.next())
			{
				qry4="UPDATE STUDENTWISEGRADE SET MassCuts='"+MassCuts+"', INITIALMARKS='"+marks+"' ,FINALMARKS='"+TotalMarks+"', INITIALGRADE='"+mGrade+"', FINALGRADE='"+mGrade+"',ENTRYBY ='"+mChkMemID+"',ENTRYDATE=SYSDATE WHERE INSTITUTECODE='"+mInst+"' AND EXAMCODE='"+mExamCode+"' AND FSTID='"+Fstid+"' AND BREAK#SLNO='"+mBreakSlno+"' AND STUDENTID='"+Studid+"'  ";
...
<tr bgcolor="#ff8c00">
	...
	<td><b><font color=white >Student Name</font></b></td>
		...
		<%
			...
			{
			%>
		<td><b><font color=white >Mass Cuts</font></b></td>
			<%
			}
	%>
