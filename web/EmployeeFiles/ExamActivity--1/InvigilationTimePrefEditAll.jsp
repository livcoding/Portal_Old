...
<input Name=TXT2 Name=TXT2 Type=text Value='<%=mPREFTO%>' maxlength=10 size=10></b>
				...
				if(!mtext.equals(""))
				{
					mtext=GlobalFunctions.replaceSignleQuot(mtext);
						...
						if (mDutyHoliDay.equals("Y"))
						{
							...
							qry="UPDATE INVIGILATIONTIMEPREF SET          PREFROMDATE     = to_date('"+mDate1+"','dd-mm-yyyy'),       PRETODATE       = to_date('"+mDate2+"','dd-mm-yyyy'),       DUTYHOLIDAY     = 'Y',           REMARKS         = '"+mtext+"' WHERE  INSTITUTECODE   = '"+mInst+"' AND    COMPANYCODE     = '"+mComp+"' AND    EXAMCODE        ='"+mExam+"' AND    INVIGILATORID   = '"+EmployeeId+"' and  PREFROMDATE     = to_date('"+mDate1+"','dd-mm-yyyy') ";
