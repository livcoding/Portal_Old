...
<%
	qry="select distinct nvl(EMPLOYEEID,' ')Faculty, nvl(EMPLOYEENAME,' ')FacultyName from EMPLOYEEMASTER where CompanyCode='"+mComp+"' and EMPLOYEETYPE in '"+mEmpType+"'";
	qry=qry+" and DEPARTMENTCODE in (select DEPARTMENTCODE from hodlist where employeeid='"+mChkMemID+"' and nvl(deactive,'N')='N') and nvl(deactive,'N')='N'";
