...
// System.out.println(mMarks+" _______"+insertRecords[i].getField("studentid"));
            ...
            if(mMarks.equals(""))
            {
                ...
                {
                qry="Update StudentEventSubjectMarks set MARKSAWARDED1='"+mMarks+"', MARKSAWARDED2='"+mMarks+"', DETAINED='"+mDetained+"', DETAINED2='"+mDetained+"' , ReExam='Y'  Where FSTID='"+insertRecords[i].getField("fstid")+"' and EVENTSUBEVENT='"+mEvent+"' and STUDENTID='"+insertRecords[i].getField("studentid")+"'     ";
                db.update(qry);
           ...
           //  System.out.println(qry);
             ...
             // System.out.println("INSERT - "+qry);
                ...
                db.update(qry);
                int Upd=db.update(qry);
               //S//ystem.out.println("UPDATE - "+qry);%><BR><%
                }
                }
                catch(SQLException e)
                {
