...
%>
   ...
   <span class="submenu" id="sub5">
	...
	{
		%>
		<img src="../Images/bullet4.gif">&nbsp;<A href="../EmployeeFiles/AcademicInfo/NewDailyStudentAttendanceEntry.jsp"
...
<TD><img src="../Images/bull.gif">&nbsp;<A title="FAQ" href="../FAQ/FAQEmployee.HTML" target=_New><FONT face="Times New Roman" color =white size=2><STRONG>FAQ</STRONG></FONT></A></TD></TR></FONT></FONT> 
<%
