...
<%	try{
  ...
  qry=qry+" ) and   exists (select 'y' from V#STUDENTEVENTSUBJECTMARKS b where a.fstid=b.fstid and a.studentid=b.studentid and a.EVENTSUBEVENT=b.EVENTSUBEVENT and (nvl(detained,'N')='D' or nvl(detained,'N')='A' or nvl(marksawarded1,-1)<0 ) and nvl(reexam,'N')='Y' ) order by enrollmentno ";
	...
	qry1=qry1+" AND a.studentid IN ( SELECT DISTINCT studentid   FROM debarstudentdetail                             WHERE NVL (reexamination, 'N') = 'Y' and examcode='"+mEC+"' and subjectID='"+mSC+"' and EVENTSUBEVENT='"+mEventsubevent+"'  ) GROUP BY a.fstid, a.studentid, a.StudentName, a.enrollmentno, a.Semester, a.programcode, a.SECTIONBRANCH, a.subsectioncode";
