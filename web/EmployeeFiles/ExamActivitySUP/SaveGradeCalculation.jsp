...
/*
qryss="select count(studentid) from  studentwisegrade where  InstituteCode='"+mInst+"' and  examcode='"+mExamCode+"' and BREAK#SLNO='"+mBreakSlno+"' and  studentid  in (select studentid from studentmaster where InstituteCode='"+mInst+"' and nvl(deactive,'N')='N') ";
*/
qryss="select nvl(count(studentid),0)cc from studentwisegrade A where A.InstituteCode='"+mInst+"' and A.examcode='"+mExamCode+"' and A.BREAK#SLNO='"+mBreakSlno+"' and  A.studentid  in (select b.studentid from studentmaster B where A.STUDENTID=B.STUDENTID AND A.INSTITUTECODE=B.INSTITUTECODE AND B.InstituteCode='"+mInst+"' and nvl(B.deactive,'N')='N')";
//out.print(qryss);
