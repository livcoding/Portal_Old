...
function getCommonMasterTable1()
{
   getCheckExpiryDate();
}
...
{
    jData = {};
    jData.service = "NonTeachingFeedbackServlet";
...
function getSelectGridData()
{
  $("#lowerGrid").yattable({
    ...
    var table = "";
   $("#gridLower").html("");
      $("#gridLower").html("<th style='width: 23%'>Feedback ID</th><th style='width: 24%'>Department</th><th style='width: 23%'>Academic Year</th><th style='width: 23%'>Remarks</th><th style='width: 5%'></th>");
    for (var key in lowerGridData) {
        ...
        table = table + "<tr><td  style='width: 23%'>" + lowerGridData[key]["feedbackid"] + "</td><td  style='width: 24%'>" + lowerGridData[key]["department"] + "</td><td  style='width: 23%'>"+lowerGridData[key]["academicyear"]+"</td><td  style='width: 23%'>"+rMarks+"</td>";   
