<%-- 
    Document   : patentTransactionReport 
    Created on : Jul 24, 2015, 10:22:25 AM
    Author     : nipun.gupta
--%>
...
<html>
		<head>
			...
			<style type="text/css">
				...
				#mastergrid :hover, .applicantclass:focus, .applicantclass:active{background: skyblue !important;}
                        ...
                        <script src="../js/IQTest/patentTransactionReportJS.js"></script>
            </head>
        ...
        <!-- Above Is  to handle  the session values   -->
                     <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:95px" >
                        <FONT SIZE="2" COLOR="black" style="margin-left:70%">QA-AR-Form 4</FONT><br>
                        ...
                        <B><FONT SIZE="4" COLOR="black" style="margin-left:25%">Academic ( Research)</FONT><FONT SIZE="2" COLOR="black" style="margin-left:29%">Date:-<%=sdf.format(new java.util.Date())%></FONT><br>
                            <B><FONT SIZE="4" COLOR="black" style="margin-right:10%">Patent Registered by Faculty / Students <label id="abc"></label></FONT></B>
                ...
                <tr>
                  ...
                  <tr>
                      <td width="100px;" align="right" nowrap>Start Date<span class="req"> *</span> :</td>
                      <td width="50px">
                          <input type='text' name='StartDate' id='startdate'  value='' maxlength='10' class='date' style='width:120px;' title='Start Date' readonly/>
                      </td>
