        ...
        <!-- Above Is  to handle  the session values   -->
				<div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:95px" >
                    <FONT SIZE="2" COLOR="black" style="margin-left:70%">
                         ...
                         <FONT SIZE="2" COLOR="black" style="margin-left:14%" >Frequency: Every Year</FONT><br>
                          <B><FONT SIZE="4" COLOR="black" style="margin-left:18%">Academic(Research)</FONT><FONT SIZE="2" COLOR="black" style="margin-left:13%">Date-</FONT><br>
                          <B><FONT SIZE="4" COLOR="black" >Summary of Review articles and Books in Devlopong areas</FONT></B>
                </div>
                <div style="width: 80%; padding: 10px ;border: .3em solid;border-radius: 25px;margin-left:8%;margin-rigth:5%" >
                    ...
                    <td>
                        ...
                        <tr>
                            <td style="text-align: right"  colspan="4" nowrap><button name="submitButton_Book" id="submitButton_Book"  class="button" style="width:120px;height:25px;margin-left:140px;">Generate Report</button>
                            </td>
                        </tr>
                    </table>
                </div>
