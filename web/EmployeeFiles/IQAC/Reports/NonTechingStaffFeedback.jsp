...
<html>
    ...
    <body>
        ...
        <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:95px;" >
            ...
            <B><FONT SIZE="4" COLOR="black" style="margin-left:5%;" >Non-Teching Staff Feedback Form</FONT></B>
            ...
            <table  id="commonmasterid" style="text-align: left;font-size: 18px; border:1px;width:90%">
                ...
                <tr>
                    <td style="text-align: right;" width="100%" colspan="4" nowrap>
                        <button name="submitbutton_NonTech" id="submitbutton_NonTech"  class="button" style="width:120px;height:25px;margin-left:140px;">Generate Report</button>
                    </td>
                </tr>
            </table>
        </div>
