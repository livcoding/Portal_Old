...
<body>
    <%
        ...
        if (!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals("")) {
            ...
            String query = "select EMPLOYEETYPE from employeemaster where EMPLOYEEID='" + mChkMemID + "'";
            ...
            if (rs1.next()) {
               ...
               String qry="select distinct nvl(employeetype,'') employeetype from employeemaster where employeecode='"+mDMemberCode+"'";

                    RsChk = db.getRowset(qry);
                    if(RsChk.next())
                    {
                    empType=RsChk.getString("employeetype")==null?"":RsChk.getString("employeetype").trim();
                    }
