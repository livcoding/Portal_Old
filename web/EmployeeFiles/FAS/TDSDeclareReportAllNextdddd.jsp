...
if(rs.next())
 ...
 qry1="select COMPANYCODE, TDSCODE, ASSESSMENTYEAR, EMPLOYEEID, to_char(DECLARATIONDATE,'dd-mm-yyyy')DECLARATIONDATE, FINYEAR  from TDS#EDIDECLARATIONHEADER where  COMPANYCODE='"+mComp+"' and  TDSCODE='"+mTDSCode+"' and ASSESSMENTYEAR='"+mAssessYear+"' and EMPLOYEEID='"+mDMemberID+"' AND NVL(FREEZE,'N')='Y' ";
// out.print(qry1);
rs1=db.getRowset(qry1);
if(rs1.next())
		{
