...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Cancel Leave Request NOC Update ] </TITLE>
...
try
{
	...
	<%
				...
				if (!mLogEntryMemberID.equals(""))
					...
					qry="UPDATE EMPLOYEELEAVING SET APPROVEDBY='"+mChkMemID+"', APPROVEDDATE=sysdate,NODUESSTATUS='C',REMARKS='"+mRem+"' ";
					...
					if(n>0)
						{
 						...
 						db.saveTransLog(mInst,mLogEntryMemberID,mLogEntryMemberType,"LEAVE REQUEST NOC CANCEL", "Staff :"+mEname+" EmployeeID :"+mEID, "NO MAC ADDRESS",  mIPAddress);
							//-----------------
						response.sendRedirect("RequestNOCCancel.jsp");
						}
					else
						{
						%><CENTER><%
