	  ...
	  //-----------------------------
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
			...
			<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>LTC Request Status</b></font></td></tr>
			</TABLE>
			<br>
			<%
			String mEName="", mECode="", mDateOfReq="";
			qry="Select nvl(A.EMPLOYEENAME,' ') STAFF, A.EMPLOYEECODE EMPCODE, B.LTCTYPE||' ('||C.LTCDESC||')' ADVDESC, B.LTCAMOUNT ADVAMOUNT, nvl(B.REQUESTREMARKS,' ') POA,";
			qry=qry+" to_char(LTCDATE,'DD-MM-YYYY')ADATE, to_char(REQUESTDATE,'DD-MM-YYYY')RDATE FROM V#STAFF A, PAY#EMPOTHERLTCREQUEST B, PAY#LTCTYPEMASTER C where B.COMPANYCODE='"+mComp+"' and B.INSTITUTECODE='"+mInst+"'";
			qry=qry+" and A.EMPLOYEEID=B.MEMBERID and A.EMPLOYEEID='"+mEID+"' and B.REQUESTID='"+mRID+"' and B.LTCTYPE='"+mWFType+"'";
			qry=qry+" and B.COMPANYCODE=C.COMPANYCODE and B.LTCTYPE=C.LTCTYPE ORDER BY ADVAMOUNT, ADVDESC DESC";
			//out.print(qry);
		    	rs=db.getRowset(qry);
			if(rs.next())
			{
			...
			<tr><td nowrap><FONT Color=Black face=arial size=2><B>&nbsp;LTC Type </B></td><td><b>&nbsp; : &nbsp;</B></td><td> </Font><FONT Color=Navy face=arial size=2><%=mAdvDesc%></Font></td></tr>
			<tr><td colspan=3>&nbsp;</td></tr>
			<tr><td nowrap><FONT Color=Black face=arial size=2><B>&nbsp;LTC Amount </B></td><td><b>&nbsp; : &nbsp;</B></td><td> </Font><FONT Color=Navy face=arial size=2><%=mAdvAmount%></Font></td></tr>
			<tr><td colspan=3>&nbsp;</td></tr>
			<tr><td nowrap><FONT Color=Black face=arial size=2><B>&nbsp;Date of LTC </B></td><td><b>&nbsp; : &nbsp;</B></td><td> </Font><FONT Color=Navy face=arial size=2><%=mDateOfAdv%></Font></td></tr>
			<tr><td colspan=3>&nbsp;</td></tr>
