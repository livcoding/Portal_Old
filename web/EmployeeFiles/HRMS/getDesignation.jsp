...
try{
 ...
 qry="SELECT DISTINCT nvl(DESIGNATIONCODE,' ')DESIGNATIONCODE, nvl(DESIGNATIOn,' ')DESIGNATIOn FROM DESIGNATIONMASTER    " +
         "      WHERE NVL (deactive, 'N') = 'N'            AND DESIGNATIONCODE IN (SELECT DESIGNATIONCODE      " +
         "                               FROM HR#VACANCYDEPDESIGTAGGING                            " +
         "         WHERE   DEPARTMENTCODE ='"+department+"' " +
         "   and VACANCYCODE='"+vacancy+"'  )";
