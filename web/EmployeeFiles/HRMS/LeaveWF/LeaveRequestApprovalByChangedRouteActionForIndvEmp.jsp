		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
			...
			//--------------------------------------------------
						else if(mActCurr.equals("D") && mChk.equals("Checked"))
						{
							...
							// Log Entry
							//-----------------
							      db.saveTransLog(mInstitute,mLogEntryMemberID,mLogEntryMemberType ,"DISCARD LEAVE WORK FLOW CRITERIA ON THIS LEVEL", "WFCode:"+QryWFCode+" WFType:"+QryWFType+" Req Dept:"+mDepartmentCode+" WFSeq:"+mWFSeq, "NO MAC Address" , mIPAddress);
							//-----------------
							}
						}
			//--------------------------------------------------
			...
			//-----Use Iterator Here------
			   ...
			   else if(mAddDropLvl.equals("DC"))
			   {
				...
				// Log Entry
				//-----------------
				      db.saveTransLog(mInstitute,mLogEntryMemberID,mLogEntryMemberType ,"DISCARD LEAVE WORK FLOW LEVEL", "WFCode:"+QryWFCode+" WFType:"+QryWFType+" Req Dept:"+mDepartmentCode+" WFLvl:"+mWFLevel, "NO MAC Address" , mIPAddress);
				//-----------------
					mDelFlag++;
					mDelWFLvl=mWFLevel;
