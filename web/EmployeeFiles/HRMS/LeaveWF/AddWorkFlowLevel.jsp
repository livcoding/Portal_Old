...
//------------------------------------
			...
			if(!rs.next())
			{
				...
				ValForAL=QryRID+"///"+mComp+"***"+mInstitute+"@@@"+mDeptCode+"###"+mWFSeqc+"&&&"+CTR+"((("+mApprBy+")))"+mApprAuth+"[[["+mTextToDisp;
				//out.print(ValForAL);
				AL.add(ValForAL);
...
//-----------------------------
			...
			if(AL1!=null)
			{
				...
				while(itr.hasNext())
				{
					...
					<td nowrap align=center><font color=black face=arial><%=APBY%></font></td>
					<td nowrap align=center><font color=black face=arial><%=APAU%></font></td>
					<td nowrap align=center><font color=black face=arial><%=TXTDSP%></font></td>
					<%
