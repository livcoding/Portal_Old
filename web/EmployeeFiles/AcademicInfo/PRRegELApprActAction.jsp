...
//out.print(mSubjCode+"sdfsdadfsa");
       ...
       //----------------------------------------CGPA PROCEDURE(START)----------------------------------------------//
                             ...
                             try{
                               rrr=db.PopulateElectiveRunning_CGPA(mInst,mPreventcode ,mExam, mHODMemberID)==null?"data updated":db.PopulateElectiveRunning_CGPA(mInst,mPreventcode ,mExam, mHODMemberID);
