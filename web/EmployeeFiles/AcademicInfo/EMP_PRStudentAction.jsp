...
{  //1
	...
	{  //2
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		{
			...
			%>
			<form name="frm1" method="post" action="ERP_PRStudSendToHODAction.jsp">
...
<%
			...
			{	//3
				...
				else
				{
					...
					//out.println("aaa"+request.getParameter("CHOICE1"));
					if(request.getParameter("sss")!=null && (((studelecchoise < mMinBasketD && (a <=mMaxCrLmt)) || studelecchoise >mMaxBasketD ) || (b <= mMaxCrLmt && studelecchoise < mMinBasketD ))) 
								...
								*/
								...
								if(MaxSubjTknFlag==0 )
								{
									...
									else
									{
										...
										/*if(request.getParameter("CHOICE1")!=null)
											mNo=1;
										else
											mNo=0;*/
			...
			if(mNo==1)
			{
				...
				<tr><td colspan=5 align=center><%if(sum!=0.0){%><Font color=green face=verdana size=4><B>Total Course Credit Point Taken By You : <%=sum%><b></font><%}%></td></tr>
