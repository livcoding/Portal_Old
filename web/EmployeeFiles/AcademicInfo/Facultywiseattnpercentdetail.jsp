...
try{
                      ...
                      qry = "SELECT distinct SEMESTERTYPE, SECTIONBRANCH,subjectid, enrollmentno,subsectioncode,  studentid,studentname ,COUNT (*) noofclass    FROM v#studentattendance a  Where  a.LTP in ('"+mLTP+"')   and a.subsectioncode='"+SUBCODE+"' and a.subjectcode='"+mSubjectcode+"' AND NVL (a.present, 'N') = 'Y' and nvl(Studentdeactive,'N')='N' and nvl(deactive,'N')='N'   and attendancetype in ('E','R')";
                      ...
                      qry = qry + " group by SEMESTERTYPE, SECTIONBRANCH,subjectid,  enrollmentno, studentid,studentname ,subsectioncode";
            /*          if(mFLAG.equals("80")){
...
//out.print(qry);
						 ...
						 int tnoc = 0;
						   ...
						   qry1 = "SELECT distinct SEMESTERTYPE, SECTIONBRANCH,subjectid, enrollmentno,subsectioncode,  studentid,studentname ,COUNT (*) mTNOOFCLASS    FROM v#studentattendance a  Where a.studentid='"+rs1.getString("studentid")+"' and  a.LTP in ('"+mLTP+"') AND  A.SEMESTERTYPE='"+mSemType+"' and a.employeeid='"+EMPID+"' and a.subsectioncode='"+SUBCODE+"' and a.subjectcode='"+mSubjectcode+"'  and nvl(Studentdeactive,'N')='N'  and nvl(deactive,'N')='N'   and attendancetype in ('E','R')";
                      ...
                      qry1 = qry1 + " group by SEMESTERTYPE, SECTIONBRANCH,subjectid,  enrollmentno, studentid,studentname ,subsectioncode";
			//	out.print(qry1);
                ...
                //  out.print(sper+"<br>");
		     	   ...
		     	   if(sper<Integer.parseInt(mFLAG))
			       {
//
