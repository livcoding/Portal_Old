	...
	/*	if (GlobalFunctions.iSValidDate(mDate)==true)
		{
			*/
			...
			qry="Select WEBKIOSK.IsValidTimeFormat('"+mtime1+"')SL from dual";
                        //out.print(qry);
...
qry=" SELECT TO_DATE('"+mDTupto+"','DD-MM-YYYY HH24:MI')  - TO_DATE('"+mDTfrom+"','DD-MM-YYYY HH24:MI')  from dual ";
	...
	qry="SELECT TO_DATE('"+mDTfrom+"','DD-MM-YYYY HH24:MI')  from dual";
			out.print(qry);
				//rsdt=db.getRowset(qry);
				if(rsdt.next())
				{
 ...
 *   */
				...
				qry=qry+" AND NVL(a.studentdeactive,'N')='N' AND NVL(a.deactive,'N')='N' and a.INSTITUTECODE='"+mInst+"' ";
