		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
			...
			<!--*********Semester Type**********-->
				...
				<td align=center><b><font color="white" face=arial size=2>Cancel?&nbsp;</font><br><font color="white" face=arial size=2><input onClick="un_check()" type="checkbox" id='allbox' name='allbox' value='Y'></font></b></td>
				...
				qry="select Distinct nvl(A.DEPARTMENTRUNNIG,' ') DeptCode, nvl(D.DEPARTMENT,' ')Dept, nvl(A.STATUS,'D')Status, nvl(B.EMPLOYEEID,' ') HODID, nvl(C.EMPLOYEENAME,' ') HODName, nvl(C.EMPLOYEECODE,' ') HODCode ";
				qry=qry+" from PR#HODLOADDISTRIBUTION A, HODLIST B, EMPLOYEEMASTER C, DEPARTMENTMASTER D ";
				qry=qry+" where A.INSTITUTECODE=B.INSTITUTECODE and B.employeeid=C.EMPLOYEEID And B.INSTITUTECODE='"+mInstitute+"' AND ";
				qry=qry+" a.companycode = b.companycode AND b.companycode = c.companycode AND c.companycode = a.companycode AND ";
				qry=qry+" a.departmentrunnig = b.departmentcode AND b.departmentcode = d.departmentcode AND d.departmentcode = a.departmentrunnig";
