...
<tbody>
<%
	qry="select distinct to_char(classtimefrom,'DD-MM-YYYY HH:MI PM')ADate, to_char(classtimefrom,'HH:MI PM')Classf, to_char(classtimeupto,'HH:MI PM')Classt, nvl(ATTENDANCETYPE,' ')CType, nvl(Programcode,' ')Prog, nvl(Sectionbranch,' ')Sec, nvl(Subsectioncode,' ')Sub from V#STUDENTATTENDANCE ";
