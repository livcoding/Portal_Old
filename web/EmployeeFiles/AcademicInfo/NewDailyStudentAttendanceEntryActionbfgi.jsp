...
<center><font size=4 face=arial  color="#008AB8">Attendance Status</font></center>
<hr>
			...
			{  //4
			  ...
			  {	
				...
				else if(mPresent.equals("L"))
				{
					...
					qry=qry+" ENRTYDATE, REMARKS )";
					qry=qry+" values('"+mFstid+"','"+mStudentID+"',To_date('"+Date+ "','dd-MM-yyyy'),To_date('"+mTfrom+"','dd-MM-yyyy HH:MI PM'),To_date('"+mTupto+"','dd-MM-yyyy HH:MI PM'),'"+Type+"',";
					qry=qry+" 'L','"+mSelf+"','"+mMemberID+"','"+mMemberType+"',sysdate,'"+Remarks+"') ";
				...
				%>
					...
					<td><%=mRollno%></td>
					<td><%=GlobalFunctions.toTtitleCase(mSID)%></td>
					<td><font color=blue>Leave</font></td>
					</tr>
				<%
				}	
				else 
