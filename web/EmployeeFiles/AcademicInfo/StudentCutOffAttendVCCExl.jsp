...
{  //1
  ...
  //----------------------
	...
	<tr><TD align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: Arial"><b>Complete Cut-off Attendance : Administrator</b></td></tr>
	</table>
	...
	ResultSet rsq=null,rsb=null;
			...
			ResultSet rs1=null;
			double mCGPA=0.0;
			String mFailsub="",mFailSem="",QrySemType="",QryEmpID="";
			int mSem=0;
...
ResultSet rsBatchDate=null;
		...
		{
			qry="select distinct A.Studentid Studentid, A.StudentName StudentName, A.EnrollmentNo EnrollmentNo, A.FSTID FSTID, A.SUBJECTID SUBJECTID, A.SUBJECTCODE SUBJECTCODE, A.SUBJECT SUBJECT, A.LTP LTP, A.SEMESTER SEMESTER, A.SECTIONBRANCH SECBR, A.SUBSECTIONCODE SUBSEC,A.academicyear academicyear,NVL(a.SEMESTERTYPE,' ')SEMESTERTYPE,a.employeeid  From v#studentltpdetail A";
