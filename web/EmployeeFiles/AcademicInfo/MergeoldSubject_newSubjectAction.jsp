		...
		//if(1==1)
	  	{
			...
			qry ="update Pr#hodloadDistribution  set MERGEWITHFSTID='"+mergFstid+"' where examcode='"+mExamcode+"' and INSTITUTECODE='"+mInst+"' and  COMPANYCODE='"+mCompcode+"' and ltp='"+mLT+"' and DEPARTMENTRUNNIG='"+DeptCode+"' and fstid='"+request.getParameter("fstid1"+iii)+"'" ;
					u=db.update(qry);
					//out.println(qry);
