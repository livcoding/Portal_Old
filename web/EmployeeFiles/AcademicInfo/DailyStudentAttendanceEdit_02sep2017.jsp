...
<body aLink=#ff00ff bgcolor=#fce9c5 rightmargin=0 leftmargin=0 topmargin=0 bottommargin=0 onload="return rad_check();">
<%
try
{
...
<table align=center><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: arial">Edit Today's or Previous Day's Class Attendance</font></TABLE>
...
%>
 ...
 <!-- <a href="javascript:NewCal('qsysdate','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a Date"></a> -->
...
{ 
	...
	qry1=qry1+" UNION Select distinct SUBSECTIONCODE SubSection,nvl(SECTIONBRANCH,' ') Section,nvl(Examcode,' ')examcode,nvl(subjectid,' ') subjectid from  facultysubjecttagging where      ";
...
<b>&nbsp;Class Period (hh:mm)</b>
<input id='timepicker1' name='timepicker1' type='text' value='<%=mtimepicker1%>' size=8 maxlength=8 >&nbsp;

<!-- <IMG SRC="../../Images/timepicker.gif" BORDER="0" ALT="Pick a Time!" ONCLICK="selectTime(this,timepicker1)" STYLE="cursor:hand">
 -->
&nbsp;&nbsp;<STRONG><FONT color=black face=Arial size=2>&nbsp;  To &nbsp;(hh:mm) </FONT></STRONG>
<input id='timepicker2' name='timepicker2' type='text' value='<%=mtimepicker2%>' size=8 maxlength=8 >&nbsp;
...
<!-- <IMG SRC="../../Images/timepicker.gif" BORDER="0" ALT="Pick a Time!" ONCLICK="selectTime(this,timepicker2)" STYLE="cursor:hand">
 -->&nbsp; &nbsp; <INPUT Type="submit" Value="Show/Refresh">
	...
	<form name="frm1"  method="post" action="DailyStudentAttendanceEditAction.jsp"> 
	...
	qry=" SELECT TO_DATE('"+mDTupto+"','DD-MM-YYYY HH24:MI')  - TO_DATE('"+mDTfrom+"','DD-MM-YYYY HH24:MI')  from dual ";
		//	out.print(qry);
				...
				{	
					...
					qry=qry+" A.SUBSECTIONCODE, C.SemesterType,C.LTP LTP  ";
...
qry=qry+" and not exists (select 'y' from STUDATTENDANCEBYSPECIALFACULTY ssf Where ";
					...
					*/
					...
					qry=qry+" And ( to_date('"+mDTfrom+"','dd-mm-yyyy hh24:mi') between CLASSTIMEFROM and CLASSTIMEFROM ";
					qry=qry+" and  to_date('"+mDTupto+"','dd-mm-yyyy hh24:mi') between CLASSTIMEUPTO and CLASSTIMEUPTO))";
