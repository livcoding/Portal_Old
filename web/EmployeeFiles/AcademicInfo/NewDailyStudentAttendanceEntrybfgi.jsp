...
<script language="JavaScript" type ="text/javascript">
   ...
   { 
	...
	for (var i = 0; i < document.frm1.elements.length; i++) 
	{
        ...
        else if((e.name != 'allbox1') && (e.type == 'radio') && (e.value=='A') &&  (e.checked==true)) 
      {
		...
		else if((e.name != 'allbox2') && (e.type == 'radio') && (e.value=='L') && (e.checked==true)) 
      {
 		l++;
	  }	
   ...
   if(p>0 && a>0 && l>0)	
   {
	...
	document.frm1.allbox2.checked=false;
   }
   else if(p>0 && a<=0  && l>0 )
   {
   ...
   else if (a>0 && p<=0 && l>0)
   {
	...
	document.frm1.allbox2.checked=true;
   }				
   else if(a<=0 && p<=0 && l<0)
   {
	document.frm1.allbox.checked=false;
...
<body  onload="AlertMe()"  bgcolor="" rightmargin=0 leftmargin=0 topmargin=0 bottommargin=0>
<%
try
{
...
<tr><TD colspan=0 align=middle><font color="#008AB8" style="FONT-SIZE: medium; FONT-FAMILY: arial">Daily Class Attendance Entry [ Today's Attendance or Previous Day's Excuse]</TD>
</font></td></tr>
</TABLE>
<table id=id2 bordercolor="" cellpadding=0 cellspacing=0 width="100%" align=center rules=rows border=1>
<!--Institute****-->
...
{
%>
<FONT color=black face=Arial size=2><b>&nbsp; Attendance Type </b></FONT> &nbsp;<input type=radio name=radio1 id=radio1  value='R' checked><font  color= green>Regular</font>
<input type=radio name=radio1 id=radio1 value='E'><font color=brown>Extra</font>
<%
}
else
{
...
<table bordercolor="" id=id2 cellpadding=0 cellspacing=0 width="100%" align=center rules=rows border=1>
...
<br>
    * In case of doubt contact department tagging co-ordinator <br>
   ...
   what you are teaching than do contact department tagging co-ordinator .

    </font></td></tr>
<TR>
<TD width=50% nowrap>
<marquee behavior=alternate scrolldelay=300 direction=right>
<a href='DailyStudentAttendanceEditbfgi.jsp'><font color=blue><b>Edit/Change Previous Day Attendance</b></font></a>
</marquee>
</TD> 
<!-- <TD  nowrap>
...
<input style="width:220px;font-size:16px;position:absolute;text-align:middle;
	...
	<form name="frm1"  method="post" action="NewDailyStudentAttendanceEntryActionbfgi.jsp">
...
//out.print(qry);
					...
					while(rs1.next())
					{
						...
						while(rsRowNum.next())
						{
							qry="Select decode(PRESENT,'N','<Font Color=red face=arial><B>A</B></Font>','Y','<Font Color=Green face=arial><B>P</B></Font>','L','<Font Color=red face=arial><B>L</B></Font>') Attendance from studentattendance where studentid='"+rs1.getString("studentid")+"' and to_char(ATTENDANCEDATE,'dd-mm-yyyy')='"+rsRowNum.getString("ATTDATE")+"'";
