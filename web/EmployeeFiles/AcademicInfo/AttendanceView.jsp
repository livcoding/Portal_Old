...
<%
                try {
                    ...
                    if (mSrcType.equals("A")) {
                        ...
                        qry = qry + " from facultysubjecttagging A, SUBJECTMASTER B where A.SUBJECTID=B.SUBJECTID and A.EXAMCODE='" + qryexam + "' AND nvl(a.PROJECTSUBJECT,'N')='N' and A.FSTID in (select fstid from V#STUDENTATTENDANCE where examcode='" + qryexam + "' and nvl(deactive,'N')='N') order by subject asc";
                    }
                     //out.print(qry);
                    rs = db.getRowset(qry);
...
<%--
    ...
    qry=qry+" from  facultysubjecttagging A where a.employeeid='"+mDMemberID+"' ";
    qry=qry+" and A.fstid not in (select fstid from STUDATTENDANCEBYSPECIALFACULTY where trunc(sysdate)=trunc(attendancedate) and ";
    ...
    qry=qry+" from  facultysubjecttagging A where a.fstid in (select fstid from MULTIFACULTYSUBJECTTAGGING where companycode='"+mComp+"' and institutecode='"+mInst+"' and facultytype=decode('"+mDMemberType+"','E','I','E') and employeeid='"+mDMemberID+"')";
    qry=qry+" and A.fstid not in (select fstid from STUDATTENDANCEBYSPECIALFACULTY where trunc(sysdate)=trunc(attendancedate) and ";
    qry=qry+" nvl(deactive,'N')='N' and facultyid<>'"+mDMemberID+"' And InstituteCode='"+mInst+"') and  A.EXAMCODE='"+qryexam+"' " ;
    qry=qry+" union ";
...
%>
                ...
                try {
                    if (mSrcType.equals("I")) {
                        ...
                        qry1 = qry1 + " and employeeid='" + mDMemberID + "' and";
                        ...
                        qry1 = qry1 + " UNION";
                        qry1 = qry1 + " select nvl(SECTIONBRANCH,' ') Section from facultysubjecttagging where facultytype=decode('" + mDMemberType + "','E','I','E')";
                        qry1 = qry1 + " and fstid in (select fstid from MULTIFACULTYSUBJECTTAGGING where companycode='" + mComp + "' and institutecode='" + mInst + "' and facultytype=decode('" + mDMemberType + "','E','I','E') and employeeid='" + mDMemberID + "') and";
                        qry1 = qry1 + " examcode not in (select examcode from exammaster where nvl(LOCKEXAM,'N')='Y' or nvl(FINALIZED,'N')='Y' or NVL(DEACTIVE,'N')='Y')";
                ...
                try {
                    if (mSrcType.equals("I")) {
                        ...
                        qry1 = qry1 + " facultytype=decode('" + mDMemberType + "','E','I','E') and fstid in (select fstid from MULTIFACULTYSUBJECTTAGGING where companycode='" + mComp + "' and institutecode='" + mInst + "' and facultytype=decode('" + mDMemberType + "','E','I','E') and employeeid='" + mDMemberID + "') and ";
                        qry1 = qry1 + " examcode not in (select examcode from exammaster where nvl(LOCKEXAM,'N')='Y' ";
                        qry1 = qry1 + " or nvl(FINALIZED,'N')='Y' or NVL(DEACTIVE,'N')='Y' )  Group by SECTIONBRANCH ,subjectid,EXAMCODE";
            ...
            <table bgcolor=#fce9c5 class="sort-table" id="table-1" width='90%' bottommargin=0 rules=rows topmargin=0 cellspacing=0 cellpadding=0 border=1 align=center>
                <thead>
                    <tr bgcolor="#ff8c00">
                        ...
                        <%
            if (mSrcType.equals("I")) {
                qry = "Select DISTINCT A.LTP, DECODE(A.LTP,'L',1,'T',2,'P',3,4)LTPSEQ from facultysubjecttagging A where A.INSTITUTECODE='" + mInst + "' and A.COMPANYCODE='" + mComp + "' and A.EXAMCODE='" + mExam + "' and A.SubjectID='" + mSubject + "' and A.EMPLOYEEID in ((select '" + mDMemberID + "' from Dual)UNION(Select B.EMPLOYEEID from Multifacultysubjecttagging B where B.INSTITUTECODE='" + mInst + "' and B.COMPANYCODE='" + mComp + "' and A.FSTID=B.FSTID)) and NVL(A.PROJECTSUBJECT,'N')='N' ORDER BY LTPSEQ";
            }
            if (mSrcType.equals("A")) {
...
%>
            ...
            try {
                if (mSrcType.equals("I")) {
                    qry = "Select A.fstid from facultysubjecttagging A where A.INSTITUTECODE='" + mInst + "' and A.COMPANYCODE='" + mComp + "' and A.EXAMCODE='" + mExam + "' and A.SubjectID='" + mSubject + "' and A.LTP='L' and A.EMPLOYEEID in ((select '" + mDMemberID + "' from Dual)UNION(Select B.EMPLOYEEID from Multifacultysubjecttagging B where B.INSTITUTECODE='" + mInst + "' and B.COMPANYCODE='" + mComp + "' and A.FSTID=B.FSTID))";
                }
                if (mSrcType.equals("A")) {
                ...
                if (mSrcType.equals("I")) {
                    qry = "Select A.fstid from facultysubjecttagging A where A.INSTITUTECODE='" + mInst + "' and A.COMPANYCODE='" + mComp + "' and A.EXAMCODE='" + mExam + "' and A.SubjectID='" + mSubject + "' and A.LTP='T' and A.EMPLOYEEID in ((select '" + mDMemberID + "' from Dual)UNION(Select B.EMPLOYEEID from Multifacultysubjecttagging B where B.INSTITUTECODE='" + mInst + "' and B.COMPANYCODE='" + mComp + "' and A.FSTID=B.FSTID))";
                }
                if (mSrcType.equals("A")) {
                ...
                if (mSrcType.equals("I")) {
                    qry = "Select A.fstid from facultysubjecttagging A where A.INSTITUTECODE='" + mInst + "' and A.COMPANYCODE='" + mComp + "' and A.EXAMCODE='" + mExam + "' and A.SubjectID='" + mSubject + "' and A.LTP='P' and A.EMPLOYEEID in ((select '" + mDMemberID + "' from Dual)UNION(Select B.EMPLOYEEID from Multifacultysubjecttagging B where B.INSTITUTECODE='" + mInst + "' and B.COMPANYCODE='" + mComp + "' and A.FSTID=B.FSTID))";
                }
                if (mSrcType.equals("A")) {
...
//------------------End of 'L' Percentage--------------------
%>
                        <td ALIGN=CENTER>&nbsp;<a Title="View Date wise Student 'L' Attendance" target=_New href=DailyStudentAttendanceReportDet.jsp?SrcType=<%=mSrcType%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=L&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>><font color=""><b><%=QryPercAtt%></b> %</font></a></td>
                        <%
                            }
                            //else
                            //{
...
//------------------End of 'T' Percentage--------------------
%>
                        <td ALIGN=CENTER>&nbsp;<a Title="View Date wise Student 'T' Attendance" target=_New href=DailyStudentAttendanceReportDet.jsp?SrcType=<%=mSrcType%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=T&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>><font color=""><b><%=QryPercAtt%></b> %</font></a></td>
                        <%
                            }
                            //else
                            //{
%>
                        ...
                        %>
                        <td ALIGN=CENTER>&nbsp;<a Title="View Date wise Student 'P' Attendance" target=_New href=DailyStudentAttendanceReportDet.jsp?SrcType=<%=mSrcType%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=LT&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>><font color=""><b><%=mPercAtt%></b> %</font></a></td>
                        <%
                            }
                            //else
                            //{
...
//------------------End of 'P' Percentage--------------------
%>
                        <td ALIGN=CENTER>&nbsp;<a Title="View Date wise Student 'P' Attendance" target=_New href=DailyStudentAttendanceReportDet.jsp?SrcType=<%=mSrcType%>&amp;EXAM=<%=mExam%>&amp;SID=<%=rs1.getString("studentid")%>&amp;SC=<%=mSubject%>&amp;LTP=P&amp;SEC=<%=rs1.getString("SECBR")%>&amp;SUBSEC=<%=rs1.getString("subsectioncode")%>><font color=""><b><%=QryPercAtt%></b> %</font></a></td>
                        <%
                            }
                        //else
                        //{
