	...
	if (!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals("")) 
	{
            ...
            if (RsChk.next() && RsChk.getString("SL").equals("Y")) 
		{
			...
			<form name="frm1" id="frm1" method="get">
	            ...
	            <table id=id2 cellpadding=1 cellspacing=1  width="100%"   align=center >
                        <tr><td align=center>
                        <font color="#a52a2a" style="FONT-SIZE:medium;FONT-FAMILY:Arial">
                        <B><U>Student Registration Summary</U></b></font>
                        </td></tr>
                    </table>
