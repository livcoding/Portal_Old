...
<tr bgcolor=lightyellow><td colspan=3 align=center><FONT color=black face=Arial size=2><STRONG>&nbsp;Prefered Room Type for
<font color="#00008b"><u><%=QrySubject1%></u></font>&nbsp;</STRONG></FONT>
<!--*********Room Type**********-->
				<%
