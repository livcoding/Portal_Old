 <%--
    ...
    Created on : Feb 10, 2020, 10:49:44 AM
    Modified on: 20012020 By Anoop
    Author     : campus.trainee/Vivek Soni
--%>

<!-- Modified Date 12-01-2018 28-07-2020-->
...
//	out.print(qry);
    ...
    <div id="masterdiv">
		<div class="menutitle" onclick="SwitchMenu('sub100')">Other Fees&nbsp;<img src="../Images/arrow.gif"></div>
		<span class="submenu" id="sub100">
       <%
		//if (mMemberID.equals("UNIV-M00004"))
		//{
       qry="Select WEBKIOSK.ShowLink('415','"+ mMemberID +"','E','"+mRole+"','"+ mIPAddress +"') SL from dual";

      Rs = db.getRowset(qry);
      if (Rs.next() && Rs.getString("SL").equals("Y"))
	{
			%>
        <img src="../Images/bullet4.gif"><a href="../EmployeeFiles/ERPNonAcdmicFee/FeesHeadWise.jsp" target=DetailSection><font face="Arial"  color=black size=2><b>Fee-head Wise Collection</b></font></a><br>
         <img src="../Images/bullet4.gif">&nbsp;<a  target="_blank" title="Student wise Non-academic Fee" href="../EmployeeFiles/ERPModuleForNonAcademicFees.jsp" ><FONT face="Arial" color =black size=2><b>Student wise Non-academic Fee</b></font></a><br>
...
<A HREF="../IQAC/MENU.jsp" target=_new><div class="menutitle" onclick="SwitchMenu('sub1111')">IQAC<img src="../Images/arrow.gif"></div></A>
  ...
  <%}%>
   ...
   <span class="submenu" id="sub1046">
	...
	<img src="../Images/bullet4.gif">&nbsp;<a target="_blank" title="BBA Applicant Detail" href="../CommonFiles/bbaApplicantDetail.jsp"><FONT face="Arial" color =black size=2>BBA Applicant Detail</font></a><br>
        <%
	}%>
