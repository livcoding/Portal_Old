 <%--
    ...
    Author     : campus.trainee/Bijendra Kumar
--%>
...
qry="Select WEBKIOSK.ShowLink('60','"+ mMemberID +"','E','"+mRole+"','"+ mIPAddress +"') SL from dual";
	...
	{
	%>
	<img src="../Images/bullet4.gif">&nbsp;<A title="Student's Marks Entry Grid Version" href="ExamActivity/MarksEntryGridVersion.jsp" target=DetailSection><FONT face="Arial" size =2 color=black>Marks Entry *</FONT></A><BR>
<img src="../Images/bullet4.gif">&nbsp;<A title="Student's Marks Entry Grid Version" href="ExamActivity/ReconMarksEntryGridVersion.jsp" target=DetailSection><FONT face="Arial" size =2 color=black>Marks Entry Reconcilation</FONT></A><BR>
