...
String mLTP="",myLTP="",mSubj="",mT="",srsevent="",Faculty="",Subject="",mOldSubjID="";
...
<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy">SRS Teacher Rating Detail Report (Department wise)</font></td></tr>
</TABLE>
...
qry=qry +" hodlist where employeeid='"+mDMemberID+"' and nvl(deactive,'N')='N')) and NVL(A.FINALIZED,'N')='Y' and NVL(A.APPROVED,'N')='Y' and nvl(A.deactive,'N')='N'  order by EMPLOYEENAME ";
// out.print(qry);
...
if(request.getParameter("x")!=null)
	...
	mSNo=0;
		mLTP="";
		myLTP="";
		String mOldSubj="",mOldDate="",mOldSubjCode="";
		 Ltot=0;
		Ttot=0;
		Ptot=0;
		//int	mOldCount=0;
