...
/*public IQACconnection() {
  ...
  //---------------------------For live Server(end)----------------------------------------//
  public IQACconnection(Properties props) throws SQLException,
  ...
  public IQACconnection(String dsn) throws ClassNotFoundException, SQLException {
    Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
    con = DriverManager.getConnection("jdbc:odbc:"+dsn);
  }
  public IQACconnection(String driver,String url) throws ClassNotFoundException,
      SQLException {
  ...
  public IQACconnection(String driver,String url,String userName,String password) throws
  ...
  public IQACconnection(String driver,String serverName,String port,String SID,String userName,String password) throws
      ClassNotFoundException, SQLException {
    Class.forName(driver);
    String url="jdbc:oracle:thin:@"+serverName+":"+port+":"+SID;
    con=DriverManager.getConnection(url,userName,password);
  }
  public IQACconnection(String driver,String serverName,String port,String userName,String password) throws
      ClassNotFoundException, SQLException {
    Class.forName(driver);
...
String mRetFSTID="";
  ...
  try{
    con = ds.getConnection();
    proc= con.prepareCall("{call generateID(?,?,?)}");
    proc.setString(1, "0001");
    proc.setString(2, "FBMId");
    proc.registerOutParameter( 3, Types.VARCHAR);
    proc.execute();
    mRetFSTID=proc.getString(3);
    proc.close();
    proc = null;
    con.close(); // Return to connection pool
    con = null;  // Make sure we don't close it twice
