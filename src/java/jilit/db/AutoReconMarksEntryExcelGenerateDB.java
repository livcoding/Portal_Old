 ...
 */
public class AutoReconMarksEntryExcelGenerateDB extends HttpServlet {
    ...
    public AutoReconMarksEntryExcelGenerateDB() {
 ...
 //System.out.print("Inside Generate Class1 ......");
                ...
                if (RsChk.next() && RsChk.getString("SL").equals("Y")) {
                    ...
                    if (mSelf.equals("Self")) {
                        ...
                        data.clear();
                         ...
                         // System.out.print("Inside self  Class 5 ......" +EmployeeID+Evename);
                   ...
                   // res.sendRedirect(req.getContextPath() + "/EmployeeFiles/Recon/Reconsuccess.jsp?detail="+filename.toString());
                    req.getSession().setAttribute("downfilename", filename.toString());
                    res.sendRedirect(req.getContextPath() + "/EmployeeFiles/Recon/Reconsuccess.jsp");
    ...
    public void createexcel(String EmpID, HttpServletRequest req, HttpServletResponse res,String Evename) {
        ...
        if (mSelf.equals("Self")) {
            String [] exEvecode = null;
            String hashString=null;
            if(Evename.contains("#")){
             exEvecode=Evename.split("\\#");
            }
            ...
            if(exEvecode!=null&& exEvecode.length>0){
            hashString=exEvecode[0].toString();
            qry = qry + " and ltp IN ( decode((select APPLICABLEFOR from  exameventmaster where examcode = '" + mEC + "' AND EXAMEVENTCODE = '" + hashString + "' and institutecode = '" + mIC + "'),'LT','L','LP','L','P' ) )   GROUP BY fstid,studentid,StudentName,enrollmentno,Semester, programcode,SECTIONBRANCH, subsectioncode ,EmployeeCode ";
            qry = qry + " order by " + mList + " " + mOrder + " ";
            }else{
