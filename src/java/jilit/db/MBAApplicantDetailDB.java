 ...
 * @author nipun.gupta
 */
public class MBAApplicantDetailDB {
    private Connection dbConnection;
    private PreparedStatement pStmt;
    private ResultSet rs;
    public MBAApplicantDetailDB() {
     ...
     public String selectSaveUpdateData(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            switch (MBAApplicantDetailDB.scase.valueOf((String) hm.get("handller").toString())) {
                case generateReport:
      ...
      private Map generateReport(Map hm) {
        ...
        try {
            ...
            sqry.append(" ADDRESS1,ADDRESS2,CITY,STATENAME,PIN,PHONE,EMAILID,C.STREAM,");
            sqry.append(" (Select Distinct e.Percentage From C#MBATESTSCORE e where");
            sqry.append(" e.applicationslno=a.applicationslno  And   e.testCode='CAT')catpercentile,");
            sqry.append(" (Select Distinct E.COMPOSITESCORE From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='CAT')\"CAT SCORE\",");
            sqry.append(" (Select Distinct e.Percentage  From C#MBATESTSCORE e where ");
            sqry.append(" e.applicationslno=a.applicationslno  And   e.testCode='MAT')\"MAT PERCENTILE \",");
            sqry.append(" (Select Distinct E.COMPOSITESCORE From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='MAT')\"MAT SCORE \",");
            sqry.append(" (Select Distinct e.Percentage  From C#MBATESTSCORE e where ");
            sqry.append(" e.applicationslno=a.applicationslno  And   e.testCode='CMAT')\"CMAT PERCENTILE \",");
            sqry.append(" (Select Distinct E.COMPOSITESCORE From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='CMAT')\"CMAT SCORE \",");
            sqry.append(" (Select Distinct E.RANK From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='CMAT')\"CMAT RANK \",");
            sqry.append(" (Select Distinct e.Percentage  From C#MBATESTSCORE e where ");
            sqry.append(" e.applicationslno=a.applicationslno  And   e.testCode='GMAT')\"GMAT PERCENTILE \",");
            sqry.append(" (Select Distinct E.COMPOSITESCORE From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='GMAT')\"GMAT SCORE \",");
            sqry.append(" (Select Distinct E.RANK From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='GMAT')\"GMAT RANK \",");
            sqry.append(" (Select Distinct e.Percentage  From C#MBATESTSCORE e where ");
            sqry.append(" e.applicationslno=a.applicationslno  And   e.testCode='XAT')\"XAT PERCENTILE \",");
            sqry.append(" (Select Distinct E.COMPOSITESCORE From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='XAT')\"XAT SCORE \",");
            sqry.append(" (Select Distinct E.RANK From C#MBATESTSCORE E where ");
            sqry.append(" e.applicationslno=a.applicationslno And   e.testCode='XAT')\"XAT RANK \",CHECKSCORECARD,");
            sqry.append(" C#M.CHEQUEDDNO,to_char(C#M.CHEQUEDDDATE,'dd-mm-yyyy')CHEQUEDDDATE,C#M.CHQDDTYPE,C#M.AMOUNT,C#M.BANKNAME,");
            sqry.append("C.PERCENTAGE, C.PASSINGYEAR, C.BOARD,TWE.PERCENTAGE,TWE.PASSINGYEAR, TWE.BOARD,TEN.PERCENTAGE, TEN.PASSINGYEAR, TEN.BOARD");
            sqry.append(" from c#mbaapplicationmaster a,C#MBAAPPLICANTADD b,C#QUALIFICATION C, C#QUALIFICATION TEN,  C#QUALIFICATION TWE, C#STATEMASTER D,C#MBAFEE C#M ");
            ...
            sqry.append(" AND C.QUALIFICATIONCODE='GRAD'");
            ...
            while (rs.next()) {
                ...
                data.put("stream", (rs.getString(15)==null?"":rs.getString(15)));
                data.put("catPercentile", (rs.getString(16)==null?"":rs.getString(16)));
                data.put("catScore",(rs.getString(17)==null?"":rs.getString(17)));
                data.put("matPercentile",(rs.getString(18)==null?"":rs.getString(18)));
                data.put("matScore",(rs.getString(19)==null?"":rs.getString(19)));
                data.put("cmatPercentile",(rs.getString(20)==null?"":rs.getString(20)));
                data.put("cmatScore",(rs.getString(21)==null?"":rs.getString(21)));
                data.put("cmatRank",(rs.getString(22)==null?"":rs.getString(22)));
                data.put("gmatPercentile",(rs.getString(23)==null?"":rs.getString(23)));
                data.put("gmatScore",(rs.getString(24)==null?"":rs.getString(24)));
                data.put("gmatRank",(rs.getString(25)==null?"":rs.getString(25)));
                data.put("xatPercentile",(rs.getString(26)==null?"":rs.getString(26)));
                data.put("xatScore",(rs.getString(27)==null?"":rs.getString(27)));
                data.put("xatRank",(rs.getString(28)==null?"":rs.getString(28)));
                data.put("checkScoreCard",(rs.getString(29)==null?"":rs.getString(29)));
                data.put("chequeDDNo",(rs.getString(30)==null?"":rs.getString(30)));
                data.put("chequeDDDate",(rs.getString(31)==null?"":rs.getString(31)));
                data.put("chequeDDType",(rs.getString(32)==null?"":rs.getString(32)));
                data.put("amount",(rs.getString(33)==null?"":rs.getString(33)));
                data.put("bankName",(rs.getString(34)==null?"":rs.getString(34)));
                data.put("gradPer",(rs.getString(35)==null?"":rs.getString(35)));
                data.put("gradYop",(rs.getString(36)==null?"":rs.getString(36)));
                data.put("gradUni",(rs.getString(37)==null?"":rs.getString(37)));
                data.put("twePer",(rs.getString(38)==null?"":rs.getString(38)));
                data.put("tweYop",(rs.getString(39)==null?"":rs.getString(39)));
                data.put("tweBrd",(rs.getString(40)==null?"":rs.getString(40)));
                data.put("tenPer",(rs.getString(41)==null?"":rs.getString(41)));
                data.put("tenYop",(rs.getString(42)==null?"":rs.getString(42)));
                data.put("tenBrd",(rs.getString(43)==null?"":rs.getString(43))); 
...
for(int i=1;i<=data.size();i++){
       ...
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("stream")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("catPercentile")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("catScore")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("matPercentile")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("matScore")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("cmatPercentile")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("cmatScore")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("cmatRank")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("gmatPercentile")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("gmatScore")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("gmatRank")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("xatPercentile")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("xatScore")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("xatRank")).append("</font></td>");
       sb.append("<td  style='width: 3%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("checkScoreCard")).append("</font></td>");
       ...
       sb.append("<td  style='width: 2%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("gradPer")).append("</font></td>");
       sb.append("<td  style='width: 2%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("gradYop")).append("</font></td>");
       sb.append("<td  style='width: 2%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("gradUni")).append("</font></td>");
       sb.append("<td  style='width: 2%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("twePer")).append("</font></td>");
       sb.append("<td  style='width: 2%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("tweYop")).append("</font></td>");
       ...
       sb.append("<td  style='width: 2%'><font size='1' style='font-family:arial'>").append(((HashMap) data.get(i)).get("tenYop")).append("</font></td>");
