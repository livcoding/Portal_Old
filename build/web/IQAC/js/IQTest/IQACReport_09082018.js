...
IqacReport_uri='/ShFacultyFeedBackReport?feedbackid='+$("#feedbackid").val()+'&institute='+$("#Institute").val()+'';
...
$("#facultyfeedbackid").change(function(){
   ...
   alert("IqacReport_uri"+IqacReport_uri);
...
{ try{var R1 = new IqacReport();
   alert(R1.url1+"1111111"+IqacReport_uri+"$$$$$"+R1.typ+"^^^^^"+R1.contType);
 $.ajax({
...
for (var key in e)
        ...
        error : function (){
               ...
               alert("Error in geting Program...11");
            }
    });
}catch(e)
{
