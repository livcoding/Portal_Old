...
function getFacultyNames(pno)
{
    ...
    jData.service = "ProjectMasterBtechServlet";
...
function getSelectFacultyInfoInPopUp(){
     var table = "";
     $("#popupHeader").html("");
     $("#popupHeader").html("<th style='width: 5%'>S No.</th><th style='width: 47%'>Faculty Code</th><th style='width: 48%'>Faculty Name</th>");
    
     for (var key in selectFacultyInfo) {
        table = table + "<tr ondblclick='setNames("+key+")'  style='cursor:pointer;'><td  style='width: 5%;text-align: left'>" + selectFacultyInfo[key]["sno"] + "</td><td  style='width: 47%;text-align: left'>" + selectFacultyInfo[key]["employeeCode"] + "</td><td  style='width: 48%;text-align: left'>" + selectFacultyInfo[key]["employeename"] + "</td></tr>";
    }

    $("#facultyNameBody").html("");
    $("#facultyNameBody").html("" + table);
   
 $("#popupHeaderTable").css("width",$("#facultyNameBody").width());
}
...
{
    $("#staffID").val(selectFacultyInfo[key]["employeeID"]);
    $("#facultyName").val(selectFacultyInfo[key]["employeename"]);
...
function formsubmit()
{
    ...
    if (jQuery.trim($('#facultyName').val()) == "") {
    ...
    if (jQuery.trim($('#publications').val()) == 0) {
        alert("Please Select the Publications.");
        $('#publications').focus();
        return false;
    } 
    ...
    jData.publicationsID=$("#publications").val();
...
function getGridData() {
    ...
    var apiScore="";
   $("#gridhead").html("");
      $("#gridhead").html("<th style='width: 5%'>Sl No.</th><th style='width: 8%'>Department Name</th><th style='width: 8%'>Project Code</th><th style='width: 12%'>Project Title</th><th style='width: 8%'>Student Name</th><th style='width: 8%'>Faculty Name</th><th style='width: 8%'>Publications</th><th style='width: 8%'>Project % of Work</th><th style='width: 8%'>Project Status</th><th style='width: 8%'>Project Remarks</th><th style='width: 8%'>Project API Score</th><th style='width: 6%'>Active Y/N</th><th style='width: 5%'></th>");
    ...
    for (var key in gridData) {
        ...
        table = table + "<td  style='width: 8%'>" + gridData[key]["studentName"]+"-"+gridData[key]["enrollNo"] + "</td><td  style='width: 8%'>" + gridData[key]["employeeName"] + "</td><td  style='width: 8%'>" + gridData[key]["publication"] + "</td>";
