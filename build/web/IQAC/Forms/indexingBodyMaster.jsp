<%-- 
    Document   : indexingBodyMaster
    Created on : Jun 30, 2015, 4:14:43 PM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/indexingBodyMasterJS.js"></script>
        <script>
    ...
    <body >
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
        ...
        <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:28px " >Indexing Body Master</div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        <td style="text-align: right">Indexing Body Code<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='indexingBodyCode' id='indexingBodyCode' value='' maxlength='20' class='textbox'  title='Indexing Body Code'/></td>
                        <td style="text-align: right">Indexing Body Name<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='indexingBodyName' id='indexingBodyName' value='' maxlength='100' class='textbox'  title='Indexing Body Name'/></td>
                    </tr> 
                    <tr>
                        <td style="text-align: right">Indexing Body Rating<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='indexingBodyRating' id='indexingBodyRating' value='' maxlength='5' class='nondecimal'  title='Indexing Body Rating'/></td>
                        <td style="text-align: right">Indexing Body Remarks:</td><td style='text-align: left'><input type='text' name='indexingBodyRemarks' id='indexingBodyRemarks' value='' maxlength='160' class='textbox'  title='Indexing Body Remarks'/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">API Score<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='apiScore' id='apiScore' value='' maxlength='3' class='number'  title='Indexing Body Rating'/></td>
                        <td style="text-align: right">Hindex<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='hIndex' id='hIndex' value='' maxlength='2' class='nondecimal'  title='Hindex'/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">Start Value<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='startValue' id='startValue' value='' maxlength='14' class='number'  title='Start Value' onchange="getValidateValue()"/></td>
                        <td style="text-align: right">End Value<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='endValue' id='endValue' value='' maxlength='14' class='number'  title='End Value' onchange="getValidateValue()"/></td>
                    </tr>
                    <tr>
