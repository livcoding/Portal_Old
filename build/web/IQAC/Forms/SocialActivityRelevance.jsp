<%-- 
    Document   : SocialActivityRelevance
    Created on : Jan 11, 2017, 11:32:09 AM
...
<!DOCTYPE html>
<!-- Header Name and Form Name Changes on Date 23-05-2018
     Modified By Vivek
-->
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #departmentNameTable :hover, .highlight:focus,highlight:active  { background: skyblue !important;}
        ...
        <script src="../js/IQTest/SocialActivityRelevanceJS.js"></script>
        <script>
    ...
    <body>
        ...
        <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 50%;float: left;text-align: right;font-size: large">Social Activity & Relevance</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-SAP-FORM-3]</div></div>
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" >
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    ...
                    <tr>
                        <td style="text-align: right">Faculty Co-Ordinator<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='departmentCode' id='departmentCode' value='' maxlength='100' class='textbox'  title='Department Name' /></td>
                        <td style="text-align: right">Faculty ID<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='fIds' id='fIds' value='' maxlength='20' class='textbox' style='width: 120px;'   title='Faculty ID' readonly /></td>
                    </tr>
                     <tr>
                        <td style="text-align: right">Participant Of Student NSS/NCC Events Y/N<span class="req"> *</span> :</td><td td style="text-align: left"><input type='radio' name='active' id='activeY'  value='A' onclick="getHeadData()"/>YES &nbsp;&nbsp; &nbsp; &nbsp; &nbsp <input type='radio' name='active' id='activeN'  value='E' title="Active Y/N"  onclick="getHeadData1()"/>NO</td>
...
<th id="oStud" style="width:15%">Name of Student/Faculty </th>
<!--th id="pStud" style="width:10%">Name of Student Participents  </th-->
<th id="dEvent" style="width:30%">Detail of Event (Date ,institute,JYC,Faculty,Type of Event :Society Benefit)
<th id="fSuooprt" style="width:10%">Financial Support </th>
<th id="tEvent" style="width:20%">Number Of Participant</th>
                    ...
                    <tbody class="interdisciplinaryRow1">
                        <tr>
                            <td id="row1">1.</td>
                            <input type="hidden" name="facultyID" id="facultyID1" value="0" maxlength="20" class="textbox" style="width:80%" />

                            <td><input type="text" name="facultyName" id="facultyName1" value="" maxlength="100" class="textbox" style="width:80%"  /></td>
                            <td><input type="text" name="orgStud" id="orgStud1" value="" maxlength="100" class="textbox" style="width:80%" /></td>
                            <!--td><input type="text" name="partStud" id="partStud1" value="" maxlength="100" class="textbox" style="width:80%" /></td-->
                            <td><input type="text" name="eventDetail" id="eventDetail1" value="" maxlength="100" class="textbox" style="width:80%" /></td>
                            <td><input type="text" name="fSuooprt" id="fSuooprt1" value="" maxlength="100" class="textbox" style="width:80%" /></td>
                            <td><input type="text" name="eventType" id="eventType1" value="" maxlength="100" class="textbox" style="width:80%" /></td>
  ...
  <div class="ui-widget-header ui-corner-all" style="text-align:left;width:100%;" id="finaldivsave">
         ...
         <div id="departmentCodes" title="Faculty co-ordinator" style="overflow: auto;height: 300px">
            <div class="ui-widget-header ui-corner-all" style="font-size:13px;text-align:left;width:100%;" >
             Search:<input type="text" id="searchNamesDepartment">
                ...
                <select id="paggingPopUp"   onchange="getDepartmentNames(0)"  style="text-align:left" ></select>
            </div>
