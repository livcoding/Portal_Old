<%-- 
    Document   : equipmentMaster
    Created on : Jun 15, 2015, 3:06:25 PM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/equipmentMasterJS.js"></script>
        <script>
    ...
    <body >
      ...
      //  out.println("nipun"+mMemberID+">>>>>"+mMemberCode+">>>>>"+mMemberName);
        ...
        <form name="masterform" >
            ...
            <input type="hidden" id="equipmentID"  value="0"/>
            
            <!-- Above Is  to handle  the session values   -->
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:28px " >Equipment/Software Master</div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        ...
                        <td style="text-align: right">Eqpt/Software Code<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='equipmentCode' id='equipmentCode' value='' maxlength='20' class='textbox'  title='Equipment Code'/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">Eqpt/Software Name<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='equipmentName' id='equipmentName' value='' maxlength='100' class='textbox'  title='Equipment Name'/></td>
                        <td style="text-align: right" >Eqpt/Software<span class="req"> *</span> :</td>
                        <td  style="text-align: left">
                            <select name="equipmentSoftware" class='combo' id="equipmentSoftware" title='Equipment/Software'>
                                <option value="0">Select Eqpt/Software</option>
                    ...
                    <tr>
                        <td style="text-align: right">Eqpt/Software Description<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='equipmentDescription' id='equipmentDescription' value='' maxlength='250' class='textbox'  title='Equipment Description'/></td>  
                    </tr> 
                    <tr>
                        <td style="text-align: right">AMC Due Date :</td><td style='text-align: left'><input type='text' name='amcDueDate' id='amcDueDate' value='' maxlength='100' class='date'  title='AMC Due Date' readonly/></td>
                        <td style="text-align: right">AMC Amount :</td><td style='text-align: left'><input type='text' name='amcAmount' id='amcAmount' value='' maxlength='14' class='number'  title='AMC Amount'/></td>
                    </tr> 
                    <tr>
                        <td style="text-align: right">Procurement Date<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='procurmentDate' id='procurmentDate' value='' maxlength='100' class='date'  title='Procurment Date' readonly onchange="getValidateDate()"/></td>
                        <td style="text-align: right">Procurement Cost<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='procurmentCost' id='procurmentCost' value='' maxlength='14' class='number'  title='Procurment Cost'/></td>
                    </tr>
                    <tr>
