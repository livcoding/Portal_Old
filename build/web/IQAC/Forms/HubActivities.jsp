<%-- 
    Document   : HubActivities
    Created on : Jul 26, 2017, 3:42:26 PM
    Author     : ashish1.kumarr
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/HubActivitiesJS.js"></script>
        <script>
    ...
    <body>
      ...
      <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 50%;float: left;text-align: right;font-size: large">Hub Activity Form</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-SAP-FORM-2]</div></div>
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" >
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                   ...
                   <tr>
                         <td style="text-align: right">Name Of Hub<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='hubName' id='hubName' value='' maxlength='100' class='textbox'  title='Hub Name' /></td>
            ...
            <div style="height: 150px;" >
                <table id="interdisciplinaryTable" style="width: 100%;font-size: 18px;text-align: center;">
                    <tr class="_thead">
                        ...
                        <th id="detailHeader" style="width:20%">Detail of Event</th>
                        <th style="width:10%">Financial Support</th>
                    ...
                    <td><input type="text" name="facultyName" id="facultyName1" value="" maxlength="100" class="textbox" style="width:84%"  /></td>
