    ...
    <body>
        ...
        <div style="width: 90%; padding: 10px ;border: .3em solid;border-radius: 25px;margin-left:4%" >
            <table  id="commonmasterid" style="text-align: left;font-size: 18px; border:1px;width:90%">
                <tr>
                     <td width="10%" align="right" nowrap>Company<span class="req"> *</span> :</td>
                    <td width="40%">
                        <select  name='company' id='company'  class='combo' style='width:100%'  title='Comapny'>
                            <option value="">Select Company</option>
                        </select>
                    </td>
                    <td width="10%" align="right" nowrap>Institute<span class="req"> *</span> :</td>
                    <td width="40%">
                ...
                <tr>
                    ...
                    <td width="40%">
                        <select  name='acadyear' id='acadyear'  class='combo' style='width:100%'  title='Academic Year'>
                ...
                <tr>
                     <td width="10%" align="right" nowrap>Program<span class="req"> *</span> :</td>
                     <td width="40%">
                        <select  name='program' id='program'  class='combo' style='width:100%'  title='Department'>
                            <option value="">Select Program</option>
                        </select>
                    </td>
                    <td style="text-align: right;" width="100%" colspan="2" nowrap>
                        <button name="submitbutton_facultyTrans" id="submitbutton_facultyTrans"  class="button" style="width:120px;height:25px;margin-left:140px;">Generate Report</button>
                    </td>
                </tr>
            </table>
        </div>
