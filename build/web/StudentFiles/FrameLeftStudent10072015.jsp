...
if(1==1)
	 ...
	 qry="Select WEBKIOSK.ShowLink('249','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
		...
		<img src="../Images/bullet4.gif">&nbsp;<a  target="DetailSection" title='Supplimentary Registration Form ' href='Exam/RegistrationActionJIIT2.jsp'><FONT face="Arial" color =white size=2>II Supplimentary <br><FONT face="Arial" color='#de6400' size=2>&nbsp;&nbsp;&nbsp;</font>Reg. Form</font></a><br>
