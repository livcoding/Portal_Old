...
qry="SELECT nvl(SUMMEREXAMCODE,' ')SUMMEREXAMCODE, nvl(PREVEXAMCODE,' ')PREVEXAMCODE, nvl(SUPFEES,'')SUPFEES  FROM EXAMMASTER where InstiTuteCode='"+mInst+"' and examcode='"+QryExam+"' and NVL(LOCKEXAM,'N')='N'";
//out.println(qry);
rs=db.getRowset(qry);
if(rs.next())
{
