...
<form name="frm" method=post>
			...
			<%
			qry="select distinct nvl(examcode,' ')examcode, EXAMPERIODFROM from exammaster where institutecode='"+mInst+"' AND (eXAMCODE LIKE 'SUP%' ) and nvl(deactive,'N')='N' and nvl(LOCKEXAM,'N')='N' and  trunc(sysdate) >= trunc(examperiodfrom) and trunc(sysdate) <=trunc(examperiodto)   order by examcode Desc";
		//out.println(qry);
			rs=db.getRowset(qry);
			%>
