...
<%
	...
	qry=qry+" and examcode in ( select examcode from V#StudentSubjectTagging where StudentID='"+mMemberID+"' group by examcode) order by examcode desc";
	//out.print(qry);
  	rs=db.getRowset(qry);
...
<table><tr><td><font size=2 color=red face=arialblack>&nbsp;Hint: </font><font face=arialblack size=2 color=Green>If the '%' attendance of Lecture, Tutorial or Practical is not above 50%, It will be appeared in Red color</font></td></tr></table>
