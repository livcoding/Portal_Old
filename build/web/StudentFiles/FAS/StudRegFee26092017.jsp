...
qry=qry+" And STUDENTID='"+mChkMemID+"'  Group By COMPANYCODE, INSTITUTECODE, STUDENTID, ACADEMICYEAR, PROGRAMCODE, BRANCHCODE, SEMESTER, SEMESTER, SEMESTER||' (' ||SEMESTERTYPE||')',CURRENCYCODE,PAIDINACCOUNTINGCURRENCY,REFUNDINACCOUNTINGCURRENCY";
...
while (RsFee.next())
   {
	...
	<td align=right><A target=_new href="StudRegFeeDetail.jsp?SEM=<%=RsFee.getString("SEMESTER")%>&amp;CC=<%=RsFee.getString("CURRENCYCODE")%>"><%=RsFee.getDouble("FEEAMOUNT")%></A>&nbsp; &nbsp;</td>
