...
qry="SELECT to_char(FROMPERIOD,'dd-mm-yyyy')FROMPERIOD, to_char(TOPERIOD,'dd-mm-yyyy')TOPERIOD, NVL(STATUS,'N')STATUS ,NVL(ASSESSMENTYEAR,' ')ASSESSMENTYEAR , NVL(FINYEAR,' ')FINYEAR,NVL(TDSCODE,' ')TDSCODE		FROM TDS#PARAMETER where companycode='"+mComp+"'  ";  //sysdate between fromperiod and toperiod and
//out.print(qry);
rs=db.getRowset(qry);
if(rs.next())
		{
 ...
 qry1="select COMPANYCODE, TDSCODE, ASSESSMENTYEAR, EMPLOYEEID, to_char(DECLARATIONDATE,'dd-mm-yyyy')DECLARATIONDATE, FINYEAR,nvl(FINALFREEZE,'N')FINALFREEZE  from TDS#EDIDECLARATIONHEADER where  COMPANYCODE='"+mComp+"' and  TDSCODE='"+mTDSCode+"' and ASSESSMENTYEAR='"+mAssessYear+"' and EMPLOYEEID='"+mDMemberID+"' AND NVL(FREEZE,'N')='Y' ";
// out.print(qry1);
rs1=db.getRowset(qry1);
if(rs1.next())
		{
