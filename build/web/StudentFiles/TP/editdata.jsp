...
try
{
	 qry1="select distinct NVL(BRANCHCODE,' ') b FROM v#studentmaster where nvl(Deactive,'N')='N' and PROGRAMCODE='"+program+"' and ACADEMICYEAR='"+Academicyear+"'";
	  rst=db.getRowset(qry1);
	if (request.getParameter("x")!=null)
	{
		%>
...
<td valign="top" align="left"  nowrap>
    ...
    try
{
	 qry1="select distinct NVL(SEMESTER,0) s FROM v#studentmaster where nvl(Deactive,'N')='N' and PROGRAMCODE='"+program+"' and ACADEMICYEAR='"+Academicyear+"' and BRANCHCODE='"+branch+"'";
	  rst=db.getRowset(qry1);
	if (request.getParameter("x")!=null)
	{
		%>
...
<td nowrap><% if(request.getParameter("DATE1")==null){
    ...
    <INPUT TYPE="text" readonly NAME=DATE1 ID=DATE1 size=9 tabindex=1 VALUE='<%=mDate12%>'
