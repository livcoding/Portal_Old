...
%>
<option value="<%=mDEPARTMENTCODE%>"><%=rs.getString("Department")%>  -  <%=rs.getString("DEPARTMENTCODE")%></option>
<%
}
}
else
...
{
%>
<option selected value="<%=mDEPARTMENTCODE%>"><%=rs.getString("Department")%>  -  <%=rs.getString("DEPARTMENTCODE")%></option><%
}
else
{
%>
