...
//out.print(qry);
		...
		while(rs.next())
			...
			qry="Select B.COURSECREDITPOINT COURSECREDITPOINT, decode(nvl(COURSETYPE,'C'),'C','A','B','E','E') BASKET from ProgramSubjectTagging B where ";
		...
		qry="Select distinct  SubjectID from ";
	...
	<br>	<br>	<br>
	<A href="../StudentPageFinal.jsp"><font color=red size=2 face='verdana'><b>Click to View Webkiosk</b></font></A>
