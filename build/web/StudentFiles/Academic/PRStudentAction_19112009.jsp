...
<%
			...
			{	//3
				...
				for (int TT1=1;TT1<=mTotalRec;TT1++)
				{
					...
					String bhk="",aaaaa="";
					aaaaa="temp1"+request.getParameter(mName8)+"1";
					//out.println(request.getParameter(aaaaa));
					
					//out.println("::<br>"+request.getParameter(mName8));
					if(request.getParameter(aaaaa)==null)
						bhk="";
					else
						bhk=request.getParameter(aaaaa);
					...
					if(mChk.equals("Y"))
					{
						...
						//out.println(sum1+"::<br>"+request.getParameter(mName8));
						if(!melec.equals(melecold))
						{
							//out.println("aaa");
