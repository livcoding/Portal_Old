...
return false;
	...
	if(tt==0){
		alert("You have not filled choices in all the compulsary PD electives.");
		document.getElementById(c).value="";
...
if(document.frm1.mProg.value=='DUAL' && document.frm1.mSem.value=='10')
	{
	var cr=parseInt(document.frm1.TotalCCPAld.value);
		var corecr=parseInt(document.frm1.corecrpoint.value);
		var total=parseInt(document.frm1.TotalCCP.value);
...
if(mFlag==1)
				{
			%>
			<h3><font face="verdana" size=3> <b> You have been registered for following Courses 
