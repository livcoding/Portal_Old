...
<%=mYear%>) then the students shall get an option to tick the choice of even-semester
<%=mYear%> core-courses that he/she wishes to opt by un-checking the courses that are
