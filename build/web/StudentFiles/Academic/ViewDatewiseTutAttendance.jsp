...
<HTML>
<head>
<TITLE>#### <%=mHead%> [Student Attendance Report (Tutorial Attendance Detail)]</TITLE>
...
<tr>
<TD CLASS="pageheading"  colspan=0 align=middle >Student Tutorial Attendance Detail</td>
</tr>
</TABLE>
<%
...
<table width="100%">
<tr><td align=center>
 <font color="#00008b">Subject Code: <b><%=mSubject%></B> &nbsp; &nbsp;Student Name: <B><%=GlobalFunctions.toTtitleCase(mSnm)%> [<%=mENo%>]</B> &nbsp; &nbsp; LTP: <B><%=GlobalFunctions.getLTPDescWSQ(mLTP)%></B>
 </font>
</td></tr></table>
...
<tr bgcolor="#c00000">
 ...
 <td Title="Click on Status to Sort"><b><font color="White">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Status</font></b></td> 
...
<%
	...
	qry=qry+" union	select to_char(a.ATTENDANCEDATE,'DD-MM-YYYY')ADate, nvl(a.ATTENDANCETYPE,'R')CType, nvl(b.Employeename,' ')EName, nvl(a.PRESENT,'N')Status from STUDENTPREVATTENDENCE a , Employeemaster b	where a.EXAMCODE='"+mExam+"' and a.EMPLOYEEID = B.EMPLOYEEID and a.ATTENDANCETYPE=Decode('"+mCType + "','ALL',a.ATTENDANCETYPE,'"+ mCType +"') and a.SUBJECTID='"+mSubj+"' and a.LTP='"+mLTP+"' and a.STUDENTID='"+mChkMemID+"' and nvl(a.DEACTIVE,'N')='N' "; 
	rs=db.getRowset(qry);
//out.print(qry);
	mSNO=0;
	while(rs.next())
