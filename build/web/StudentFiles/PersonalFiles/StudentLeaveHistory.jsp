<%-- 
    Document   : StudentLeaveHistory
    Created on : Sep 7, 2012, 4:08:17 PM
    Author     : ankur.verma
--%>
...
String mStudentName="",mEnroll="",mSex="";
	...
	if(rs.next())
	{
		...
		<font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana">
            <u><FONT SIZE=4>Student Leave History</FONT></u></b></font>
		<br><br>
		<table align=center cellpadding="0" cellspacing="0" border="0" rules="groups">
			...
			<b><FONT face=Arial size=2>&nbsp;&nbsp;Student Name : </B>
				...
				<font color="#00008b" ><b> &nbsp;<%=mEnroll%> </b></font><hr>
				</td>
			</tr>
		</table>
		</center>
		...
		qry=qry+" FROM STUDENTLEAVETRANSACTION where companycode='"+mComp+"' " +
                "and EmpCategorycode='STU' ";
		...
		<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana">
            ...
            <FONT SIZE=4>Availed Leaves</FONT></u></b></font></td></tr>
		</table>
