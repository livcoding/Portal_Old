...
if(1==1)
	 ...
	 qry="Select WEBKIOSK.ShowLink('249','"+ mMemberID +"','S','"+mRole+"','"+ mIPAddress +"') SL from dual";
		...
		{
		%>
		<img src="../Images/bullet4.gif">&nbsp;<a  target="DetailSection" title='Supplimentary Registration Form ' href='Exam\RegistrationActionJIIT.jsp'><FONT face="Arial" color =white size=2>Supplimentary Reg.<small>Form</small></font></a><br>
		<%
		}
