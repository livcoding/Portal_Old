...
try
{ 
	qry="Select Distinct nvl(SRSEventCode,' ') SRSEVENTCODE from v#SRSEVENTS Where nvl(Approved,'N')='N' and nvl(Deactive,'N')='N'";
	rs=db.getRowset(qry);
	if (request.getParameter("x")==null)
	{
		%>
...
%> 
<tr><td>&nbsp;</td><td Nowrap><FONT color=black face=Arial size=2><strong>SRS Count >=&nbsp;</strong></FONT><INPUT Type="Text" style="text-align=right"size=3 maxlength=3 Name=mCount id=mCount  Value=<%=mT%>>
...
<td><b><font color="white" size=2>Approve?<br><input onClick="un_check()" type="checkbox" id='allbox' name='allbox' value='Y'>All</font></td>
</tr>
 <%
//------------------  
