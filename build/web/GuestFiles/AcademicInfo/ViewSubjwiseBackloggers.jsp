	  ...
	  //-----------------------------
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
			...
			{
				mSubjectType="E";
				qry="Select nvl(ElectiveCode,' ')ECode from PR#STUDENTSUBJECTCHOICE where subjectid='"+mSubjID+"' And INSTITUTECODE='"+mInstitute+"'";
				rs1=db.getRowset(qry);
				if(rs1.next())
			...
			<%
				...
				qry=qry+" AND B.SEMESTERTYPE='RWJ' And (b.INSTITUTECODE,b.EXAMCODE) in (Select E.INSTITUTECODE, E.ExamCode from PREVENTMASTER E Where E.EXAMCODE='" + mExam+ "' And INSTITUTECODE='"+mInstitute+"' and nvl(E.DEACTIVE,'N')='N')";
