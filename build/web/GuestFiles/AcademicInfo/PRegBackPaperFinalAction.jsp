...
//------------------------------------------------
			...
			{
				%><BR><%
				out.print(" &nbsp;&nbsp;&nbsp <b><font size=2 face='Arial' color='Green'> Back Log Paper(s) are approved successfully...</font> <br>");
			}
			else if(mRecFlag==6)
			{
				%><BR><%
				out.print(" &nbsp;&nbsp;&nbsp <b><font size=2 face='Arial' color='Green'> Back Log Paper(s) are unapproved successfully...</font> <br>");
			}	
//------------------------------------------------
//-------------------------------------------------------
//-----------------------------
