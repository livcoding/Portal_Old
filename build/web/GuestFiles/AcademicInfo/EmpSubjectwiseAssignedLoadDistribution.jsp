...
//--------------------------------------------HOD------------------------------------- 
					if(mType.equals("H"))
					{
						...
						qry=qry+" A.EXAMCODE='"+mE+"' AND C.DEPARTMENTCODE='"+QryDept+"' and A.STATUS='"+mShowLoadOn+"'";
...
//--------------------------------------------DOAA-------------------------------------
					if(mType.equals("D"))
					{
						...
						qry=qry+" C.DEPARTMENTCODE dcode From PR#HODLOADDISTRIBUTION A, SUBJECTMASTER B, V#STAFF C";
						qry=qry+" Where A.SUBJECTID=B.SUBJECTID AND A.INSTITUTECODE=B.INSTITUTECODE AND A.COMPANYCODE=C.COMPANYCODE AND A.FACULTYID=C.EMPLOYEEID AND ";
						qry=qry+" A.EXAMCODE='"+mE+"' AND C.DEPARTMENTCODE='"+QryDept+"' and A.STATUS='"+mShowLoadOn+"' Order By subname";
					}
					//out.print(qry);
					rs=db.getRowset(qry);
