...
' *******************************************************************************************
' *													   *
' * File Name:	PRRegBatchAllocation.jsp [For Employee]						          *
...
if(!mMemberID.equals("") &&  !mMemberCode.equals("") && !mMemberName.equals("")) 
{
  ...
  //-----------------------------
	...
	qry="Select WEBKIOSK.ShowLink('57','"+ mChkMemID+"','"+mChkMType+"','"+mRole+"','"+ mIPAddress +"') SL from dual";
...
try
{ 
	qry1="Select Distinct P.SUBJECTID SubjectID, nvl(S.Subject,' ')||' ['||P.SUBJECTID||']' Subj from PR#FACULTYSUBJECTCHOICES P, SubjectMaster S where nvl(P.SELECTEDSUBJECT,'N')='N' ";
