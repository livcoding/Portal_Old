...
String mInst="",mHOD="";
String mSUBJECT="", mSECTIONBRANCH="", if (session.getAttribute("InstituteCode")==null)
{
	mInst="";
}
else
...
mFACULTYID="",mFACULTYID1="",mFACULTYID2="",mDept="",mDeptCode="",mDeptment="";
...
qry=qry+" From PR#HODLOADDISTRIBUTION A,SUBJECTMASTER B,EMPLOYEEMASTER C where A.SUBJECTID=B.SUBJECTID and A.FACULTYID=C.EMPLOYEEID And INSTITUTECODE='"+mInst+"'";
