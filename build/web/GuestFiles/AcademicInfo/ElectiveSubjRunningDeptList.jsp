...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Elective/Free Elective Subject Running Department List] </TITLE>
		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
			...
			{		
				...
				<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>View Elective/Free Elective Subject(s) Department</B></TD>
				</font></td></tr>
				</TABLE>
				...
				<tr>
				 ...
				 <%
				 if(mSTYPE.equals("F"))
					mSType="Free Elective";
				 else if(mSTYPE.equals("E"))
					mSType="Elective";
				 %>
				...
				{ 
					...
					<td align=center><%=rs.getString("DEPTCODE")%></td>
