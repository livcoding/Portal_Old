		...
		if (RsChk.next() && RsChk.getString("SL").equals("Y"))
		  ...
		  //----------------------
			...
			<!--*********Final/Draft Mode**********-->
				...
				<th><b><font color="white" size=3>Approve?&nbsp;</font><br><font color="white" size=3><input onClick="un_check()" type="checkbox" id='allbox' name='allbox' value='Y'></font></b></th>
				...
				qry="select Distinct nvl(A.DEPARTMENTRUNNIG,' ') Dept, nvl(A.STATUS,'D')Status, nvl(B.EMPLOYEEID,' ') HOD, nvl(C.EMPLOYEENAME,' ') HODName, nvl(C.EMPLOYEECODE,' ') HODCode, nvl(FACULTYTYPE,' ')FACULTYTYPE from PR#HODLOADDISTRIBUTION A, ";
