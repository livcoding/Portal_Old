...
<%
	...
	qry=qry+" and A.ENTRYBYFACULTYID='"+mFaculty+"' and A.FSTID IN(select FSTID from V#STUDENTATTENDANCE where Entrybyfacultyid='"+mFaculty+"' and subjectid='"+mSubjID+"' And INSTITUTECODE='"+mInst+"' and ";
