...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Employee Lists Late] </TITLE>
		...
		while(rs.next())
		   {
			...
			<td nowrap align=left>&nbsp;<A Title="Click Employee Name To View Detail"HREF="EmployeeLateEarlyAttendance.jsp?ECD=<%=rs.getString("EmployeeCode")%>"><%=rs.getString("EmployeeName")%></A></td>	
