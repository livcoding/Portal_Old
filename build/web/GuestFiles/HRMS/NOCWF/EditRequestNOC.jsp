...
String mDMemberType="";
String mMemberCode="";
String mDMemberCode="",mInst="",mRightsID="177";
...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Edit Leave Request For NOC] </TITLE>
...
try
{
	String mPageHeader="Edit Leave Request for NOC", mMarqMsg="", CurrDate="";
...
<%
	...
	%>
		...
		<td nowrap align=center><a Title="Click to Edit <%=rs.getString("EMPLOYEENAME")%>'s NOC Leave Request" href='EditRequestNOCDetail.jsp?EID=<%=rs.getString("EMPLOYEEID")%>'><FONT COLOR=blue>Edit</FONT></a>
		</td>
		</tr>
		</tbody>
		<%
