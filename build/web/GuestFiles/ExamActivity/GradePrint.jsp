...
<td>
	...
	<%
qry="select distinct examcode from gradecalculation Where InstituteCode='"+mInst+"'";
		rs=db.getRowset(qry);
...
qry=qry+" where  employeeid='"+mChkMemID+"' and examcode='"+mDefault+"'  and COORDINATORID<>'"+mChkMemID+"' ) A,subjectmaster B where A.subjectID=B.subjectID ";
