...
int msno=0, len=0, pos=0, ctr=0,mFlag=0;
  ...
  //----------------------
		...
		mFlag=1;
			...
			while(rs.next())
			{
				...
				<td nowrap><Font size=2 COLOR="darkOrange" face=arial><b><%=rs.getString("status")%></b></font></td>
			...
			if(mFlag==0)
				{
					out.print(" &nbsp;&nbsp;&nbsp<center> <b><font size=4 face='Arial' color='gREEN'>Grades are Entered ! </font></center> <br>");
				}
