...
else
{
	...
	qry="select GRADEENTRYEXAMID  from COMPANYINSTITUTETAGGING Where COMPANYCODE='"+mComp+"' And INSTITUTECODE='"+mInst+"'";
	rs=db.getRowset(qry);
	if(rs.next())
	{
...
<td>
	...
	qry=qry+" where  INSTITUTECODE='"+mInst+"' And employeeid='"+mChkMemID+"' and COORDINATORID<>'"+mChkMemID+"' ) A,subjectmaster B where A.subjectID=B.subjectID ";
...
qry2=qry2+" where  institutecode='"+mInst+"' And employeeid='"+mChkMemID+"' and COORDINATORID<>'"+mChkMemID+"' and subjectID='"+mSC+"' )) ";
