...
//--------------------------------------
		...
		qry=qry+" where institutecode='"+mIC+"' and EVENTSUBEVENT='"+mEventsubevent+"' and nvl(PROCEEDSECOND,'N')='Y' and nvl(a.DEACTIVE,'N')='N' and nvl(locked,'N')='N' and  ";
		...
		{
//out.println("PROCEED"+mProceed);
//out.println("Employeeid"+mDMemberID);
...
//out.println("Locked"+mLocked);
//out.println("Employeeid"+mDMemberID);
	if(mLocked.equals("Y"))
			{
			 /*qry1="Update STUDENTEVENTSUBJECTMARKS set LOCKED='Y' where ";
                   qry1=qry1+" EVENTSUBEVENT='"+mEventsubevent+"' and FSTID in (select FSTID from FacultySubjectTagging ";
			 qry1=qry1+" where INSTITUTECODE='"+mIC+"' and ExamCode='"+mEC+"' and employeeid='"+mDMemberID+"' and facultytype=decode('"+mDMemberType+"','E','I','E')";
			 qry1=qry1+" and SubjectID='"+mSC+"' and (LTP='L' OR PROJECTSUBJECT='Y'))";*/
