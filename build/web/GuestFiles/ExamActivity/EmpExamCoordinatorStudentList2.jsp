...
String mExamID="",mexam="",mExamid="",QryExamid="",meventcode="",mSubEventCode="",mEventCode="",mSubj="",msubj="";
...
try
{
  ...
  //----------------------
		...
		<!--*********Exam**********-->
			...
			try
			{
			 qry="Select Distinct NVL(EXAMCODE,' ')EXAMCODE,EXAMEVENTDESC ||'('||EXAMEVENTCODE||')' ExamEvent from EXAMEVENTMASTER WHERE INSTITUTECODE='"+mInst+"' and nvl(Deactive,'N')='N' ";
			 rs=db.getRowset(qry);
