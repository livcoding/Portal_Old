...
/*
***************************************************************************************
	' * File Name:		DetailSelfStudEmpDrCrAdvice.JSP			[For Students]					
...
%>	<table width="100%" ALIGN=CENTER bottommargin=0  topmargin=0>
	...
	<FORM METHOD=POST ACTION="DetailSelfEmpStudDrCrAdvice.jsp">
...
%>
	...
	<tr bgcolor="#ff8c00">
	 ...
	 <td align=center Title="Click on Amount to Sort"><b><font   
	 color="White">Serial No.</font></b></td> 
...
%>				
				<tr>
				 ...
				 <td class="tablecell"> &nbsp;<%=rs.getString("SLNO")%></td>
...
%>
	...
	<table width="100%">
	  <tr>
		<FORM METHOD=POST ACTION="DetailSelfStudEmpDrCrAdvice.jsp">
	...
	var st1 = new SortableTable(document.getElementById("table-1"),["Number","CaseInsensitiveString","CaseInsensitiveString","CaseInsensitiveString","CaseInsensitiveString","CaseInsensitiveString","CaseInsensitiveString","CaseInsensitiveString"]);
	</script>
