...
%>
<center><U><FONT face='arial' color=darkbrown size=4>Parents Signup Screen </FONT></U>
<TABLE cellSpacing=2 cellPadding=3 width="100%" border=2 rules="groups" bordercolor=black>
  ...
  <TR>
  <form name=frm1 action="AdminSignUpParentsAction.jsp" method=post>
...
//-------------------------
	...
	<tr>
	<TD>
      <INPUT id=ChkAllSudent type=radio checked name=ChkAllSudent title='LoginID for Parents' value =A>Login for Parents
