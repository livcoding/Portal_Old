<%-- 
    Document   : mbaApplicantDetail
    Created on : 2 Nov, 2015, 11:39:53 AM
    Author     : nipun.gupta
--%>
...
<HTML>
    <head>
        ...
        <script src="js/mbaApplicantDetailJS.js"></script>
        <script>
        ...
        <form name="employeeMaster">
            <div id="non-printable"> 
                <table cellpadding=2 cellspacing=2 align=center rules=groups border=1 style="table-layout:fixed;">
                    <tr><td align="center" colspan='4' bgcolor='#c00000'><font color=white><b>MBA Applicant Detail</b></font></td></tr>
                    <tr>
                        <td style="text-align: right">Admission Year<span class="req"><font color='red'> *</font></span> :</td><td style="text-align: left"><select  name='admissionYear' id='admissionYear'  class='combo' style=''  title='Admission Year'><%=ccd.commonJspCombo("{\"comboId\":\"admissionYearCombo\"}")%></select></td>
                    ...
                    <tr>
                       ...
                       <td colspan="2" align="right"><input type="button" id="submitReport" value="Submit"  style="margin-right: 35%" onclick="generateReportMBAApplicantDetail()"></td>
                    </tr>
                </table>
            </div>
            <div id="printable">
