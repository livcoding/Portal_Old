...
<tr><td>&nbsp;&nbsp;<font color=black face=arial size=2><STRONG> Name:&nbsp;</STRONG></font><%=GlobalFunctions.toTtitleCase(mSnm)%>[<%=mENo%>]
	&nbsp; &nbsp; &nbsp; &nbsp; <font color=black face=arial size=2><STRONG>Course/Branch:&nbsp;</STRONG></font><%=mProgr%>(<%=mBran%>)
	&nbsp; &nbsp; &nbsp; &nbsp; <font color=black face=arial size=2><STRONG>Current Sem:&nbsp;</STRONG></font><%=mSem1%>
</td></tr>

<tr><td>&nbsp;&nbsp;<font color=black face=arial size=2><STRONG>Exam Code</STRONG></font>
<%
  qry="Select nvl(examcode,' ')examcode from exammaster where institutecode='"+mInst+"' and nvl(deactive,'N')='N'";
  qry=qry+" and examcode in (Select ExamCode from V#StudentLtpDetail Where studentid='"+mSID+"' and institutecode='"+mInst+"' And nvl(deactive,'N')='N' Group By ExamCode) ";
...
/*
	...
	qry=qry+" and A.studentid='"+mSID+"' and B.institutecode='"+mInst+"' and ";
...
qry="select studentid,subjectid,nvl(SUBJECT,' ')||'('||NVL(SUBJECTCODE,' ')||')' SUBJECT  from V#StudentltpDetail where EXAMCODE='"+mexam+"' and studentid='"+mSID+"' and institutecode='"+mInst+"' group by studentid,subjectid,SUBJECT,SUBJECTCODE having count(*)>=1 ";
	...
	%>
	   <tr>
		...
		<td>
			<%
			qry1="select distinct EMPLOYEENAME,LTP FROM V#StudentltpDetail WHERE EXAMCODE='"+mexam+"' and studentid='"+mSID+"' and institutecode='"+mInst+"' and subjectid='"+mSubjectID+"' and nvl(deactive,'N')='N'";
		...
		<td>
				<%
			qry2="select distinct EMPLOYEENAME,LTP FROM V#StudentltpDetail WHERE EXAMCODE='"+mexam+"' and studentid='"+mSID+"' and institutecode='"+mInst+"' and subjectid='"+mSubjectID+"'  and nvl(deactive,'N')='N'";
		...
		<td>
		<%
			qry3="select distinct EMPLOYEENAME,LTP FROM V#StudentltpDetail WHERE EXAMCODE='"+mexam+"' and studentid='"+mSID+"' and institutecode='"+mInst+"' and subjectid='"+mSubjectID+"' and  nvl(deactive,'N')='N' ";
