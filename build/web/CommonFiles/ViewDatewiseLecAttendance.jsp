...
String mSpecialApproval="",mREGCONFIRMATIONDATE1="",QryProgramCode="",QryAcad="",qrtyyy="";
...
String mCType="ALL" ,mInst="",mColor="",mColor1="";
	...
	String QryFSTID="",QrySemType="",mSec="",mSubSec="",mSID="",QryEmpID="",mmRegConfirmDateOrg="";
	long QrySem=4;
...
//out.print(QryEmpID+"LLL");
	...
	if (request.getParameter("mRegConfirmDateOrg")==null)
	{
		mmRegConfirmDateOrg="";
	}
	else
	{	
		mmRegConfirmDateOrg=request.getParameter("mRegConfirmDateOrg").toString().trim();
	}
...
if (request.getParameter("SID")==null)
	...
	{	
		mMemberID=request.getParameter("SID").toString().trim();
	}
...
qry="select distinct StudentName, Enrollmentno,ACADEMICYEAR, SEMESTER, STUDENTID,NVL(SEMESTERTYPE,' ')SEMESTERTYPE,  AcademicYear AcademicYear,ProgramCode ProgramCode from  V#STUDENTLTPDETAIL where StudentID='"+mMemberID+"'  and INSTITUTECODE='"+mInst+"'  and EXAMCODE='"+mExam+"' ";
...
//-------------------------- For T Type Subject -------------------------------------
	...
	qry7=qry7+" and   NVL (deactive, 'N') = 'N'    and INSTITUTECODE='"+mINSTITUTECODE+"'"; 
		qry7=qry7+"   and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) ) ";
	...
	qry8=qry8+" and   NVL (deactive, 'N') = 'N'    and INSTITUTECODE='"+mINSTITUTECODE+"'";  
		qry8=qry8+"   and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) ) ";
	...
	if(mLTP.equals("L") || mLTP.equals("T") || mLTP.equals("P") || mLTP.equals("LT") )
		   {
				%>
					...
					<li>Your Registration Date: <%=mmRegConfirmDateOrg%> <br>
