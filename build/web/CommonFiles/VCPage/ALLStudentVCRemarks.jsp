...
<tr>
<TD colspan=0 align=middle><font color="#a52a2a" face=verdana size=4>View Existing Remarks/Comments(Query/View criteria)</b></font>
</td>
</tr>
</TABLE>
<br>
<table align=center rules=groups border=2 width=70%  cellspacing=0 cellpadding=0 >
<tr>
<td><font color="black" face=verdana size=2>Interaction date between
