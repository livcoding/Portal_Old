...
try
  {
String mFinalFreeze="",mFinalTextReadonly="",mFinalDisablecombo="";
	
		

 qry1="select  nvl(FREEZE,' ')FREEZE , NVL(FINALFREEZE,' ')FINALFREEZE from TDS#EDIDECLARATIONHEADER where  COMPANYCODE='"+mComp+"' and  TDSCODE='"+mTDSCode+"' and ASSESSMENTYEAR='"+mAssessYear+"' and EMPLOYEEID='"+mDMemberID+"' ";
