...
try
{
	qry="Select Distinct nvl(B.PROGRAMCODE,' ')PROGRAMCODE, A.PROGRAMNAME||' ('||B.PROGRAMCODE||') ' Program from " +
            "PROGRAMMASTER A, v#SRSEVENTS B where EmployeeID='"+mDMemberID +"' and A.ProgramCode=B.ProgramCode and" +
            " nvl(Finalized,'N')='Y' and nvl(B.deactive,'N')='N'";
	//out.print(qry);
    rs=db.getRowset(qry);
...
<% 
	...
	qry1 =" select distinct EXAMCODE,EMPLOYEEID,SUBJECTID,SUBJECTCODE,LTP,EMPLOYEENAME,SUBJECT from v#SRSEVENTDETAIL  Where ";
