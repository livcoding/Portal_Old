...
<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><B>SRS Finalization [After Printing Approval]</B></TD>
</font></td></tr>
</TABLE>
...
<TR bgcolor="#ff8c00">
 ...
 <td><b><font face=arial color="white" size=2>Finalize?<br><input onClick="un_check()" type="checkbox" id='allbox' name='allbox' value='Y'>All</font></td>
</tr>
</THEAD>
<%
//------------------  
