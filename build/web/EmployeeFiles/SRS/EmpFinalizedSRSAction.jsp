...
//out.print("Hello - "+mNoStudent);
	...
	out.print("<center><a href='FinalizedSRSAfterPrint.jsp'><B><Font color=blue face=verdana size=3>Back & Next</Font></B></a></center>");

	response.sendRedirect("FinalizedSRSAfterPrint.jsp?NoStudent="+mNoStudent+"&mCount="+mT+"");
