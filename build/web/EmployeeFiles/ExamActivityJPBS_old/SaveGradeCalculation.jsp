...
<%
//out.print("*****1***********");
String mHead="",mLOWERLIMIT1="",qry43="";ResultSet rs43=null;
int yrr =0;
int yrer=0;
...
////out.print("****");
//if(request.getParameter("LOWERLIMIT1")==null)
		//mLOWERLIMIT1="";
	//else
		//mLOWERLIMIT1=request.getParameter("LOWERLIMIT1").toString().trim();
////out.print("**###**");
...
// out.println(mBreakSlno+"mCheck"+mCheck);
...
else
{
	...
	{
	//out.print("*****6666666666***********");
	qry8="UPDATE EXAMEVENTSUBJECTTAGGING set LOCKED='Y' ,ENTRYdate=sysdate WHERE FSTID='"+abc+"' ";
...
Set mGradeUnChecked=new HashSet();
   	...
   	while(itun.hasNext())	
   {
	...
	//out.print("*****10000000000000**********");	// System.out.println("TYYYYYYYYYYYYYYYVVVVVVVVVVVVVVYYYYYYYYYYYYYY");
...
//System.out.println("RRRRRRRRRRRRRRRRRRRRRR");
			...
			//out.print("*****11 11 11 11 11***********");	if(mStudidInit.equals(mStudid))
				{
...
*/
//out.print("*****112 12 12 121***********");
qry43=" select NVL ( ( (CASE  WHEN (TATOTAL - Masscuts) < 0 THEN TATOTAL   ELSE  Masscuts   END)),0   )masscuts  from STUDENTGRADEMASSCUTS where  STUDENTID='"+mStudidInit+"' and fstid IN  ('"+mfst+"' ) and institutecode='"+mInst+"'  ";
//out.print(qry43);
rs43=db.getRowset(qry43);
if(rs43.next())
{
	mMass=rs43.getString("masscuts");
	  //out.print("****%%%%%*******");
  yrr = Integer.parseInt(mMass);
  //out.print("****%%%%%*******");
  //yrer = Integer.parseInt(mMarksInit);
  //out.print("****%%988798787987%%%*******");
	//yrer=yrer-yrr;
	//out.print("****%%%1212121%%*******");
}
//out.print("*****13***********");
qryttt=" Select 'Y' from  debarstudentdetail where STUDENTID='"+mStudidInit+"' and (UFM='Y' OR ABSENTCASE='Y' OR DEBAR='Y') and examcode='"+mExamCode+"' and institutecode='"+mInst+"' and fstid IN  ('"+mfst+"' )";
...
qry4=qry4+" '"+mStudidInit+"' ,'"+mInitMarks+"' ,'"+mGradInit+"' , ";
qry4=qry4+" '"+mMarksInit+"' ,'"+mGrad+"','"+mChkMemID+"',SYSDATE,'D','"+mMass+"','"+mETOD+"') ";
st.addBatch(qry4);
	 //out.println(qry4);
	//out.print("****"+mStatus+"mStatus%%%%%%%%%%%%%%%%%%%%%%%%%111111111%%%%%%%%*&@@@@@@@@@@@@@@@@@@@");
...
//out.print("****"+mStatus+"mStatus%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*&@@@@@@@@@@@@@@@@@@@"+updateCounts.length);
...
<%
//	out.print("**222222222222222222222222222222222**");
	  }
//out.print("**12121212121212121212121212**");
con.commit();
con.close();
co.DBConClose();
}
