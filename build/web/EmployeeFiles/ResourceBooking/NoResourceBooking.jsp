...
int dubCode=0,slno=0,totalcount=0;
...
<html>
 <head>
	...
	//	var y=x.type=="checkbox";
	//	y.checked=="true";
	//	alert(y);
    //   	for (var i=0; i<x.length; i++) {
 //  if (x[i].type == "checkbox" && x.checked ==true) {
  //   c++;
...
//}
		...
		if(document.getElementById("DATE2").value=="")
		 ...
		 {
		   msg=msg+"Please Fill	form time slot.\n";
         c=1;
		 document.getElementById("time1").focus();
		}
		if(document.getElementById("time2").value=="")
		 {
		 msg=msg+"Please Fill to time slot.\n";
         c=1;
		 document.getElementById("time2").focus();
		 }
	//	 if(document.getElementById("resource"+e).checked==false)
	//	{
	//	msg=msg+"please tick a resource.\n";
	//	c=1;
	//	document.getElementById("resource"+e).focus();
	//	}
		if(c>0)
		{
		alert(msg);
...
//--------------------------------------
  ...
  //-----------------------------
   ...
   <br>
   <tr  bgcolor="#ff8c00">
	<td valign="top" colspan="4" align="center" width="80%"><FONT color="black" face="Arial" size="2" align="left">Institue Code & Name<FONT color="red" face="Arial" size="4" align="left">*
     <% 
...
<%
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="checkbox" id="active" name="active" value="<%=active%>" ><FONT color="black" face="Arial" size="2" align="left">DeActive
		</td>
	...
	<tr>
	<td align="right" colspan="">From Period <font color=green face=Calibri size=2>(DD-MM-YYYY)</font><FONT color="red" face="Arial" size="4" align="left">*</td>
...
<FONT color="black" face="Arial" size="2" >Resources<FONT color="red" face="Arial" size="4" align="left">*</td>
<td align="left"  valign="top">
 <table>
  ...
  <tr><td>
  <input type="checkbox" name="resource<%=i%>"  id="resource<%=i%>" Value="Y" > 
...
&nbsp;<input type="reset" value="Cancel"/>
		...
		if(reqAction!=null && reqAction.equalsIgnoreCase("Save"))
			{
		String chkY="";
...
chkY=request.getParameter("resource"+j)==null?"Z":request.getParameter("resource"+j);
if(chkY.equals("Y"))
			{
flag=1;
resourcetypeId=request.getParameter("resourcetypeId"+j)==null?"":request.getParameter("resourcetypeId"+j);
resource=request.getParameter("resourceId"+j)==null?"":request.getParameter("resourceId"+j);
qry="SELECT 'Y' FROM rs#noresourcebooking where INSTITUTECODE='"+institute+"' and NOBOOKINGFROMDATE=to_date('"+DATE1+"','dd-mm-yyyy') and NOBOOKINGTODATE=to_date('"+DATE2+"','dd-mm-yyyy') and RESOURCEID='"+resource+"' and RESOURCETYPEID='"+resourcetypeId+"'";
...
if(request.getParameter("z")!=null)
		{if(flag==0)
{
out.print("<FONT color=red face=Arial size=2 align=right>Please Select A Resource");
}}
}
...
if(reqAction.equalsIgnoreCase("Update"))
		{
totalcount=Integer.parseInt(request.getParameter("totalcount"))==0?0:Integer.parseInt(request.getParameter("totalcount"));
	...
	String chk="";
		...
		qry1="delete from RS#NORESOURCEBOOKING   where INSTITUTECODE='"+institute+"' and NOBOOKINGFROMDATE=to_date('"+DATE1+"','dd-mm-yyyy') and NOBOOKINGTODATE=to_date('"+DATE2+"','dd-mm-yyyy')  ";
		//out.print(qry1);
		int result=db.update(qry1);

	for(int k=1;k<=totalcount;k++)
		{
chk=request.getParameter("resource"+k)==null?"Z":request.getParameter("resource"+k);
if(chk.equals("Y"))
			{
	resource=request.getParameter("resourceId"+k)==null?"":request.getParameter("resourceId"+k);
	resourcetypeId=request.getParameter("resourcetypeId"+k)==null?"":request.getParameter("resourcetypeId"+k); 
 // out.print(resource);
// out.print(resourcetypeId);
...
n=db.insertRow(qry);		
	  ...
	  <br><table cellspacing="0"  cellpadding="0"  cellspacing="0" align="center"	style="FONT-SIZE:x-small" border="1"  borderColor=black borderColorDark="white" bgcolor="white" width="850" name="table1" id="table1">
		...
		<td align="left" valign="top" id="instcode" width="6%">
		 <FONT color=white face=Arial size=2><U>S.No.</U>
		 </td>
		...
		{%>
		 <tr>
		 <td align="left" valign="top" width="10%" ><%=p%></td>
