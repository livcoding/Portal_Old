...
<tbody>
<%
	qry="select distinct nvl(FSTID,' ')FSTID, to_char(classtimefrom,'DD-MM-YYYY HH:MI PM')ADate, to_char(classtimefrom,'HH:MI PM')Classf, to_char(classtimeupto,'HH:MI PM')Classt, nvl(ATTENDANCETYPE,' ')CType, nvl(Programcode,' ')Prog, nvl(Sectionbranch,' ')Sec, nvl(Subsectioncode,' ')Sub from V#STUDENTATTENDANCE ";
	...
	while(rs.next())
	{
		...
		qry2=qry2+" where EXAMCODE='"+mExam+"' and nvl(PRESENT,'N')='Y' And INSTITUTECODE='"+mInst+"'";
		qry2=qry2+" and ATTENDANCETYPE=Decode('"+mCType + "','ALL',ATTENDANCETYPE,'"+ mCType +"')";
		qry2=qry2+" and SUBJECTID='"+mSubjID+"' and LTP='"+mLTP+"'";
		qry2=qry2+" and ENTRYBYFACULTYID='"+mFaculty+"' and nvl(DEACTIVE,'N')='N'";
		qry2=qry2+" and ProgramCode='"+mProg+"' and Sectionbranch='"+mSec+"' and Subsectioncode='"+mSub+"'";
