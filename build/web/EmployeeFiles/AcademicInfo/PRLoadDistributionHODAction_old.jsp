...
if(mType.equals("C"))
{
	...
	qry1=qry1+" and (programcode,SECTIONBRANCH,SEMESTER) in( select distinct A.PROGRAMCODE ,A.SECTIONBRANCH SECTIONBRANCH,A.SEMESTER from PROGRAMSUBSECTIONTAGGING A, ";
	qry1=qry1+" PROGRAMSCHEME B where A.institutecode='"+mInst+"' and A.examcode='"+mExamcode+"' and ";
	qry1=qry1+" A.semestertype=decode('"+mSem+"','ALL',A.semestertype,'"+mSem+"') and nvl(A.deactive,'N')='N' and ";
	qry1=qry1+" A.ACADEMICYEAR=B.ACADEMICYEAR and A.PROGRAMCODE=B.PROGRAMCODE and A.SECTIONBRANCH=B.SECTIONBRANCH and";
	qry1=qry1+" A.SEMESTER=B.SEMESTER  and B.SUBJECTID='"+mSubjID+"' and A.SUBSECTIONTYPE='C' ";
...
%>
	...
	String query123=" select count(distinct a.studentid)cnt from STUDENTREGISTRATION a, studentmaster b where ";
	query123=query123+" a.institutecode='"+mInst+"' and A.PROGRAMCODE='"+rs1.getString("PROGRAMCODE")+"' and a.institutecode=b.institutecode and a.studentid=b.studentid and b.SUBSECTIONCODE='"+mSubsection+"' AND NVL(regallow, 'N') = 'Y' and a.sectionbranch='"+mSection+"' and  (examcode,regcode) in (Select examcode,regcode ";
	query123=query123+" from PREVENTS where MEMBERTYPE='S') and  (a.INSTITUTECODE, ";
	query123=query123+" a.EXAMCODE,  a.ACADEMICYEAR, a.PROGRAMCODE, a.TAGGINGFOR, a.SECTIONBRANCH, ";
	query123=query123+" a.SEMESTER ) in (select INSTITUTECODE, EXAMCODE, ";
	query123=query123+" ACADEMICYEAR, PROGRAMCODE, TAGGINGFOR, SECTIONBRANCH, SEMESTER from ";
	query123=query123+" PROGRAMSUBJECTTAGGING WHERE EXAMCODE='"+mExamcode+"' AND SUBJECTID='"+mSubjID+"' )";
	query123=query123+" and SEMESTERTYPE=decode('"+mSem+"','ALL',semestertype,'"+mSem+"')  ";
