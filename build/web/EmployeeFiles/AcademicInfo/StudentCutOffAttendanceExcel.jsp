...
String mREGCONFIRMATIONDATE="",QryEmpID="",mStudentid="",mSemType="";
long mPresent=0, mL=0, mT=0, mP=0, mLP=0, mTP=0, mPP=0;
	...
	<font color=black face=arial size=2><STRONG>&nbsp; &nbsp; Semester Type  : <%=mSemType%></STRONG></font>
	</td></tr>
	<tr><td align=center>
