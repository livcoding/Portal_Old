...
<HTML>
<head>
<TITLE>#### <%=mHead%> [Elective Subject Choices Finalization by HOD]</TITLE>
...
<tr>
<TD colspan=0 align=middle ><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: fantasy"><b>Elective Subjects Choice Finalization by HOD </b></font></td>
</tr>
</TABLE>
<BR>
<%
...
<%
	...
	<form name="frm1" method="Post" action="PRRegElectiveSubjectActionAy.jsp" >
	<input id="x" name="x" type=hidden>
