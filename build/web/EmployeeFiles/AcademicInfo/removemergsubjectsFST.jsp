...
qry="update facultysubjecttagging set MERGEWITHFSTID='' where examcode='"+mExamcode+"' and institutecode = '"+mInst+"'   AND companycode = '"+mCompcode+"' and fstid='"+fstid+"' and ltp='"+mLT+"' ";

//System.out.println(qry);
int u=db.update(qry);
response.sendRedirect("oldSubject_newSubjectFST.jsp?oldSubject1="+oldSubject+"&LTP="+mLT+"&x=");
