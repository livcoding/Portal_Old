...
String mInst="", mEmpID="";
String OldEnNo="", OldSubj="", OldLTPVal="",OldEnNo1="";
int Ctr=0, CTR=0;
...
if(request.getParameter("SemType")==null)
		...
		if(mCutOffVal >= 0 && mCutOffVal <=100)
		{
			...
			qry=qry+" where  A.ExamCode='"+QryExam+"' and nvl(A.STUDENTDEACTIVE,'N')='N' and A.ACADEMICYEAR='"+QryAcadYr+"' AND A.PROGRAMCODE='"+QryProgCode+"' AND A.INSTITUTECODE='"+mInst+"' AND A.PROGRAMCODE NOT LIKE 'PHD%' ";
...
qry=" SELECT   nvl(count(pcount ),0)  pcount FROM (select distinct  CLASSTIMEFROM Pcount from mv_studentattendancedetail  a where SubjectID= '"+mSubject+"'  and LTP='L' and UV= '"+mUV+"'  AND  ( A.FSTID='"+mLFSTID+"'   OR (A.FSTID  IN ( SELECT b.mergewithfstid FROM FacultySubjecttagging b where  b.examcode='"+QryExam+"' and b.institutecode='"+mINSTITUTECODE+"' and b.SUBJECTID='"+mSubject+"' and  b.LTP='L' and b.FSTID='"+mLFSTID+"')))  ";  qry=qry+" and (("+QrySem+">1) or ("+QrySem+"=1 and trunc(A.attendancedate) > trunc(TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))))  and a.studentid<>'"+mMemberID+"' ";
 qry=qry+" and not exists (select 1 from mv_studentattendancedetail  c where c.studentid='"+mMemberID+"' and c.SubjectID= '"+mSubject+"'  and c.LTP='L' and c.UV= '"+mUV+"' and c.institutecode='"+mINSTITUTECODE+"' and  trunc(c.CLASSTIMEFROM)= trunc(a.CLASSTIMEFROM))";
...
qry=" select count( distinct CLASSTIMEFROM) tot  from mv_studentattendancedetail   a where SubjectID= '"+mSubject+"'  and LTP='L' and UV= '"+mUV+"' ";
...
qry1="SELECT   count(pcount ) pcount FROM (select distinct  CLASSTIMEFROM pcount from mv_studentattendancedetail  a   where SubjectID= '"+mSubject+"' and UV= '"+mUV+"' AND  a.ltp='L' and a.studentid='"+mMemberID+"'   ";
...
qry1="SELECT   count(pcount ) pcount FROM (select distinct   CLASSTIMEFROM pcount from mv_studentattendancedetail  a   where SubjectID= '"+mSubject+"' and UV= '"+mUV+"' AND   a.ltp='L' and a.studentid='"+mMemberID+"' and nvl(a.present,'N')='Y' ";
qry1=qry1+" and INSTITUTECODE='"+mINSTITUTECODE+"'  and nvl(DEACTIVE,'N')='N' and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) ) ";
qry1=qry1+" UNION   ";
qry1=qry1+" select  distinct  CLASSTIMEFROM  pcount from STUDENTPREVATTENDENCE where  subjectid ='"+mSubject+"'     AND ltp ='L'    ";
...
mNotAttendedAttendance=0;
qry=" SELECT   nvl(count(pcount ),0)  pcount FROM (select  distinct CLASSTIMEFROM Pcount from mv_studentattendancedetail  a where SubjectID= '"+mSubject+"'  and LTP='T' and UV= '"+mUV+"'  AND  ( A.FSTID='"+mTFSTID+"'   OR (A.FSTID IN ( SELECT b.mergewithfstid FROM FacultySubjecttagging b where  b.examcode='"+QryExam+"' and b.institutecode='"+mINSTITUTECODE+"' and b.SUBJECTID='"+mSubject+"' and  b.LTP='T' and b.FSTID='"+mTFSTID+"')))  ";                           
qry=qry+" and (("+QrySem+">1) or ("+QrySem+"=1 and trunc(A.attendancedate) > trunc(TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))))  and a.studentid<>'"+mMemberID+"' ";
 ...
 qry=qry+" and not exists (select 1 from mv_studentattendancedetail  c where c.studentid='"+mMemberID+"' and c.SubjectID= '"+mSubject+"'  and c.LTP='T' and c.UV= '"+mUV+"' and c.institutecode='"+mINSTITUTECODE+"' and  trunc(c.CLASSTIMEFROM)= trunc(a.CLASSTIMEFROM))";
...
while(rs1.next())
 ...
 qry=" select count( distinct CLASSTIMEFROM) tot  from mv_studentattendancedetail   a where SubjectID= '"+mSubject+"'  and LTP='T' and UV= '"+mUV+"' ";
...
qry1="SELECT   count(pcount ) pcount FROM (select  distinct CLASSTIMEFROM pcount from mv_studentattendancedetail  a   where SubjectID= '"+mSubject+"' and UV= '"+mUV+"' AND  a.ltp='T' and a.studentid='"+mMemberID+"'   ";
qry1=qry1+" and INSTITUTECODE='"+mINSTITUTECODE+"'  and nvl(DEACTIVE,'N')='N' and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) )   ";
qry1=qry1+" UNION   ";
...
qry1="SELECT   count(pcount ) pcount FROM (select distinct  CLASSTIMEFROM pcount from mv_studentattendancedetail  a   where SubjectID= '"+mSubject+"' and UV= '"+mUV+"' and a.ltp='T' and a.studentid='"+mMemberID+"' and nvl(a.present,'N')='Y' ";
qry1=qry1+" and INSTITUTECODE='"+mINSTITUTECODE+"'  and nvl(DEACTIVE,'N')='N' and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) )  ";
qry1=qry1+" UNION   ";
qry1=qry1+" select  distinct  CLASSTIMEFROM  pcount from STUDENTPREVATTENDENCE where  subjectid ='"+mSubject+"'     AND ltp ='T'    ";
qry1=qry1+" AND examcode =  '"+QryExam+"'   AND studentid = '"+mMemberID+"' and nvl(present,'N')='Y' ";       
...
mNotAttendedAttendance=0;
qry=" SELECT   nvl(count(pcount ),0)  pcount FROM (select distinct  CLASSTIMEFROM Pcount from mv_studentattendancedetail  a where SubjectID= '"+mSubject+"'  and LTP='P' and UV= '"+mUV+"'  AND  ( A.FSTID='"+mPFSTID+"'   OR ( A.FSTID IN ( SELECT b.mergewithfstid FROM FacultySubjecttagging b where  b.examcode='"+QryExam+"' and b.institutecode='"+mINSTITUTECODE+"' and b.SUBJECTID='"+mSubject+"' and  b.LTP='P' and b.FSTID='"+mPFSTID+"')))  ";                            
qry=qry+" and (("+QrySem+">1) or ("+QrySem+"=1 and trunc(A.attendancedate) > trunc(TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))))  and a.studentid<>'"+mMemberID+"' ";
 qry=qry+" and not exists (select 1 from mv_studentattendancedetail  c where c.studentid='"+mMemberID+"' and c.SubjectID= '"+mSubject+"'  and c.LTP='P' and c.UV= '"+mUV+"' and c.institutecode='"+mINSTITUTECODE+"' and  trunc(c.CLASSTIMEFROM)= trunc(a.CLASSTIMEFROM))";
...
while(rs1.next())
 ...
 qry=" select count( distinct CLASSTIMEFROM) tot  from mv_studentattendancedetail   a where SubjectID= '"+mSubject+"'  and LTP='P' and UV= '"+mUV+"' ";
...
qry1="SELECT   count(pcount ) pcount FROM (select distinct CLASSTIMEFROM pcount from mv_studentattendancedetail  a   where SubjectID= '"+mSubject+"' and UV= '"+mUV+"' and a.ltp='P' and a.studentid='"+mMemberID+"'   ";
qry1=qry1+" and INSTITUTECODE='"+mINSTITUTECODE+"'  and nvl(DEACTIVE,'N')='N' and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) )  ";
qry1=qry1+" UNION   ";
...
qry1="SELECT   count(pcount ) pcount FROM (select  distinct CLASSTIMEFROM pcount from mv_studentattendancedetail  a   where SubjectID= '"+mSubject+"' and UV= '"+mUV+"'  and a.ltp='P' and a.studentid='"+mMemberID+"' and nvl(a.present,'N')='Y' ";
qry1=qry1+" and INSTITUTECODE='"+mINSTITUTECODE+"'  and nvl(DEACTIVE,'N')='N' and ( ("+QrySem+"=1 and trunc(ATTENDANCEDATE)>=TO_Date(nvl('"+mREGCONFIRMATIONDATE+"',ATTENDANCEDATE),'dd-mm-yyyy'))  or  ("+QrySem+">1) )  ";
qry1=qry1+" UNION   ";
qry1=qry1+" select  distinct  CLASSTIMEFROM  pcount from STUDENTPREVATTENDENCE where  subjectid ='"+mSubject+"'     AND ltp ='P'    ";
qry1=qry1+" AND examcode =  '"+QryExam+"'   AND studentid = '"+mMemberID+"' and nvl(present,'N')='Y' ";       
