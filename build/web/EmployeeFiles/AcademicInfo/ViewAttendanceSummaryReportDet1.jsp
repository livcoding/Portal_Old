...
//	qry=qry+"  and s.FSTID='"+QryFSTID+"'		";  
	...
	while(rs1.next())
		...
		qry="select to_char(CLASSTIMEFROM,'DD-MM-YYYY HH:MI PM')||' - '||to_char(CLASSTIMEUPTO,'HH:MI PM') ADate, nvl(ENTRYBYFACULTYNAME,' ')EName, nvl(PRESENT,'N')Status,decode(LTP,'L','Lecture','T','Tutorial','P','Practical','N') LTP from V#STUDENTATTENDANCE ";
