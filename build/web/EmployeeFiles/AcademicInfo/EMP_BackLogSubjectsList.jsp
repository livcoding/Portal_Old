...
{*/
	...
	String mStatus="";
	//out.println(mChkMemID+"::::::::::"+mChkMType+">>>>>>>"+mRole+"'''''''''"+mIPAddress);
	...
	mDID=mChkMemID;
	mSname=RsChk.getString("studentname");
	mSCode=studRoll;
	//out.print(session.getAttribute("CompanyCode"));
...
%>
<font color=Green face=verdana Size=4><b><a href='EMP_PRStudentEntry.jsp?studentEnRoll=<%=mSCode%>'>Click to proceed Registration Process</a></b></font>	
<div class=Section1>
...
pre-registration shall be carried out from November 6, 2008 till November 10,
2008 after which the kiosk window shall automatically close and hence
...
1. For Pre registration related problem contact to Deputy Registrar / JILIT Support Team (Ext. 364) <br>
