...
try
{
  ...
  //----------------------
		...
		<tr><td align=center nowrap><font face=arial color="#00008b" size=2>Subject Code: <b><%=mSubj%></B>&nbsp; &nbsp;LTP: <B><%=GlobalFunctions.getLTPDescWSQ(mLTP)%></B>&nbsp; &nbsp;Class Time: <B><%=mAttDate%>-<%=mClassTo%></B></font></td>
		</tr></table>
		...
		qry2=qry2+" and  Sectionbranch='"+mSec+"' and Subsectioncode='"+mSub+"'";
		qry2=qry2+" and ClassTimeFrom=to_date('"+mAttDate+"','dd-mm-yyyy hh:mi pm') and to_char(ClassTimeUpto,'hh:mi PM')='"+mClassTo+"'";
