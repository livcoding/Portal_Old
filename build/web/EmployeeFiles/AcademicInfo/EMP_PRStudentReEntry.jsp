...
String readonly="",pdvalue="",mSsname="",studRoll="",mSsCode="";
int mochoice=0, mochoice1=0,Count=0,chk=0,m=1,eee=0;
int CourseCrPtBasketD=1,i=1,mTotB=0,mysno=0,mFlag=0;
String choise="",OldmELECTIVECODE1="";
double mMinBasketD=0,mMaxBasketD=0,mMaxCrLmtTknbc=0;
double mMinBasketE=0,mMaxBasketE=0;

int tcount=0,snocount=0;
   long FeeAmt = 0;
...
<script language=javascript>
        ...
        function FunMustChoice(j,k,n,PROJECT){
            var x=parseInt(j);
            var y=parseInt(k);

            //if(PROJECT=="MINOR")
var BOTHPROJECT;
BOTHPROJECT=document.getElementById("BOTHPROJECT").value;
...
//alert(BOTHPROJECT+"---");
            ...
            if(backcr>=total ){
                ...
                mName1="CHK"+y;
                //  alert(mName1+" -F- "+PROJECT);
                if(document.frm1[mName1].checked==false   && ( PROJECT!="MINOR")){
                ...
                //    document.frm1[mName1].checked=true;
                    ...
                    /* MINOR Subject */
                    if( BOTHPROJECT=="Y" ) {
                       if (  (PROJECT=="PROJECT") || (PROJECT=="MINOR")  )
                        {
                        mName1="CHK"+y;
                        mName2="CHK"+(y+1);

                        //alert(document.frm1[mName1].checked+"---"+document.frm1[mName2].checked);

                        if(document.frm1[mName1].checked==true && document.frm1[mName2].checked==true )
                        {
                    //        alert('You can choose only one amongst the PROJECT');
                        //    document.frm1[mName1].checked=false;
                               flag=1;
                        }
                        }
                    }/* MINOR Subject */
  ...
  if (  (PROJECT=="PROJECT") || (PROJECT=="MINOR")  )
             ...
             //   alert(document.frm1[mName1].checked+"---INN---"+document.frm1[mName2].checked+" --- "+mName1+"--"+mName2);
...
if(flag!=1)
{
  if(document.frm1[mName1].checked==true || document.frm1[mName1].checked==false )
      {
                if(document.frm1["CHK"+y].checked){
                    var z=parseInt(document.frm1.TotalCCPAld.value)+parseInt(j);
                    if(document.frm1.TotalCCP.value>=z){
...
/*----------------------------*/
        ...
        function FunRefresh(j,k,b,n,PROJECT){
          ...
          //  alert(PROJECT);
            ...
            Projectflag=document.getElementById("PROJECT").value;
...
var prflag=0;
  ...
  if (  (PROJECT=="PROJECT") || (PROJECT=="MINOR")  )
           ...
           //    alert(document.frm1[mName1].checked+"---"+mName1+"--"+mName2);
                //ankur
                if(document.frm1[mName1].checked==true && document.frm1[mName2].checked==true )
                {
                 //   alert('You can choose only one amongst the PROJECT');
                    ...
                    //alert(document.frm1[mName1].checked+"-innnn--");
                //    document.frm1[mName1].checked=false;
...
/*----------------------------*/
            ...
            for(i=1;i<=totalcheckcount ;i++){
                ...
                if(document.frm1[nn1].checked==false && (  BOTHPROJECT!="Y" ) ){
                    flag1=1;
            ...
            if(sum1<totalcheckcount)
            {
                ...
                if(document.frm1["Improvement"+k].value=="Y" && Projectflag!="PROJECT"  )
                {
                  //  alert(' Sorry first you have to select all Core/PD Electives/Electives subjects ');
            ...
            if(backcr>=total){
                ...
                if(parseInt(t)!=0 && parseInt(total)!=0 ){
                    ...
                    if(total>=totalchkcr  &&  Projectflag!="PROJECT"){
                  //      alert(' Sorry first you have to select all Core/PD Electives/Electives subjects');

                        //alert(document.frm1[mName1].checked+"--55-");
                        document.frm1[n].checked=true;
                        return false;
                    }else
                        if(document.frm1[n].checked  &&  PROJECT!="PROJECT"     ){



                            var z=parseInt(document.frm1.TotalCCPAld.value)+parseInt(j);
                        //  alert(z+"--"+document.frm1.TotalCCPAld.value+" -- "+j);
                           ...
                           //     document.frm1[n].checked=false;
                            ...
                            //alert(document.frm1[mName1].checked+"--66-"+document.frm1[n].checked);
                        }
                    }
                    else{
                      if(  BOTHPROJECT!="Y")
                      ...
                      //  alert(z+"--55-"+document.frm1.TotalCCPAld.value+"--"+j);
                          }
                    }
        ...
        /*
        for( i=1;i<=t;i++){
                    document.getElementById("tempPD"+i).value='N';
        ...
        function FunRefreshselect(j,k){
            ...
            if(document.getElementById(k).value!="" && parseInt(document.getElementById(k).value)<=parseInt(document.frm1.studelecchoise.value)){
                if(document.getElementById("temp"+t).value=='Y'){
                    var z=parseInt(document.frm1.TotalCCPAld.value)+parseInt(j);
                    //  alert(z+"--"+document.frm1.TotalCCP.value+"--"+document.frm1.TotalCCPAld.value+"---"+j);
                    if(document.frm1.TotalCCP.value>=z){
                        document.frm1.TotalCCPAld.setAttribute("value",z);
                        document.getElementById("temp"+t).value='N';
                    }else{
                        //	alert('You have exceeded the maximum credit limit of jjj '+document.frm1.TotalCCP.value);
        ...
        function ClickedselELE(k,j,c,b,t){
            var ttt=0;
...
return false;
                ...
                if(document.frm1.studelecchoise.value!=''){
                    ...
                    if(parseInt(c1)<=parseInt(c3)) {
                        ...
                        if(flag==1 && document.getElementById(c).value!=""){
                            alert('You have already exercised this priority');
                            document.getElementById(c).value="";
                            return false;
                        }
                        else{
        ...
        function Clickedsel(k,j,c,b,t,ECODE){
            var ttt=0;

            //alert(document.frm1.studelecchoise.value+"LLL"+document.frm1.maxValueLmitD.value);
            //alert(document.frm1.TCount.value+"sdfsdf");
            //alert(k+"---"+j+"---"+c+"----"+b+"---"+t+"----"+ECODE);
            ...
            var tt=0,xx=0,uu=0;
            //alert(mTCount+"-- TT"+ttt);
            for(i=1;i<=ttt;i++){
                //  alert(i+"-- TT"+document.getElementById("Selectf"+i).value);
                if(document.getElementById("Selectf"+i).value!="")
                {
                    tt=1;
                    break;
...
/*
            ...
            /*if(xx>10)
{
alert('Not allowed ,you have already selected electives');
document.getElementById(c).value="";
return false;
}*/
...
return false;
            ...
            var Enn="DE"+ECODE.substr(2);

            var x=0;

            var total;
            //alert(document.getElementById("DE1").value);

            if(ECODE=="DE1")
            { x=1;    t=document.getElementById("DE1").value; total=document.getElementById("DE1").value; }
            else if(ECODE=="DE2")
            { total=document.getElementById("DE2").value; x=(parseInt(document.getElementById("DE1").value)+1) ;  t= (parseInt(document.getElementById("DE1").value) + parseInt(document.getElementById("DE2").value) )  ;}
            else
            { total=document.getElementById("DE3").value; x=((parseInt(document.getElementById("DE1").value) + parseInt(document.getElementById("DE2").value) ) +1 ) ;  t= (parseInt(document.getElementById("DE1").value) + parseInt(document.getElementById("DE2").value) + parseInt(document.getElementById("DE3").value)); }
                ...
                if(document.frm1.studelecchoise.value!=''){
                    ...
                    if(parseInt(c1)<=parseInt(c3)) {
                        ...
                        if(ECODE==Enn)
                        {
                            ...
                            for( i=x;i<=t;i++){
                                //  alert(("Select"+i)+" -t- "+c+" -t- "+document.getElementById(c).value+" -t- "+document.getElementById("Select"+i).value+"-ttt-"+flag);

                                ///if(c==("Select"+i))
                                //   {

                                if((document.getElementById(c).value==document.getElementById("Select"+i).value) && document.getElementById(c).value!=null &&
                                    document.getElementById("Select"+i).value!=null
                                    && document.getElementById(c).value!=""  &&        document.getElementById("Select"+i).value!="")
                                {
                                    flag++;
                                    //    alert(("Select"+i)+" -- "+c+" -- "+document.getElementById(c).value+" -- "+document.getElementById("Select"+i).value+"-flag-"+flag);
                                }
                                //}
                        ...
                        if(document.frm1.mProg.value=='DUAL' && document.frm1.mSem.value=='9')
                        {
                            if(flag==1 && document.getElementById(c).value!=""){
                              //  alert('You have already exercised this priority.');
                            //    document.getElementById(c).value="";
                                ...
                                FunRefreshselectELE(j,c,total,ECODE);
                            }
        ...
        function FunRefreshselectELE(j,k,total,ECODE){
            var t=k.substr(6,k.length);


            if(ECODE=="DE1")
            { x=1;    y=document.getElementById("DE1").value; total=document.getElementById("DE1").value; }
            else if(ECODE=="DE2")
            { total=document.getElementById("DE2").value; x=(parseInt(document.getElementById("DE1").value)+1) ;  y= (parseInt(document.getElementById("DE1").value) + parseInt(document.getElementById("DE2").value) )  ;}
            else
            { total=document.getElementById("DE3").value; x=((parseInt(document.getElementById("DE1").value) + parseInt(document.getElementById("DE2").value) ) +1 ) ;  y= (parseInt(document.getElementById("DE1").value) + parseInt(document.getElementById("DE2").value) + parseInt(document.getElementById("DE3").value)); }



        //   alert(parseInt(document.getElementById(k).value) +"----"+parseInt(document.frm1.studelecchoise.value)+"---"+t);
            if(document.getElementById(k).value!="" && parseInt(document.getElementById(k).value)<=parseInt(document.frm1.studelecchoise.value)){

 //alert(document.getElementById("temp"+t).value+" --- "+t+"==="+("temp"+t));
              ...
              //          alert(x+" --- "+y);
                        for( i=x;i<=y;i++){
                            document.getElementById("temp"+i).value='N';
                            document.frm1.ELEpdvalue.value="Y";
                        }
        ...
        function Clickedsel11(k,j,c,b,t){
            ...
            if(flag==1 && document.getElementById(c).value!=""){
                ...
                var tt=c.substr(7,8);
                if(document.getElementById("tempPD"+tt).value=='Y')	{
                    ...
                    //	alert(document.frm1.TotalCCP.value +" -- "+z+" ggg "+document.frm1.TotalCCPAld.value+" vv "+j);


                    var z=parseInt(document.frm1.TotalCCPAld.value)-parseInt(j);
                    document.frm1.TotalCCPAld.setAttribute("value",z);
                    for( i=1;i<=t;i++){
                        document.getElementById("tempPD"+i).value='Y';
                    }
                }
            }
        }
        ...
        function onLoadfun() {
            if(document.frm1!=null) {
                ...
                if(parseInt(total)<(parseInt(corecr)+3)){
                    //alert(total+"sdfsdf"+(parseInt(corecr)+3)+" -- "+t);
                    for(i=1;i<=t;i++){
                        if(document.getElementById("Selectf"+i).value=="")
                           // document.getElementById("Selectf"+i).disabled=true;
                    }
                }
                //	alert(total+"sdfsdf"+(parseInt(corecr)+3)+" -- "+ec);
...
else
{
	mLoginComp=session.getAttribute("LoginComp").toString().trim();
		...
		if(request.getParameter("studentEnRoll")==null)
			...
			studRoll=request.getParameter("studentEnRoll").toString().trim();
		//out.println("jjj:-"+studRoll);
		
		qry="select Studentid,studentname from studentmaster where ENROLLMENTNO='"+studRoll+"' and   INSTITUTECODE='"+mInst+"'";
		//out.println(qry);
		 RsChk= db.getRowset(qry);

		if (RsChk.next())
		{
			mChkMemID=RsChk.getString("Studentid");
			mDID=mChkMemID;
			mSsname=RsChk.getString("studentname");
			mSsCode=studRoll;
			qry="select 'Y' from prevents where memberid='"+mChkMemID+"' and INSTITUTECODE='"+mInst+"' ";
		rs=db.getRowset(qry);
		if(rs.next())
		{
			qry1="update prevents set sendtohod='' where memberid='"+mChkMemID+"' and INSTITUTECODE='"+mInst+"' ";
			int x=db.update(qry1);
                    ...
                    qry = " SELECT distinct examcode, regcode                     FROM preventmaster                    WHERE institutecode = '" + mInst + "'                      AND NVL (prcompleted, 'N') = 'N'                      AND NVL (prbroadcast, 'N') = 'Y'                      AND prrequiredfor = 'S'                      AND NVL (deactive, 'N') = 'N'   ";        
					
					//AND TRUNC (SYSDATE) >= TRUNC (fromdate)                      AND TRUNC (SYSDATE) <= TRUNC (endate)";
                    rs = db.getRowset(qry);
                    //out.print(qry);
                    if (rs.next()) {
...
/********************************/
 ...
 if(rsso.next())
  {
   if(!mCoreFinal.equals("Y") && !mFELFinal.equals("Y"))
   {
 	...
 	if(!rss1.next())
		      ...
		      else if(rss1.getString("SENDTOHOD").equals("Y"))
			{
			...
			else
	      	{
				...
				<form name="frm1" method=post action="EMP_PRStudentReAction.jsp">
				<input Type=hidden id="studentEnRoll" name="studentEnRoll" value="<%=studRoll%>">				
				...
				<tr>
			     	<td colspan=2><FONT face=Arial size=2 color=black><STRONG>Student Name - </STRONG></FONT><FONT face=verdana size=2 color=black><%=GlobalFunctions.toTtitleCase(mSsname)%> (<%=mSsCode%>)</td>
                            ...
                            <%
                                               ...
                                               if (mSubjType.equals("C")) {
                                                   ...
                                                   if (mMaxCrLmtTkn <= mMaxCrLmt) {
                                                       ...
                                                       //}
%>
                            <td align=center> <input Type=checkbox id='<%=mName1%>' name='<%=mName1%>' value='Y' <%=jk%> onclick="FunMustChoice('<%=mCourseCrPt%>', '<%=mSno%>','<%=mName1%>' ,'<%=MINOR%>')"></td>
                            <%
                                                        Count++;

                                                    } else {
                            %>
                            <td align=center><input Type=checkbox id='<%=mName1%>' name='<%=mName1%>' value='Y' onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','<%=MINOR%>')"></td>
                            <%Count++;
...
%><INPUT TYPE="hidden" NAME="backcr" value=<%=mMaxCrLmtTknbc%>><%
        ...
        while (rs.next()) {
            ...
            PROJECT = mSubjName.substring(0, 7);
            // out.print(mSubjName.substring(0,7));
            ...
            if (PROJECT.equals("PROJECT") && minorflag == 1) {
                //	str1="checked";
%>
                        <INPUT TYPE="hidden" NAME="PROJECT"  id="PROJECT"  value="<%=PROJECT%>">
      <INPUT TYPE="hidden" NAME="BOTHPROJECT"  id="BOTHPROJECT"  value="Y">
                        <%
                                            } else {
                                                str1 = "checked";
                                                %>
                                                  <INPUT TYPE="hidden" NAME="BOTHPROJECT"  id="BOTHPROJECT"  value="N">
                                                      <%
                                            }
                                            ...
                                            if (mSubjType.equals("C")) {
                                                ...
                                                if (!mFlagstr1.equals("1")) {
                                                    ...
                                                    if (mMaxCrLmtTkn <= mMaxCrLmt) {
                                                        ...
                                                        //current core
%>
                            <td align=center>  <input Type=checkbox id='<%=mName1%>' name='<%=mName1%>' value='Y'  <%=str1%> onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','<%=PROJECT%>')">
                            </td>
                            <%
                                        Count++;
                                    } else {
                            %>
                            <td align=center>  <input Type=checkbox <%=str1%> id='<%=mName1%>' name='<%=mName1%>' value='Y' onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','<%=PROJECT%>')"></td>
                            <%
                                    ...
                                    if (mMaxCrLmtTkn <= mMaxCrLmt) {
                                        ...
                                        //current core
%>
                            <td align=center> <input Type=checkbox <%=str1%> id='<%=mName1%>' name='<%=mName1%>' value='Y'  onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','<%=PROJECT%>')">
                            </td>
                            <%
                                                            Count++;
                                                        } else {
...
String mPDElecCode1="";
        ...
        while (rsc.next()) {
          ...
          //  mTot = 3;
                        ...
                        %><INPUT TYPE="hidden" NAME="pd" value="<%=rsc.getInt("cnt")%>"><%
                                            ...
                                            while (rs1.next()) {
                                                ...
                                                if (rse.next()) {
                                                    ...
                                                    pdvalue = "Y";
                                                         ...
                                                         if(!mPDElecCode1.equals(rsc.getString("ELECTIVECODE")))
				   {
					mPDElecCode1=rsc.getString("ELECTIVECODE");
                   // out.print(mElecCode1+"<BR>");
                       ...
                       mMaxCrLmtAld = mMaxCrLmtAld + mCourseCrPt;
                        ...
                        <tr bgcolor="<%=mColor%>">
                            ...
                            <td nowrap align="center">
                              ...
                              <input type="hidden" name='tempPD<%=++i%>' value="<%=value%>" size=1 id="tempPD<%=i%>">
      ...
      // out.print(mMaxCrLmtAld+"- PD --");
        ...
        i = 1;
        //---------new added ----------------------
        String ELECT = "", mElecCode1="";
        int mTCount = 0, kk = 0,SumFlag=0;

    

        //out.println(electivecount);


				qry="Select distinct Semester, SEMESTERTYPE, SUBJECTTYPE, SUBJECTID, SUBJECT Subj, COURSECREDITPOINT COURSECREDITPOINT, nvl(BASKET,' ')BASKET,ELECTIVECODE";
				qry=qry+" from (";
				/*qry=qry+" (select distinct A.semester Semester, 'REG' SEMESTERTYPE, 'C' SUBJECTTYPE, A.SUBJECTID SUBJECTID, B.Subject||' ('||B.SubjectCode||')' SUBJECT, A.COURSECREDITPOINT COURSECREDITPOINT, nvl(A.BASKET,'A')BASKET from PROGRAMSCHEME A,SUBJECTMASTER B";
				qry=qry+" where A.institutecode='"+mInst +"' and A.Academicyear='"+mAcad+"' and A.programcode='"+mProg+"' and A.TAGGINGFOR='"+mTag+"' AND A.SECTIONBRANCH='"+mySect+"' ";
				qry=qry+" and A.semester="+mSem+" AND A.BASKET='A' AND A.institutecode=B.institutecode and A.subjectID=B.subjectID )";
				qry=qry+" union ";*/
				qry=qry+" (select distinct A.semester Semester, 'REG' SEMESTERTYPE, 'E' SUBJECTTYPE, A.SUBJECTID SUBJECTID, B.Subject||' ('||B.SubjectCode||')'||'***'||nvl(A.ELECTIVECODE,' ') SUBJECT, A.COURSECREDITPOINT COURSECREDITPOINT, nvl(A.BASKET,'D')BASKET ,A.ELECTIVECODE from PR#ELECTIVESUBJECTS A,SUBJECTMASTER B";
				qry=qry+" where   A.institutecode='"+mInst+"' and A.Academicyear='"+mAcad+"' and A.programcode='"+mProg+"' and A.TAGGINGFOR='"+mTag+"' AND A.SECTIONBRANCH='"+mySect+"' ";
				//improvement subject not in
				qry=qry+" and (a.subjectid) not IN (                                    SELECT DISTINCT subjectid                                               FROM studentresult                                              WHERE institutecode ='"+mInst +"'                                                AND studentid ='"+mChkMemID+"' )";
				qry=qry+" and A.semester="+mSem+" AND A.BASKET in ('D','E') AND A.institutecode=B.institutecode and A.subjectID=B.subjectID)";
				qry=qry+" ) order by ELECTIVECODE, Subject";
...
/*getting draft values*/
qry1=" select ELECTIVECODE, count(*)aa from PR#ELECTIVESUBJECTS A,SUBJECTMASTER B where A.institutecode='"+mInst+"' and A.Academicyear='"+mAcad+"' and A.programcode='"+mProg+"' and A.TAGGINGFOR='"+mTag+"' AND A.SECTIONBRANCH='"+mySect+"'  and A.semester="+mSem+" AND A.BASKET in ('D','E')   and a.ELECTIVECODE='"+rs.getString("ELECTIVECODE")+"'  AND A.institutecode=B.institutecode and A.subjectID=B.subjectID group by ELECTIVECODE order by   ELECTIVECODE";
       		//out.println(qry1);
				ResultSet rsco=db.getRowset(qry1);
				if(rsco.next())
				{
					kk++;
					electivecount=rsco.getInt("aa");
					ELECT=rsco.getString("ELECTIVECODE");
				}
		/*	}
			else
			{
...
*/
	...
	if (!ELECT.equals(OldmELECTIVECODE1))
						{
							%>
					<INPUT TYPE="hidden" NAME="electivecount" id="electivecount" value='<%=electivecount%>'>
					<INPUT TYPE="hidden" NAME="mSno1" id="mSno1" value='<%=mSno%>'>
					<%
							OldmELECTIVECODE1=ELECT;


if(rs.getString("ELECTIVECODE").equals("DE4"))
					{
						 snocount=1;
					 tcount=0;
//out.print(snocount+"-- snocount -- "+i);
					}
					else if(rs.getString("ELECTIVECODE").equals("DE5"))
					{
						 snocount=i;
						 	 tcount=electivecount;
//out.print(snocount+"-- snocount -- "+i);
					}
					else if(rs.getString("ELECTIVECODE").equals("DE6"))
					{
						 snocount=i;
						 	 tcount=electivecount;
//out.print(snocount+"-- snocount -- "+i);
					...
					else
					{
						...
						if(rse12.next())
						{
							//out.println(mSubjType+"INNNN   "+mSubjId);
							if(mSubjType.equals("C"))
							{
...
//							out.print(electivecount+"electivecount"+choise);
					...
					if(rs.getString("ELECTIVECODE").equals("DE4"))
					{
						mSubjTypeDesc="DEPARTMENTAL ELECTIVE - ";
					...
					if(mSubjType.equals("C"))
					{
						...
						if(!mFlagstr1.equals("1"))
						{
							...
							if(mMaxCrLmtTkn<=mMaxCrLmt )
							{
								...
								<input Type=checkbox id='<%=mName1%>' name='<%=mName1%>' value='Y' checked onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>')">
							...
							else
							{
								...
								<input Type=checkbox <%=str1%> id='<%=mName1%>' name='<%=mName1%>' value='Y' onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>')">
  ...
  <select name='<%=mName10%>' id='Select<%=i%>' 							onChange="Clickedsel('<%=mSno%>','<%=mCourseCrPt%>','Select<%=i%>','<%=mBasket%>','<%=electivecount%>','<%=mElecCode%>','<%=snocount%>' )"	style="Width:40">
								<%
...
//System.out.print(choise+"--JJJ--"+m);
										if(choise.equals(String.valueOf(m)))
										{
											...
											st1="";
										//System.out.print(mochoice+"-g-"+m+"-h-"+st1);
											%>
											<option <%=st1%>  Value="<%=m%>"><%=m%></option>
											<%
									}
        ...
        qry1 = qry1 + " from ";
        qry1 = qry1 + " ( SELECT DISTINCT A.semester semester, 'REG' semestertype,  'C' subjecttype, a.subjectid subjectid,         " +
                "                        B.Subject||' ('||B.SubjectCode||')' SUBJECT ,                       " +
                "          a.coursecreditpoint coursecreditpoint,                                 NVL (a.basket, 'A') basket  " +
                "   FROM programscheme a, subjectmaster b,studentresult c,studentmaster d                  " +
                "         WHERE (B.subject NOT LIKE '%PROJECT%'            OR B.subject LIKE '%PROJECT MANAGEMENT%') AND " +
                " a.institutecode = '" + mInst + "'   and a.BASKET='A'  and a.SUBJECTID=c.SUBJECTID and d.studentid=c.studentid" +
                "  AND d.institutecode = c.institutecode                       " +
                "       AND a.institutecode = c.institutecode and b.SUBJECTID=c.SUBJECTID    " +
                "         and                  A.institutecode='" + mInst + "' and A.Academicyear='" + mAcad + "' " +
                "and A.programcode='" + mProg + "' and A.TAGGINGFOR='" + mTag + "' AND A.SECTIONBRANCH='" + mySect + "'     " +
                "                        AND a.institutecode = b.institutecode                      " +
                "       AND a.subjectid = b.subjectid  and (a.SUBJECTID,d.studentid) " +
                "in (select distinct e.subjectid,e.studentid from studentresult e where e.INSTITUTECODE = '" + mInst + "'  and     " +
                "                          e.STUDENTID= '" + mChkMemID + "'  and e.grade NOT IN ('A', 'A+', 'B+','F','X')    " +
                "  AND exists (select 'y'                                                      " +
                "       FROM studentsgpacgpa x                                                          " +
                "   WHERE x.institutecode = '" + mInst + "'                                                        " +
                "      AND  x.cgpa <  " + mMinsem + "                                                       " +
                "      and  x.studentid= e.studentid                                                         " +
                "     and x.semester = " + mMaxsem + "                                                   " +
                "         and ( (x.semester = a.semester)                                                                     or                                                                     (e.subjectid in(select o.subjectid                                                                                      from offersubjecttagging o                                                                                      where o.institutecode ='" + mInst + "'                                                                                     and   o.examcode = '" + mExam + "'                                                                                      and   o.subjectid = e.subjectid                                                   )                                                                     )                                                                    )                                                                            ))) ";
        ...
        while (rs.next()) {
            ...
            qry2 = "select FEEAMOUNT from PR#LTPWiseFee a where a.INSTITUTECODE='" + mInst + "'  " +
                    " AND A.EXAMCODE='" + mExam + "' AND A.MAXCOURSECREDITPOINT=" + rs.getString("coursecreditpoint") + "";
            //System.out.print(" AAA "+qry2 );
                            ...
                            if (mSubjType.equals("C")) {
                                ...
                                if (!mFlagstr1.equals("1")) {
                                    ...
                                    if (mMaxCrLmtTkn <= mMaxCrLmt) {
                                        ...
                                        //current core
%>
                            <td align=center> <input Type=checkbox id='<%=mName1%>' name='<%=mName1%>' value='Y'  onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','N')">
                            </td>
                            <%
                                        Count++;
                                    } else {
...
%>
                            <td align=center> <input Type=checkbox <%=str1%> id='<%=mName1%>' name='<%=mName1%>' value='Y' onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','N')" ></td>
                            <%
                            ...
                            %>
                            <td align=center><input Type=checkbox <%=str1%> id='<%=mName1%>' name='<%=mName1%>' value='Y' onclick="FunRefresh('<%=mCourseCrPt%>', '<%=mSno%>','<%=mBasket%>','<%=mName1%>','N')" >
                            </td>
                            <%
                                                            Count++;
                                                        } else {
...
%>
        ...
        while (rs1.next()) {
            ...
            qry2 = "select FEEAMOUNT from PR#LTPWiseFee a " +
                    "where a.INSTITUTECODE='" + mInst + "'   AND A.EXAMCODE='" + mExam + "' AND A.MAXCOURSECREDITPOINT=" + rs1.getString("coursecreditpoint") + "";
            //out.print(qry2);
