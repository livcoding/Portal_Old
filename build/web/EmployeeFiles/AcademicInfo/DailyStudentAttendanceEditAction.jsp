...
<td><font color="White"><b>Enrollment No.</b></td>
<td><font color="White"><b>Student Name</b></td>	
			...
			{  //4
			  ...
			  // qry=qry+" and CLASSTIMEUPTO=To_date('"+mTupto+"','dd-MM-yyyy HH24:MI') ";
			   ...
			   {	
				...
				{
					qry1="UPDATE STUDENTATTENDANCE SET PRESENT='Y', ENRTYDATE=SYSDATE WHERE FSTID='"+mFstid+"' AND STUDENTID='"+mStudentID+"' AND to_char(ATTENDANCEDATE,'dd-mm-yyyy')='"+Date+"' AND CLASSTIMEFROM=to_date('"+mTfrom+"','dd-mm-yyyy HH24:MI')";
					n=db.update(qry1);
				...
				{
					qry1="UPDATE STUDENTATTENDANCE SET PRESENT='N', ENRTYDATE=SYSDATE WHERE FSTID='"+mFstid+"' AND STUDENTID='"+mStudentID+"' AND to_char(ATTENDANCEDATE,'dd-mm-yyyy')='"+Date+"' AND CLASSTIMEFROM=to_date('"+mTfrom+"','dd-mm-yyyy HH24:MI')";
					//out.print(qry1);
					n=db.update(qry1);
					qry="Select WEBKIOSK.getMemberName('"+mStudentID+"','S') SL from dual" ;
					RsChk1= db.getRowset(qry);
				...
				//out.print(qry1);
                               ...
                               out.print("Mark Attendance First!!");
                           }

/*******************************************************************Commented Start() by Satendra********************************************************/
        /*
			   else
			   {

                           out.print("Please Marck Attendance First!!");
