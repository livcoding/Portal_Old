					...
					<tr>
						...
						<%
							if(request.getParameter("subjectid")==null)
								...
								mSubjectid2=request.getParameter("subjectid2");
							qry="SELECT DISTINCT b.subjectid subjectid,b.subject || ' (' || b.subjectcode || ')' subject FROM   subjectmaster b WHERE  NVL (b.deactive, 'N') = 'N' AND b.subjectid = '"+mSubjectid2+"' and b.InstituteCode='"+mInst+"'";
							rs=db.getRowset(qry);
							//out.println(qry);
						%>
							<select name="subjects" tabindex="0" id="subjects" style="WIDTH: 480px">
