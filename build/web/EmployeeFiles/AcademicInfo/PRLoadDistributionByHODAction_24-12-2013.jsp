...
try
{
	...
	qry+=" A.EMPLOYEETYPE facultytype,WebKiosk.getAssignedTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"')assignedload, ";
	qry+=" WebKiosk.getAssignedTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"','"+QrySubjID+"','"+mBasket+"','"+mLTP+"')assignedload11 , ";
	qry+=" WebKiosk.getMinTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"') minload,WebKiosk.getMaxTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE ,'"+QryExam+"')maxload  from V#STAFF A where A.departmentcode='"+QryDept+"' and a.COMPANYCODE='"+mComp+"' and nvl(A.deactive,'N')='N'";
/*
	qry+=" minus ";
...
//=============================================
	if(mType.equals("C"))
	{
		...
		qry+=" a.semester, a.semestertype,(SELECT COUNT (*) FROM programsubsectiontagging cc  ";
...
//out.println(mNameLMR);
		...
		qry+=" A.EMPLOYEETYPE facultytype,WebKiosk.getAssignedTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"')assignedload, ";
		qry+=" WebKiosk.getAssignedTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"','"+QrySubjID+"','"+mBasket+"','"+mLTP+"')assignedload11 , ";
		qry+=" WebKiosk.getMinTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"') minload,WebKiosk.getMaxTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE ,'"+QryExam+"')maxload  from V#STAFF A where A.departmentcode='"+QryDept+"' and nvl(A.deactive,'N')='N' and A.COMPANYCODE='"+mComp+"'";
/*
		qry+=" minus ";
		qry+=" select A.facultyid facultyid,B.Employeename employeename,B.COMPANYCODE companycode,";
		qry+=" A.FACULTYTYPE facultytype,WebKiosk.getAssignedTeachLoad(B.COMPANYCODE,'"+mInst+"',A.facultyid,A.FACULTYTYPE,'"+QryExam+"')assignedload, ";
...
//out.print("OLD - "+mOldEmp);
		...
		if (request.getParameter("xx")==null) 
		{
			...
			while(rs.next())
			{
				...
				qry1+=" WebKiosk.getAssignedTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"')assignedload, ";
				qry1+=" WebKiosk.getAssignedTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"','"+QrySubjID+"','"+mBasket+"','"+mLTP+"')assignedload11 , ";
				qry1+=" WebKiosk.getMinTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE,'"+QryExam+"') minload,WebKiosk.getMaxTeachLoad(A.COMPANYCODE,'"+mInst+"',A.Employeeid ,A.EMPLOYEETYPE ,'"+QryExam+"')maxload  from V#STAFF A where A.departmentcode='"+QryDept+"' and nvl(A.deactive,'N')='N' and A.COMPANYCODE='"+mComp+"'";
...
//------------------
				...
				else
				{
					if(mOldEmp.equals(mEmpIdv))
					{
						try
						{
							qry="Select A.COMPANYCODE CC, A.FACULTYTYPE FT, A.EMPLOYEEID EID, A.NOFHRS HR, B.ENTRYDATE DT, A.FACULTYSET FS, A.CLASSINAWEEK CPW, A.SET1 S1, A.SET2 S2, A.SET3 S3, B.ACADEMICYEAR AYR, B.PROGRAMCODE PC";
