...
<%
        ...
        ResultSet rs1 = null;
        ResultSet rs2 = null;
        ResultSet rsAtt = null, rsRowNum = null, RsChk1 = null, rsdt = null,rsyyyy=null;
...
<%
		...
		int j=0;
                            ...
                            qry = qry + " NVL(A.SECTIONBRANCH,' ')sectionbranch, nvl(B.SEMESTER,1) SEMESTER, To_Char(b.REGCONFIRMATIONDATE,'DD-MM-YYyy') REGCONFIRMATIONDATE ,nvl(b.SPECIALAPPROVAL,'N')SPECIALAPPROVAL ,";
...
%>
                ...
                <tbody>
                    <%
                            ...
                            qry = "select distinct  DECODE (a.enrollmentno,NULL,A.RANKNO,A.ENROLLMENTNO )enrollmentno,nvl(A.studentname,' ')studentname, NVL(A.studentid,' ')studentid,";
                            qry = qry + " NVL(A.SECTIONBRANCH,' ') sectionbranch, nvl(B.SEMESTER,1) SEMESTER, To_Char(b.REGCONFIRMATIONDATE,'DD-MM-YYyy') REGCONFIRMATIONDATE ,nvl(to_char(REGCONFIRMATIONDATE,'yyyymmdd'),' ') REGCONFIRMATIONDATE1,nvl(b.SPECIALAPPROVAL,'N')SPECIALAPPROVAL ,";
                         qry = qry + " A.SECTIONBRANCH SECBR,  NVL(a.SEMESTERTYPE,' ')SEMESTERTYPE ";
                         qry = qry + ",  A.AcademicYear AcademicYear,A.ProgramCode ProgramCode from V#STUDENTLTPDETAIL A,STUDENTREGISTRATION B ";
                            qry = qry + " Where NVL(a.studentdeactive,'N')='N' AND NVL(a.deactive,'N')='N' ";
                            qry = qry + " AND B.INSTITUTECODE=A.INSTITUTECODE";
                            qry = qry + " AND B.EXAMCODE=A.EXAMCODE";
                             qry = qry + " AND b.EXAMCODE='"+mExam +"'";
