...
ResultSet Rs =null;
String mMemberID="", mMemberType="", mRole="",mIPAddress="", mDeptCode="";
...
if(!mMemberID.equals("") || !mMemberType.equals(""))
{
  ...
  //----------------------
		...
		<TR><TD nowrap align=center><FONT color=black size=3><STRONG>Available options</STRONG></FONT>
...
//--------------------------
 ...
 <span class="submenu" id="sub3">
   ...
   <span class="submenu" id="sub5">
	...
	{
		%>
		<img src="../Images/bullet4.gif">&nbsp;<A href="../EmployeeFiles/AcademicInfo/DailyStudentAttendanceEntry.jsp" title="Student Attendance Entry-for the current working Days/class only"  target="DetailSection"><FONT face="Arial" size =2 color=white>Attendance Entry</FONT></A></br>
	...
	{
		%>
		<img src="../Images/bullet4.gif">&nbsp;<A href="../EmployeeFiles/AcademicInfo/ViewAttendanceSummary.jsp?SrcType=I" title="Subject wise Student percentage(%) Attendance" target="DetailSection"><FONT face="Arial" size =2 color=white>Attendance Summary</FONT></A></br>
	...
	{
	%>
		<img src="../Images/bullet4.gif">&nbsp;<A href="../EmployeeFiles/AcademicInfo/ViewAttendanceSummary.jsp?SrcType=H" title="Subject wise Student percentage(%) Attendance" target="DetailSection"><FONT face="Arial" size =2 color=white>Attendance Summary</FONT></A></br>
	...
	{
	%>
		<img src="../Images/bullet4.gif">&nbsp;<A title="Faculty Subject Choices Entry/Request" href="../EmployeeFiles/AcademicInfo/EmpSubjectChoiceEntry.jsp" title="Subject Choice entry for the comming batch" target="DetailSection"><FONT face="Arial" size =2 color=white>Subj. Preference</FONT></A></br>
	<%
	}
	...
	<img src="../Images/bullet4.gif">&nbsp;<A title="Pre Registration - HOD Load Distribution (Advance)" href="AcademicInfo/PreRegLoadDistributionByHOD.jsp" target=DetailSection><FONT face="Arial" size =2 color=Yellow>Adv. Load Distribution</FONT></A></br>	
	<img src="../Images/bullet4.gif">&nbsp;<A title="Pre Registration - HOD Load Distribution Before Load Assign" href="AcademicInfo/oldSubject_newSubject.jsp" target=DetailSection><FONT face="Arial" size =2 color=white>Merge Subjects</FONT></A></br>
	<%
	}
  ...
  // Closing of Date seet date checking
	...
	*/
	...
	//out.print(qry);
		...
		{
			%>
			<img src="../Images/bullet4.gif">&nbsp;<a  target="DetailSection" title="Emial to Students in  bulk" href="AdminOptions\LotusEmail\MailLogin.jsp"><FONT face="Arial" color =white size=2>Mass Mailing</font></a><br>
...
qry="Select WEBKIOSK.ShowLink('229','"+ mMemberID +"','E','"+mRole+"','"+mIPAddress+"') SL from dual";
	//out.print(qry);
		...
		if (Rs.next() && Rs.getString("SL").equals("Y"))
		{
			...
			<img src="../Images/bullet4.gif">&nbsp;<a  target="DetailSection" title="Report of Bulk Mail " href="AdminOptions\LotusEmail\SentEmail.jsp?SRCType=A"><FONT face="Arial" color =white size=2>Sent Mail</font></a><br>
			<%
		}
qry="Select WEBKIOSK.ShowLink('230','"+ mMemberID +"','E','"+mRole+"','"+mIPAddress+"') SL from dual";
	//out.print(qry);
		Rs = db.getRowset(qry);
		if (Rs.next() && Rs.getString("SL").equals("Y"))
		{
			...
			<img src="../Images/bullet4.gif">&nbsp;<a  target="DetailSection" title="Report of Bulk Mail " href="AdminOptions\LotusEmail\SentEmail.jsp?SRCType=H"><FONT face="Arial" color =white size=2>Sent Mail</font></a><br>
			<%
		}
