...
nitobi.spotlight.Spotlight=function(_82,_83,_84,_85){
if(_84==null){
this.useLens=false;
}else{
this.useLens=false;
...
if(_83!=null){
this.stylesheet=_83.toLowerCase();
}
...
if(_82!=null){
this.effectMode=_82.toUpperCase();
}
this.lastID="";
this.Containers=Array();
...
this.opera=false;
this.useMouse=false;
var _87=nitobi.html.Css.getRule("ntbSpot");
this.StyleSheetUrl=nitobi.html.Css.getPath(_87.parentStyleSheet);
var _88=navigator.userAgent.toLowerCase();
if(_88.indexOf("opera")!=-1){
this.opera=true;
}
if(_88.indexOf("firefox")!=-1){
this.firefox=true;
}
if(_88.indexOf("msie")!=-1){
this.ie=true;
}
if(_88.indexOf("msie 7.0")!=-1){
this.ie7=true;
}
...
var _94=mS.scrollTop;
var _95=mS.scrollLeft;
if(y1<mS.scrollTop){
var _94=y1-(mS.clientHeight/4.5);
}
if(x1<mS.scrollLeft){
var _95=x1-(mS.clientWidth/4.5);
}
if(y2>(mS.scrollTop+mS.clientHeight)){
var _94=y2-mS.clientHeight+(mS.clientHeight/4.5);
}
if(x2>(mS.scrollLeft+mS.clientWidth)){
var _95=x2-mS.clientWidth+(mS.clientWidth/4.5);
}
if(_94<0){
_94=0;
}
...
if(_94>(mS.bodyHeight-mS.clientHeight)){
_94=(mS.bodyHeight-mS.clientHeight+10);
}
if(_95>(this.oS.bodyWidth-this.oS.clientWidth)){
_95=(this.oS.bodyWidth-this.oS.clientWidth);
}
this.targetScrollX=_95;
this.targetScrollY=_94;
if(!this.inScroll){
...
_99=(Math.abs(this.targetScrollX-this.startingScrollX)/20)*0.8;
_9a=(Math.abs(this.targetScrollY-this.startingScrollY)/20)*0.8;
_9b=(this.scrollX-this.startingScrollX)/(this.targetScrollX-this.startingScrollX+0.0001);
_9c=(this.scrollY-this.startingScrollY)/(this.targetScrollY-this.startingScrollY+0.0001);
_96=(this.easeInEaseOut(_99,1,_9b)*_96);
_97=(this.easeInEaseOut(_9a,1,_9c)*_97);
this.scrollX+=_96;
this.scrollY+=_97;
if(this.scrollY<0){
this.scrollY=0;
...
nitobi.spotlight.Spotlight.prototype.setMouseIcon=function(_9d){
this.MouseIcon.className=_9d;
if((this.ie)&&(!this.ie7)){
this.MouseIcon.style.backgroundImage="none";
this.MouseIcon.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+this.StyleSheetUrl+nitobi.callout.Callout.readClassAttribute(_9d,"backgroundImage")+"', sizingMethod='crop');";
}else{
this.MouseIcon.style.filter="";
}
this.Mouse_offX=nitobi.callout.Callout.readClassAttribute(_9d+"_offset","left");
this.Mouse_offY=nitobi.callout.Callout.readClassAttribute(_9d+"_offset","top");
this.MouseIcon.style.left=(this.MouseX+this.Mouse_offX)+"px";
this.MouseIcon.style.top=(this.MouseY+this.Mouse_offY)+"px";
};
nitobi.spotlight.Spotlight.prototype.setEffect=function(_9e){
this.effectMode=_9e.toUpperCase();
};
...
nitobi.spotlight.Spotlight.prototype.lensMagnify=function(_a0){
var _a1;
_a1=_a0;
if(this.useLens){
_a1.x-=parseInt(_a0.w*this.lensOversize);
_a1.y-=parseInt(_a0.h*this.lensOversize);
_a1.w+=parseInt(_a0.w*(this.lensOversize*2));
_a1.h+=parseInt(_a0.h*(this.lensOversize*2));
}
return _a1;
};
nitobi.spotlight.Spotlight.prototype.setEffect=function(_a2){
var _a3=false;
if(_a2==null){
_a3=true;
var mc=nitobi.callout.Callout.getCoords($(_a2));
_a2="NTB_tempDiv"+this.uid;
var me=nitobi.html.createElement("div",{"id":_a2},{"position":"absolute","top":mc.y+"px","left":mc.x+"px","width":"0px","height":"0px"});
document.getElementsByTagName("body").item(0).appendChild(me);
}
if(_a2.indexOf(":")>0){
_a2=document.forms[_a2.split(":")[0]][[_a2.split(":")[1]]];
}
...
this.lastID=_a2;
if(this.opera){
_a7=nitobi.callout.Callout.getCoordsAlt($(_a2));
}else{
_a7=nitobi.callout.Callout.getCoords($(_a2));
}
_a7=this.lensMagnify(_a7);
this.coords=_a7;
this.ContainerCoords[0][0]=0;
this.ContainerCoords[0][1]=0;
this.ContainerCoords[0][2]=sP.bodyWidth;
this.ContainerCoords[0][3]=_a7.y;
this.ContainerCoords[1][0]=0;
this.ContainerCoords[1][1]=_a7.y;
this.ContainerCoords[1][2]=_a7.x;
this.ContainerCoords[1][3]=_a7.h;
this.ContainerCoords[2][0]=_a7.x+_a7.w;
this.ContainerCoords[2][1]=_a7.y;
this.ContainerCoords[2][2]=sP.bodyWidth-(_a7.x+_a7.w);
this.ContainerCoords[2][3]=_a7.h;
this.ContainerCoords[3][0]=0;
this.ContainerCoords[3][1]=_a7.y+_a7.h;
this.ContainerCoords[3][2]=sP.bodyWidth;
this.ContainerCoords[3][3]=sP.bodyHeight-(_a7.y+_a7.h);
}else{
_a7=this.coords;
}
for(var t=0;t<4;t++){
...
this.drawLens();
if(_a3){
document.getElementsByTagName("body").item(0).removeChild($(_a2));
}
};
nitobi.spotlight.Spotlight.prototype.swipeIn=function(){
var fd=this;
if(this.swipePos<this.swipeEnd-3){
var _aa=this.swipePos-this.swipeStart;
var _ab=this.swipeEnd-this.swipeStart;
this.swipePos+=((_aa/_ab)*700)+2;
...
var _b3=this.stepArray[d][0].id;
}
if(this.ie){
var _b3=this.stepArray[d][0].name;
}
_b1=d;
break;
}
...
nitobi.spotlight.Spotlight.prototype.endEffect=function(_b6){
var _b7=0;
...
nitobi.spotlight.Spotlight.prototype.runFormHelper=function(_b9){
var ff=this;
var _bb=true;
...
if(_bb){
if(typeof (_b9[0])=="string"){
_b9[0]=document.forms[_b9[0].split(":")[0]][[_b9[0].split(":")[1]]];
}
if(_b9[4]=="TYPETEXT"){
...
this.textIterator++;
if(this.textIterator<_b9[2].length+1){
_b9[0].value=_b9[2].substring(0,this.textIterator);
if(_b9[0].onkeydown!=null){
_b9[0].onkeydown.call();
}
if(_b9[0].onkeyup!=null){
_b9[0].onkeyup.call();
}
if(_b9[0].onkeypress!=null){
_b9[0].onkeypress.call();
}
var _bc=80;
if(Math.round((Math.random()*9)+1)>7){
_bc=Math.round((Math.random()*250)+1);
}
setTimeout(function(){
ff.runFormHelper(_b9);
},_bc);
}else{
_b9[0].blur();
setTimeout(function(){
...
nitobi.spotlight.Spotlight.prototype.easeInEaseOut=function(_bd,_be,_bf){
var _c0=0.5;
if(_bf>0.7){
_c0=(_bf-0.4)/0.6;
}
...
var _c1=(Math.sin((parseFloat(_c0)*180)*(3.141592/180)))*_bd;
if(_c1<_be){
_c1=_be;
}
return _c1;
};
nitobi.spotlight.Spotlight.prototype.moveMouseXY=function(_c2,_c3){
this.MouseTargetX=_c2;
this.MouseTargetY=_c3;
var fk=this;
clearTimeout(this.mouseTimerObj);
var _c5=(_c2-this.MouseOrigX);
var _c6=(_c3-this.MouseOrigY);
var _c7=(_c2-this.MouseX)+1e-10;
var _c8=(_c3-this.MouseY);
var _c9=Math.round(Math.sqrt((_c5*_c5)+(_c6*_c6)))+0.001;
var _ca=Math.round(Math.sqrt((_c7*_c7)+(_c8*_c8)));
var _cb=((_c9-_ca)/_c9);
if((Math.abs(_c2-this.MouseX)>3)||(Math.abs(_c3-this.MouseY)>3)){
var _cc=_c8/_c7;
var _cd=this.easeInEaseOut((_c9/80)*5.5,0,_cb)+1;
var _ce=0;
var _cf=0;
if(_cc<=0){
if(_c2>=this.MouseX){
...
this.MouseX+=_ce*_cd;
this.MouseY+=_cf*_cd;
var _d4=Math.sin((_cb+0.01)*3.1415927)*(this.MouseDistance/100)*13;
var _d5=nitobi.lang.Math.rotateCoords(0,-_d4,this.MouseAngle);
this.MouseIcon.style.left=this.MouseX+this.Mouse_offX+_d5.x+"px";
this.MouseIcon.style.top=this.MouseY+this.Mouse_offY+_d5.y+"px";
...
try{
var _d6=$(this.stepArray[this.currentStep][0]);
}
catch(e){
}
}
...
try{
var _d6=$(this.stepArray[this.currentStep][0].call());
}
catch(e){
}
}
...
try{
_d6.onmouseover.call();
}
catch(e){
}
try{
_d6.onmousedown.call();
}
catch(e){
}
setTimeout(function(){
...
nitobi.spotlight.Spotlight.prototype.createFormHelperStep=function(_d7,_d8,_d9,_da,_db){
this.stepArray[this.stepArray.length]=Array(6);
this.stepArray[this.stepArray.length-1][0]=_d7;
if(_d9!=null){
this.stepArray[this.stepArray.length-1][1]=_d9;
}else{
this.stepArray[this.stepArray.length-1][1]=100;
}
this.stepArray[this.stepArray.length-1][2]=_da;
this.stepArray[this.stepArray.length-1][3]="EXECFORMHELPER";
this.stepArray[this.stepArray.length-1][4]=_d8.toUpperCase();
if(_db!=null){
this.stepArray[this.stepArray.length-1][5]=_db;
}else{
this.stepArray[this.stepArray.length-1][5]=true;
}
};
nitobi.spotlight.Spotlight.prototype.createMouseStep=function(_dc,_dd,_de){
this.stepArray[this.stepArray.length]=Array(6);
this.stepArray[this.stepArray.length-1][0]=_dd;
if(_de!=null){
this.stepArray[this.stepArray.length-1][1]=_de;
}else{
this.stepArray[this.stepArray.length-1][1]=100;
}
this.stepArray[this.stepArray.length-1][2]=_dc.toUpperCase();
this.stepArray[this.stepArray.length-1][3]="MOUSEACTION";
};
nitobi.spotlight.Spotlight.prototype.createCodeStep=function(_df,_e0){
this.stepArray[this.stepArray.length]=Array(6);
this.stepArray[this.stepArray.length-1][0]=_df;
if(_e0!=null){
this.stepArray[this.stepArray.length-1][1]=_e0;
}else{
this.stepArray[this.stepArray.length-1][1]=100;
}
this.stepArray[this.stepArray.length-1][3]="EXECCODE";
};
nitobi.spotlight.Spotlight.prototype.createCalloutStep=function(_e1,_e2,_e3){
this.stepArray[this.stepArray.length]=Array(6);
this.stepArray[this.stepArray.length-1][0]=_e1;
this.stepArray[this.stepArray.length-1][1]=_e2;
this.stepArray[this.stepArray.length-1][2]=_e3;
this.stepArray[this.stepArray.length-1][3]="OBJID";
};
nitobi.spotlight.Spotlight.prototype.createFocusStep=function(_e4,_e5){
this.stepArray[this.stepArray.length]=Array(6);
...
this.setMouseIcon("ntbMouse");
if(this.opera){
var _ea=nitobi.callout.Callout.getCoordsAlt($(this.stepArray[this.currentStep][0]));
}else{
var _ea=nitobi.callout.Callout.getCoords($(this.stepArray[this.currentStep][0]));
}
_ea=this.lensMagnify(_ea);
this.updateScroller(_ea.x,_ea.y,_ea.x+_ea.w,_ea.y+_ea.h);
if(this.useMouse){
this.waitForMouse=true;
this.mouseDone=false;
this.MouseOrigX=this.MouseX;
this.MouseOrigY=this.MouseY;
this.MouseAngle=nitobi.lang.Math.returnAngle(this.MouseX,this.MouseY,_ea.x+(_ea.w*0.8),_ea.y+(_ea.h/2));
this.MouseDistance=nitobi.lang.Math.returnDistance(this.MouseX,this.MouseY,_ea.x+(_ea.w*0.8),_ea.y+(_ea.h/2));
this.moveMouseXY(_ea.x+(_ea.w*0.8),_ea.y+(_ea.h/2));
}
...
_eb=this.stepArray[this.currentStep][0].id;
}
if(this.ie){
if(this.stepArray[this.currentStep][5]){
this.setEffect(this.stepArray[this.currentStep][0].name);
}
_eb=this.stepArray[this.currentStep][0].name;
}
if(this.opera){
var _ea=nitobi.callout.Callout.getCoordsAlt($(_eb));
}else{
var _ea=nitobi.callout.Callout.getCoords($(_eb));
}
_ea=this.lensMagnify(_ea);
this.updateScroller(_ea.x,_ea.y,_ea.x+_ea.w,_ea.y+_ea.h);
if(this.useMouse){
...
if(typeof (this.stepArray[this.currentStep][0])=="string"){
try{
var _ec=$(this.stepArray[this.currentStep][0]);
}
catch(e){
}
}
if(typeof (this.stepArray[this.currentStep][0])=="function"){
try{
var _ec=$(this.stepArray[this.currentStep][0].call());
}
catch(e){
}
}
if(this.opera){
var _ea=nitobi.callout.Callout.getCoordsAlt(_ec);
}else{
var _ea=nitobi.callout.Callout.getCoords(_ec);
}
this.MouseX=_ea.x+(_ea.w*0.8);
this.MouseY=_ea.y+(_ea.h/3);
this.MouseOrigX=this.MouseX;
this.MouseOrigY=this.MouseY;
...
this.MouseAngle=nitobi.lang.Math.returnAngle(this.MouseX,this.MouseY,_ea.x+(_ea.w*0.8),_ea.y+(_ea.h/2));
this.MouseDistance=nitobi.lang.Math.returnDistance(this.MouseX,this.MouseY,_ea.x+(_ea.w*0.8),_ea.y+(_ea.h/2));
this.moveMouseXY(_ea.x+(_ea.w*0.8),_ea.y+(_ea.h/3));
}
if((this.stepArray[this.currentStep][2]=="CLICKONOBJECT")||(this.stepArray[this.currentStep][2]=="CLICKONOBJECTCALCED")){
this.setMouseIcon("ntbMouse");
if(typeof (this.stepArray[this.currentStep][0])=="string"){
