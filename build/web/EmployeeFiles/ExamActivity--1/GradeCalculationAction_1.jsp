...
//out.print(mGlobalMean+"mGlobalMean");
//***********************************************
...
while(i11.hasNext() && i21.hasNext())
{
	...
	qry1="select distinct  GRADEPOINTS,GRADE,nvl(HIGHGRADECALCLIMIT,0)HIGHGRADECALCLIMIT,nvl(LOWGRADECALCLIMIT,0)LOWGRADECALCLIMIT from grademaster where institutecode='"+mInst+"' and examcode='"+mExamCode+"' and nvl(DEACTIVE,'N')='N' and  HIGHGRADECALCLIMIT is not null and nvl(HIDEINGRADESHEET,'N')='N' ";
...
//out.print(mGradeInitialCount+"mGradeInitialCount<br>");
