			...
			if(rsmm.next())
				    ...
				    mMaxMarks=mMaxmarks+"";
					  ...
					  <CENTER><FONT face=Arial size=2 color=navy><STRONG>Maximum Marks (Full Marks for Evaluation) : </STRONG><%=mMaxmarks%></FONT>
                            ...
                            <CENTER>
							<font size=2 color="RED" face=arial><B>'A' - for Absent &nbsp; &nbsp; 'M' - for Medical &nbsp; &nbsp; 'U' - for UFM &nbsp; &nbsp;'0' - for UFMarks &nbsp;&nbsp; 'D' - for Debar   &nbsp; &nbsp;Enter Marks between '0' to '<%=mMaxmarks%>'</B></font></td>
							</CENTER>
...
myMasterGrid.getCellObject(myRow,3).readOnly(true);
		...
		if(value!='' && value!='A' && value!='D' && value!='M' && value!='U'  ){
...
myMasterGrid.getCellObject(myRow,3).setValue(value);
   ...
   if(value=='A'  || value=='D' || value=='M' || value=='U'  )
    {
myMasterGrid.getCellObject(myRow,3).readOnly(true);
    }
