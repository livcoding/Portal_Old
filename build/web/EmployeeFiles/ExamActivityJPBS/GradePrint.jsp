...
if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals("")) 
   ...
   qry="Select WEBKIOSK.ShowLink('146','"+ mChkMemID+"','"+mChkMType+"','"+mRole+"','"+ mIPAddress +"') SL from dual";
	...
	<tr><TD colspan=0 align=middle><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana"><b>View saved Grades</b></TD>
	</font></td></tr>
	</TABLE>
...
%><TR bgcolor=white>
<TD><B><%=++count%>.</B></TD>
<TD></b><A target=_child HREF="GradePrintAction.jsp?ExamCode=<%=mEC%>&ETOD=<%=mETOD%>&Subject=<%=mSC%>&bno=<%=rssss.getString("BREAK#SLNO")%>">Batch - <%=count%> </A></b></TD>
