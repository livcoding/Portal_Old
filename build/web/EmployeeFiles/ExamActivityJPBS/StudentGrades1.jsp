...
else
{
  ...
  if(!mMemberID.equals("") && !mMemberCode.equals("") && !mMemberName.equals("")) 
	...
	ResultSet RsChk=null , rsCal=null,rscase=null;
  //-----------------------------
...
if (RsChk.next() && RsChk.getString("SL").equals("Y"))
 {
	...
	String mSc="";
	String mSem1="";
	String mFFFCount="",mIIICount="" ;

	ResultSet rs1=null,rs=null,rssub=null,rsttt=null,rsdd=null;
%>
...
if(request.getParameter("FFFCount")==null)
		mFFFCount="";
	else
		mFFFCount=request.getParameter("FFFCount").toString().trim();
	if(request.getParameter("IIICount")==null)
		mIIICount="";
	else
		mIIICount=request.getParameter("IIICount").toString().trim();
...
<tr><td align=left >F</td > <td ><%=mFFFCount%></td>   </tr>
<tr><td align=left >I</td >  <td><%=mIIICount%></td> </tr>
 </table>
<br>
<TABLE bgcolor=#fce9c5 class="sort-table"  width=76% ALIGN=CENTER rules=COLUMNS CELLSPACING=0 BORDER=1> 
<tr bgcolor="#ff8c00">		
...
<td  valign=top >
	...
	<tr  bgcolor="#ff8c00">
		<td rowspan=2 Title="Sort on SlNo">
				<Font color=white><b>Sl. <BR> No.</b><BR>&nbsp;</font> </font>
		</td>
	</tr>
	</thead>
		<tbody>
...
while (x < mTotalStudents+1) 
{
 ...
 %>
	...
	<td align=left ><b><font color=white >Student Name&nbsp;&nbsp;&nbsp;Sym.</font></b></td>
	<%
 		...
 		while(it.hasNext())	
		   {
			   ...
			   {
			qry1=" select distinct NVL(A.GRADE,'N')GRADE from DEBARSTUDENTDETAIL a  WHERE a.EXAMCODE='"+mExamCode+"' and a.fstid = '"+mfst+"'  and a.INSTITUTECODE='"+mInst+"' and a.STUDENTID='"+mStudidInit+"' AND A.SUBJECTID='"+mSubjectCode+"' and nvl(a.DEACTIVE,'N')='N' AND (NVL(A.MEDICALCASE,'Y')='Y'  OR NVL (A.medicalwithdrawal, 'Y') = 'Y' OR  NVL(A.ABSENTCASE,'N')='N' OR NVL(A.UFM,'N')='N' ) AND NVL(A.PRORATA,'N')='N' AND A.GRADE IS NOT NULL ";
						//	out.print(qry);
...
if(rsiimr.next()  &&( mGradInit.equals("A+") || mGradInit.equals("A"))){
	mGradInit="B+";
