...
<HTML>
<head>
<TITLE>#### <%=mHead%> [ Employee Leave History ] </TITLE>
...
try
{
  ...
  //----------------------
	...
	if(rs.next())
	{
		...
		%> 
		<CENTER>
		<STRONG><font color="#a52a2a" style="FONT-SIZE: medium; FONT-FAMILY: verdana"><b><u><FONT SIZE=4>Employee Leave History</FONT></u></b></font></STRONG>
		<br><br>
		...
		qry=qry+" and Employeeid='"+mChkMemID+"' and LEAVECODE='"+mLeaveCode+"'";
