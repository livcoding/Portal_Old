...
//out.print("HELLO");
            ...
            if((mIngtime > mPInTime)&&(!mWAIVER.equals("Y"))){
			%>
            <td align=center><font color=brown size=2><b>Half Day Penalty</b></font></td>
            <%}else{%>
			<td align=center><font color=black size=2><b>----</b></font></td>
            <%}%>
			<%
