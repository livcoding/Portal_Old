...
ResultSet rs=null,Ern=null,Ded=null,Ded1=null;
...
sql = " Select nvl(A.EDID,'UNK') EDID, nvl(B.EDDESCRIPTION,' ') EDDES, nvl(to_char(A.EDAmount),'0')EDAmount , nvl(to_char(A.ArrearAmount),'0') ArrearAmount,to_char(B.SEQID) SEQID from PayableSalary A, EDMaster B where A.COMPANYcODE= B.COMPANYcODE And A.EDID= B.EDID And A.CompanyCode='"  + mComp + "' and EmployeeId ='" +mDMemberID + "' and YearMonth = '" + myDate + "' and A.PRFlag = 'R'";
if (AdvanceRecovery>0)
  sql = sql+" union select 'AdvRec' EDID, 'AdvRec' EDDES, '" + AdvanceRecovery + "' EDAmount,'0' ArrearAmount,'-1' SEQID from dual ";
if (PFLoanRecovery>0)
...
while(Ded1.next()) 
	  {
		EDID = Ded1.getString("EDDES");
		EDAmt= Ded1.getDouble("EDAmount");
		ArrearAmount= Ded1.getDouble("ArrearAmount");
