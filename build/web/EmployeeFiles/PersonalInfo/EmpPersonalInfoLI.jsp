...
qry =   "Select a.employeeid employeeid, a.employeename employeename,nvl(to_char(a.dateofbirth,'dd/mm/yyyy'),' ')" +
        ...
        " panno,nvl(b.passportno,' ') passportno,b.UANNO,nvl(d.bankname,' ') bankname,nvl(b.AADHARNO,' ') AADHARNO,nvl(caddress1,' ') caddress1,nvl(caddress2,' ' ) " +
...
//out.print(qry);
if(EmployeeRecordSet==null){
out.print("Resulset Null");
}else{
out.print("Resulset Nottttttttt Null");
}
EmployeeRecordSet = db.getRowset(qry);
if (EmployeeRecordSet.next())
{
	   System.out.print("Inside1111111111111111111111---------------------");
   ...
   pEmail = EmployeeRecordSet.getString("emailid");
      System.out.print("Inside 22222222222222222---------------------");
	  out.print("Inside 22222222222222222---------------------");
