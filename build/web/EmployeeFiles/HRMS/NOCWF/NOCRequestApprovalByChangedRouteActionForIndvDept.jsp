...
String mApprAuth="", mApprBy="", mApprovalById="", QryWFCode="";
...
String mMemberName="";
String mInstitute="";
String QryReqDate="", QryRID="", QryFaculty="",  QryWFType="", QryLvDateFr="", QryLvDateTo="", QryLvPurp="";
String QryChDvFor="";
				...
				if(AL1!=null)
				{
					...
					while(itr.hasNext())
					{
						...
						if(rs.next())
						{
							...
							qry=qry+" AND WORKFLOWCODE='"+QryWFCode+"' AND WORKFLOWTYPE='"+QryWFType+"' AND DEPARTMENTCODE='"+mDepartmentCode+"' AND WFSEQUENCE='"+SEQ+"'";
							nnn=db.update(qry);
						}
						else
						{
			...
			*/
			   ...
			   else if(mAddDropLvl.equals("DC"))
			   {
				...
				//-----------------
					...
					qry=qry+" AND WORKFLOWCODE='"+QryWFCode+"' AND WORKFLOWTYPE='"+QryWFType+"' AND DEPARTMENTCODE='"+mDepartmentCode+"' AND WFLEVEL > "+mDelWFLvl+" order by WFLEVEL ASC";
					rs=db.getRowset(qry);
					//out.print(qry);
					while(rs.next())
					{
