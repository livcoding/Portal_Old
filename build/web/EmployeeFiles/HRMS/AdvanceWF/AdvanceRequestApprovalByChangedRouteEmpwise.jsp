...
//-------------------------------------------------------
			if(QryChDvFor.equals("CurrEmp"))
			{
				...
				{
					%>
					<form name="frm" method="POST" ACTION="AdvanceRequestApprovalByChangedRouteActionForIndvEmp.jsp">
...
//---------------Start Of Approval Authority for if(rsFrDept.next())----
						...
						qry=qry+" from WF#EMPWISEWORKFLOWAUTHORITY WHERE CompanyCode='"+mComp+"' and InstituteCode='"+mInst+"' AND WORKFLOWCODE='"+QryWFCode+"'";
