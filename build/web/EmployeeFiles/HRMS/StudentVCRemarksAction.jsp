...
if(mORemarks.equals("Y"))
 {
	qry="INSERT INTO WEB#REMARKSTYPE(INSTITUTECODE, REMARKSTYPE,ENTRYDATE, ENTRYBY)VALUES('"+mInst+"' ,'"+mRemarksType+"' ,sysdate, '"+mChkMemID+"' )";
...
if(n>0)
{
	out.print("<font color=Green size=4><b>Record Saved successfully...</b></font>");
}
else
{
	out.print("<font color=red size=4><b>Error while saving record..</b></font>");
