...
String QryChDvFor="", QryRID="", QryFaculty="", QryWFCode="", QryWFType="", QryDOA="", QryDOR="", QryLvlAuth="";
...
//-------------------------------------------------------
			if(QryChDvFor.equals("CurrDept"))
			{
				...
				{
					%>
					<form name="frm" method="POST" ACTION="LTCRequestApprovalByChangedRouteActionForIndvDept.jsp">
...
//---------------Start Of Approval Authority for if(rsFrDept.next())----
						...
						qry="select Distinct nvl(WFLEVEL,0)WFLEVEL, WFSEQUENCE WFSEQC, APPROVALBY APPRBY, APPROVALAUTHORITY APPRAUTH from WF#WORKFLOWAUTHORITY";
						qry=qry+" WHERE CompanyCode='"+mComp+"' and InstituteCode='"+mInst+"' AND WORKFLOWCODE='"+QryWFCode+"' AND WORKFLOWTYPE='"+QryWFType+"'";
						qry=qry+" AND DEPARTMENTCODE='"+mDeptCode+"' and WFLEVEL=DECODE('"+QryLevelEdit+"',0,WFLEVEL,'"+QryLevelEdit+"') ORDER BY WFLEVEL";
				    		rs=db.getRowset(qry);
						//out.print(qry);
