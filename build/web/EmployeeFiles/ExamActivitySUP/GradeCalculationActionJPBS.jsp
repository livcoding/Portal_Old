...
String qry2="Select ltp, academicyear,PROGRAMCODE, semester,enrollmentno, studentname, studentid,fstid,"+qryadd+","+sumadd+"  Weightage ";
if(!sumadd1.equals(""))
{
qry2+=" , "+sumadd1+" TAWeightage ";
}
qry2+=" from ( select  a.LTP, a.PROGRAMCODE,a.academicyear, a.semester,";
...
qry=" Select nvl(to_char(REGCONFIRMATIONDATE,'dd-mm-yyyy'),' ') REGCONFIRMATIONDATE , nvl(to_char(REGCONFIRMATIONDATE,'yyyymmdd'),' ') REGCONFIRMATIONDATE1    From StudentRegistration Where INSTITUTECODE='"+mInst+"'";
