...
<html>
    ...
    <body>
        ...
        <div id="windowheader" class="ui-widget-header ui-corner-all div" style="height:95px;" >
            ...
            <B><FONT SIZE="4" COLOR="black" >Alumni Feedback Details (Branchwise) </FONT></B>
        ...
        <div style="width: 90%; padding: 10px ;border: .3em solid;border-radius: 25px;margin-left:4%" >
            <table  id="commonmasterid" style="text-align: left;font-size: 18px; border:1px;width:90%">
                ...
                <tr>
                    ...
                    <td width="40%">
                        <select  name='programcode1' id='programcode1'  class='combo' style='width:100%'  title='Program Code'>
                ...
                <tr>
                    <td style="text-align: right;" width="100%" colspan="4" nowrap>
                        <button name="submitbutton_Alumni" id="submitbutton_Alumni"  class="button" style="width:120px;height:25px;margin-left:140px;">Generate Report</button>
                    </td>
                </tr>
            </table>
        </div>
