<%-- 
    Document   : patentTransaction
    Created on : Jul 15, 2015, 9:57:02 AM
    Author     : nipun.gupta
--%>
...
<html>
    <head>
        ...
        <script src="../js/IQTest/patentTransactionJS.js"></script>
        <script>
...
//                    track: true
//                });
                $("#patentFilingDate").datepicker({
                    dateFormat: 'dd-mm-yy',
                    //numberOfMonths: 2,
                    minDate: '-5Y',
                    onSelect: function(selected) {

                        $("#patentValidTillDate").datepicker("option", "minDate", selected)
                    }
                });
                $("#patentValidTillDate").datepicker({
                    // numberOfMonths: 2,
                    dateFormat: 'dd-mm-yy',
                    onSelect: function(selected) {
                        $("#patentFilingDate").datepicker("option", "maxDate", selected)
                    }
                });
            });
        </script>
    ...
    <body >
        ...
        <form name="masterform" >
            ...
            <div id="windowheader" class="ui-widget-header ui-corner-all div" style="width: 100%;height:28px"><div style="width: 60%;float: left;text-align: right;font-size: large">Patent Registered By JIIT Faculty/Students</div><div style="width: 35%;float: left;text-align: right;font-size: large">[Form:QA-AR-4]</div></div> 
            <div style="width: 99%; padding: 10px ;border: .3em solid;border-radius: 25px;" > 
                <table  id="commonmasterid" style="text-align: center;font-size: 18px; border:1px">
                    <tr>
                        ...
                        <td style="text-align: right">Patent Code<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='patentCode' id='patentCode' value='' maxlength='20' class='textbox'  title='Patent Code'/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right">Patent Title<span class="req"> *</span> :</td><td style='text-align: left'><input type='text' name='patentTitle' id='patentTitle' value='' maxlength='100' class='textbox'  title='Patent Title'/></td>
                        <td style="text-align: right">Patent Fee<span class="req"> *</span> :</td><td style="text-align: left"><input type='text' name='patentFee' id='patentFee'  value='' maxlength='14' class='number' style='' title='PatentFee' /></td>
                    </tr>
                    <tr>
                        <td style="text-align: right" >Nature Of Patent<span class="req"> *</span> :</td>
                        <td  style="text-align: left">
                            <select name="natureOfPatent" class='combo' id="natureOfPatent" title='Nature Of Patent'>
                                <option value="0">Select Patent Nature</option>
                                <option value="P">Provisional</option>
                                <option value="F">Full Length</option>
                                <option value="N">National</option>
                                <option value="T">PCT</option>
                            </select>
                        </td>
                        <td style="text-align: right" >Patent Status<span class="req"> *</span> :</td>
                        <td  style="text-align: left">
                            <select name="patentStatus" class='combo' id="patentStatus" title='Patent Status'>
                                <option value="0">Select Patent Status</option>
                                <option value="F">Filed</option>
                                <option value="G">Granted</option>
                            </select>
                        </td>
                    </tr> 
                    <tr>
                        <td style="text-align: right">Patent Filing Date<span class="req"> *</span> :</td><td style="text-align: left"><input type='text' name='patentFilingDate' id='patentFilingDate'  value='' maxlength='100' class='textbox' style='width: 90px;' title='Patent Filing Date' readonly /></td>
                        <td style="text-align: right">Patent Valid Till Date<span class="req"> *</span> :</td><td style="text-align: left"><input type='text' name='patentValidTillDate' id='patentValidTillDate'  value='' maxlength='100' class='textbox' style='width: 90px;' title='Patent Valid Till Date' readonly /></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: right">Patent Remarks :</td><td style="text-align: left"><input type='text' name='patentRemarks' id='patentRemarks'  value='' maxlength='100' class='textbox' style='' title='Patent Remarks' /></td>
                    </tr>
                    <tr>
                   ...
                   <td style="text-align: right">Patent No. :</td><td style="text-align: left"><input type='text' name='patentno' id='patentno' value='' maxlength='20' class='textbox'style='width: 120px;' title='Patent No.'/></td>
                   <td style="text-align: right">Country :<td><td style="text-align: left"><input type=text' name='country' id='country' value='' maxlength='20' class='textbox' style='width: 120px;' title='country'/></td>
                   </tr>
                </table>
            </div>

            <div style="height: 150px;" >
                <table id="patentTransactionTable" style="width: 100%;font-size: 18px;text-align: center;"> 
                    <tr class="_thead">
                        ...
                        <th style="width:5%"><img src="../js/jquery/add.png" title="Add New Row" style="cursor:pointer" class="addPatentTransactionRow" id="addPatentTransactionRow1"/></th>

                    </tr>
                    <tbody class="patentTransactionRow1">
                        <tr>
                            <td id="row1">1.</td>
                    ...
                    <td><img src="../js/jquery/minus.png"  title="Delete Current Row" style="cursor:pointer" class="dPatentTransactionRow" id="dPatentTransactionRow1"/></td>
                    </tr>
                    </tbody>   
                </table>
            </div>
