...
String qryx="";
	ResultSet rsx=null;
			...
			qry="select distinct  INSTITUTECODE ,EXAMCODE , SUBJECTID,SUBJECTCODE,SUBSECTIONCODE,fstid,Subject,count(distinct CLASSTIMEFROM) totcalsses,count(distinct studentid) totstudents from V#StudentAttendance a Where a.subjectid='"+SUBJECTID+"' and a.LTP='"+mLTP+"'  ";
			...
			qry=qry+" group by  institutecode , examcode,SUBJECTCODE,SUBSECTIONCODE,fstid,Subject,SUBJECTID order by SUBJECTCODE,Subject" ;
...
qryx=" select count(distinct studentid)totcalsses1 from V#StudentAttendance a Where  a.LTP='"+mLTP+"' and subjectid='" +rs1.getString("SUBJECTID")+ "' and  SUBSECTIONCODE='" +rs1.getString("SUBSECTIONCODE")+ "' and a.institutecode='" +rs1.getString("institutecode")+ "'  and a.examcode='" +rs1.getString("EXAMCODE")+ "'   ";	
			if(mSubject.equals("ALL"))
...
//------------------------------------------------------
			...
			qryt=" select count(distinct studentid) totstudents1 from V#StudentAttendance a Where  a.LTP='"+mLTP+"' and subjectid='" +rs1.getString("SUBJECTID")+ "' and  SUBSECTIONCODE='" +rs1.getString("SUBSECTIONCODE")+ "'   and a.institutecode='" +rs1.getString("institutecode")+ "'  and a.examcode='" +rs1.getString("EXAMCODE")+ "'   ";	
...
qryt=" select count(distinct studentid) totstudents2 from V#StudentAttendance a Where  a.LTP='"+mLTP+"' and subjectid='" +rs1.getString("SUBJECTID")+ "'  and  SUBSECTIONCODE='" +rs1.getString("SUBSECTIONCODE")+ "'  and a.institutecode='" +rs1.getString("institutecode")+ "'  and a.examcode='" +rs1.getString("EXAMCODE")+ "'   ";	
			qryt=qryt+" and trunc(a.ATTENDANCEDATE) between trunc(decode(to_date('','dd-mm-yyyy'),'',a.ATTENDANCEDATE,to_date('','dd-mm-yyyy')))";
...
qryt=" select count(distinct studentid) totstudents3 from V#StudentAttendance a Where  a.LTP='"+mLTP+"' and subjectid='" +rs1.getString("SUBJECTID")+ "'   and  SUBSECTIONCODE='" +rs1.getString("SUBSECTIONCODE")+ "' and a.institutecode='" +rs1.getString("institutecode")+ "'  and a.examcode='" +rs1.getString("EXAMCODE")+ "'   ";	
			qryt=qryt+" and trunc(a.ATTENDANCEDATE) between trunc(decode(to_date('','dd-mm-yyyy'),'',a.ATTENDANCEDATE,to_date('','dd-mm-yyyy')))";
...
//---------------------------------------------------------------------------------------------------------------------------
			...
			qryt=" select studentid,count(*)noofclass from V#StudentAttendance a Where  a.LTP='"+mLTP+"' and subjectid='" +rs1.getString("SUBJECTID")+ "'  and  SUBSECTIONCODE='" +rs1.getString("SUBSECTIONCODE")+ "'  and a.institutecode='" +rs1.getString("institutecode")+ "'  and a.examcode='" +rs1.getString("EXAMCODE")+ "'   ";	
			qryt=qryt+" and trunc(a.ATTENDANCEDATE) between trunc(decode(to_date('','dd-mm-yyyy'),'',a.ATTENDANCEDATE,to_date('','dd-mm-yyyy')))";
					qryt=qryt+" and trunc(decode(to_date('"+mDate1+"','dd-mm-yyyy'),'',a.ATTENDANCEDATE,to_date('"+mDate1+"','dd-mm-yyyy'))) ";			
			if(mSubject.equals("ALL"))
            qryt=qryt+"  and a.programcode = decode(a.programcode ,'ALL','ALL', a.programcode )  " ;
     ...
     qryt=" select studentid,count(*)noofclass from V#StudentAttendance a Where  a.LTP='"+mLTP+"' and subjectid='" +rs1.getString("SUBJECTID")+ "'  and  SUBSECTIONCODE='" +rs1.getString("SUBSECTIONCODE")+ "'  and a.institutecode='" +rs1.getString("institutecode")+ "'  and a.examcode='" +rs1.getString("EXAMCODE")+ "'   ";
			...
			CNTL30T3++;
	               ...
	               //
					...
					<td align=left ><FONT SIZE="1" ><%=rs1.getString("SUBSECTIONCODE")%></td>
					<%
				


//  multi faculty subjecttagging //--------------------------------------------------------------------

qryc="SELECT distinct  EMPLOYEEID, EMPLOYEENAME  from employeemaster  where nvl(deactive,'N')='N'   ";
qryc=qryc+"  and employeeid in (select distinct EMPLOYEEID from MULTIFACULTYSUBJECTTAGGING where FSTID ='"+rs1.getString("FSTID")+"'   " ;
if (!mInstCode.equals("ALL")) {
			    qryc = qryc + "   AND institutecode='" + mInstCode + "' ";
			}

qryc=qryc+" union  select distinct EMPLOYEEID from v#studentltpdetail where FSTID ='"+rs1.getString("FSTID")+"'   " ;
if (!mInstCode.equals("ALL")) {
			    qryc = qryc + "   AND institutecode='" + mInstCode + "' ";
			}
			 qryc = qryc + "  ) ";
			...
			if (rsc.next())
				{
                %>
				<td><FONT SIZE="1" ><%=rsc.getString("EMPLOYEENAME")%></td>
<%
}else{
%>
...
%>
    ...
    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=80&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL80T1++%></a></td>


 <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=80&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL80T2++%></a></td>

 
 <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=80&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL80T3++%></a></td>


    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=70&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CCNTL70T1++%></a></td>

<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=70&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CCNTL70T2++%></a></td>


<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=70&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CCNTL70T3++%></a></td>





    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=60&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL60T1++%> </a></td>


<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=60&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL60T2++%> </a></td>

<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=60&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL60T3++%> </a></td>



    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=50&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW> <%=CNTL50T1++%> </a></td>

<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=50&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW> <%=CNTL50T2++%> </a></td>

<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=50&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW> <%=CNTL50T3++%> </a></td>


    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=40&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW> <%=CNTL40T1++%> </a></td>

	<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=40&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW> <%=CNTL40T2++%> </a></td>

<td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=40&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW> <%=CNTL40T3++%> </a></td>




    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=30&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL30T1++%> </a></td>

	
    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=30&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL30T2++%> </a></td>

	
    <td ALIGN=LEFT><a href="Facultywiseattnpercentdetail.jsp?ViewType=CNF&amp;INSTITUTE=<%=mInstCode%>&amp;EXAMCODE=<%=mEXAMCODE%>&amp;PROGRAMCODE=<%=mSubject%>&amp;LTP=<%=mLTP%>&amp;SUBJECTCODE=<%=rs1.getString("SUBJECTCODE")%>&amp;SUBJECT=<%=rs1.getString("Subject")%>&amp;SUBCODE=<%=rs1.getString("SUBSECTIONCODE")%>&amp;FLAG=30&amp;TNOOFCLASS=<%=rs1.getInt("totcalsses")%>" target=NEW><%=CNTL30T3++%> </a></td>
...
//					usum50t1=0,usum50t2=0,usum50t3=0,vsum40t1=0,vsum40t2=0,vsum40t3=0,wsum30t1=0,wsum30t2=0,wsum30t3=0;
					%>
                    <tr><td>&nbsp;</td> <td>&nbsp;</td><td>&nbsp;</td><td align="left"><STRONG>Total Count(% Wise):</STRONG></td><td><font color="red"><%=rsum80t1%></font></td>
