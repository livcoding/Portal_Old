<%--
    Document   : SaveGradeCalculationsupple
    Created on : 23 Dec, 2017, 2:17:23 PM
    Author     : VIVEK.SONI
--%>
...
String mSemType="",mSem="",mETOD="N",mSem1="",del2="";
...
//System.out.println("444444"+qryll);
  //out.print(qryi);
while(rsi.next())
{
...
if(rs6.next())
{
    //System.out.println("66.rs6.next()");
	mStatus=1;
}
else
{
...
Set mGradeUnChecked=new HashSet();
   	...
   	while(itun.hasNext())
   {
		...
		// System.out.println("TYYYYYYYYYYYYYYYVVVVVVVVVVVVVVYYYYYYYYYYYYYY");
