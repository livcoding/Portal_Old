...
<%
        ...
        ResultSet rs = null, rs1=null, rs2=null,rs3=null,rsd=null,rsINS=null;
		String qryINS="",qryPts="";
		...
		String SumTotal="",PRORATA="",qryd="",PRORATA1="",PRORATA2="",PRORATA3="",PRORATA4="",UFMMARKS3="",UFMMARKS2="",UFMMARKS1="";
						...
						String MEDICAL1="",MEDICAL2="",MEDICAL3="",mDetained="N";
...
//System.out.print("JILIT - "+qry2);
		...
		qry=qry+" where institutecode='"+mIC+"' and nvl(DEACTIVE,'N')='N' and nvl(PROCEEDSECOND,'N')='N' and nvl(locked,'N')='N' and nvl(PUBLISHED,'N')='N' and  nvl(STUDENTLTPDEACTIVE,'N')='N' and studentid   IN  (select studentid from studentregistration  where nvl(REGALLOW,'N')='Y' and EXAMCODE='"+mEC+"'  and institutecode='"+mIC+"'   ) and ";
...
//and subjectID='"+mSC+"'
        ...
        while (rs.next())
        {
			Upd=0;
				Ins=0; 
			mNMFSTID="";
             mNMFSTID=rs.getString("fstid");
				//System.out.print("************"+mNMFSTID);
				ctr++;
                String CTR=ctr+".";
...
qry2=" select NVL(A.DEBAR,'N')DEBAR,NVL(A.MEDICALCASE,'N')MEDICALCASE,NVL(A.ABSENTCASE,'N')ABSENTCASE,NVL(A.UFM ,'N')UFM,NVL(A.UFMMARKS ,'N')UFMMARKS,NVL(A.PRORATA,'N')PRORATA from DEBARSTUDENTDETAIL a  WHERE a.EXAMCODE='"+mEC+"' AND   A.EVENTSUBEVENT='"+mEvent+"' and a.fstid = '"+rs.getString("fstid")+"'  and a.INSTITUTECODE='"+mIC+"' and a.STUDENTID='"+mSID+"' AND A.SUBJECTID='"+mSC+"' and nvl(a.DEACTIVE,'N')='N' ";
//AND   A.EVENTSUBEVENT='"+mEvent+"' "; rollbaked 12/27/2013 add condition
...
// System.out.println(" ----------- mSM"+rs.getString("fstid"));
 ...
 if(mSMarks.equals("P"))
{
                ...
                try
                {
                qryINS="Select 'Y' From StudentEventSubjectMarks Where FSTID='"+mNMFSTID+"' and EVENTSUBEVENT='"+mEvent+"' and STUDENTID='"+mSID+"'";
                //System.out.println(qry);
                rsINS=db.getRowset(qryINS);
                if(!rsINS.next())
                {
                qryINS = "Insert Into StudentEventSubjectMarks (FSTID, EVENTSUBEVENT, STUDENTID, MARKSAWARDED1, MARKSAWARDED2, DETAINED, LOCKED, ENTRYDATE, ENTRYBY, DEACTIVE, DETAINED2) VALUES (";
                qryINS += "'" +mNMFSTID+ "',";
                qryINS += "'" + mEvent + "',";
                qryINS += "'" +mSID+ "',";
                qryINS += "'" + mSMarks + "',";
                ...
                qryINS += "'" + mDetained + "'";
                qryINS += ") ";
                  Ins=db.insertRow(qryINS);
                //System.out.println("INSERT-"+qry);
                %><BR><%
                }
                else
                {
                qryPts="Update StudentEventSubjectMarks set MARKSAWARDED1='"+mSMarks+"', MARKSAWARDED2='"+mSMarks+"', DETAINED='"+mDetained+"', DETAINED2='"+mDetained+"' Where FSTID='"+mNMFSTID+"' and EVENTSUBEVENT='"+mEvent+"' and STUDENTID='"+mSID+"'";
                
                  Upd=db.update(qryINS);
            ...
            else if(mSMarks.equals("D"))
            {
//System.out.println(mSMarks);
				...
				//System.out.println("UPDATE - "+qryINS);
			 
		
                Upd=db.update(qryINS);
                
				//System.out.println(Upd+"UPDATE ATER -"+qryINS);
...
else if(mSMarks.equals("M"))
            {
               ...
               //  System.out.println(qry);
                ...
                qryPts="Update StudentEventSubjectMarks set MARKSAWARDED1='"+mSMarks+"', MARKSAWARDED2='"+mSMarks+"', DETAINED='"+mDetained+"', DETAINED2='"+mDetained+"' Where FSTID='"+mNMFSTID+"' and EVENTSUBEVENT='"+mEvent+"' and STUDENTID='"+mSID+"'";
                  ...
                  Upd=db.update(qryINS);
                //System.out.println("UPDATE - "+qryINS);%><BR><%
                }
                }
                catch(SQLException e)
                {
...
///===end
                ...
                a++;
						//System.out.println("<bR>JILIT%%%%"+mSMarks+"%%%%%%%%"+rs.getString("studentid")+">>>"+curRecord);
