<%@ page language="java" import="java.sql.*,tietwebkiosk.*,eba.gethandler.Record, eba.savehandler.SaveHandler,java.net.InetAddress,java.net.NetworkInterface,java.net.SocketException,java.net.UnknownHostException"%>
...
<%
 ...
 //System.out.println("************++++++++++++++******************");
		...
		String qry = "",qry2="",qry1="",qry3="",qry123="";
        String mMemberID="",mMemberType="",mMemberCode="",StudID="",Fstid="";
        String mDMemberType="",mDMemberID="";
        String mComp="UNIV", mSelf="", mIC="", mEC="", mSC="", mList="", mOrder="", mEvent="", mSE="",MemCode="";
...
*/
	...
	mDMemberID=enc.decode(mMemberID);
        MemCode=enc.decode(mMemberCode);
...
///System.out.println(mMarks+" ____$$___"+insertRecords[i].getField("studentid"));
      String  qry1234="delete from Temp#MacAddress";
               int d=db.update(qry1234);


            qry123="insert into Temp#MacAddress (MacAddress,LOGEMPLOYEECODE) values('"+macaddress+"','"+MemCode+"')";
           // System.out.println("qry123 : "+qry123);
           try{ Ins123=db.insertRow(qry123);}catch(Exception e){System.out.println(e);}
         //   System.out.println("qry1234 : "+qry123);
            ...
            if(mMarks.equals(""))
            {
               ...
               // System.out.println(qry);
                ...
                {
                qry="Update StudentEventSubjectMarks set MARKSAWARDED1='"+mMarks+"', MARKSAWARDED2='"+mMarks+"', DETAINED='"+mDetained+"', DETAINED2='"+mDetained+"' Where FSTID='"+insertRecords[i].getField("fstid")+"' and EVENTSUBEVENT='"+mEvent+"' and STUDENTID='"+insertRecords[i].getField("studentid")+"'";
                db.update(qry);
          ...
          //System.out.println("UPDATE - "+qry);%><BR><%
            ...
            else if(Double.parseDouble(mMarks)>=0 && Double.parseDouble(mMarks)<=mMaxmarks)
            {
               ...
               //System.out.println("***-----------"+qry);
                ...
                {
                qry="Update StudentEventSubjectMarks set MARKSAWARDED1='"+mMarks+"', MARKSAWARDED2='"+mMarks+"', DETAINED='"+mDetained+"', DETAINED2='"+mDetained+"'  ,entrydate=sysdate  Where FSTID='"+insertRecords[i].getField("fstid")+"' and EVENTSUBEVENT='"+mEvent+"' and STUDENTID='"+insertRecords[i].getField("studentid")+"'";
                db.update(qry);
                int Upd=db.update(qry);
                  //System.out.println("UPDATE - "+qry);%><BR><%
                }
