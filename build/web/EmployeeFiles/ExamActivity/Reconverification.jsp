...
try
{
               ...
               if(fromemp.equalsIgnoreCase("dean")){%>
                ...
                <%}else if(fromemp.equalsIgnoreCase("y")){%>
                 ...
                 <table border="0" align="center">
                     ...
                     <tbody>
                         <tr>
                             <td> <INPUT Type="submit" Value="PRINT" onclick="window.print()"></td>
                         </tr>
                     </tbody>
                 </table>
   ...
   break;
       ...
       <font color="red" size="3"><b>Not Updated Record  <%=notupdated%></b>              </font>
     <%  }
 ...
 <% }else
{
  ...
  " and employeeid='"+selectedEmp+"' and eventsubevent='"+selectedDBEvent+"' and foreventsubevent='"+selectedEvent+"' ";
     ...
     if(isupda>0){
     out.println("&nbsp;&nbsp;&nbsp <b><font size=3 face='Arial' color='Blue'> Record Locked Successfully </font> <br>");
     }
   }
}
  }
