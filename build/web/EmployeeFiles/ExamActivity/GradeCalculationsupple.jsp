			...
			if(!rs.next())
			{
				...
				qry=qry+" and   eventsubevent Like 'TA%' Group By A.EVENTSUBEVENT, A.WEIGHTAGE ORDER BY EVENTSUBEVENT,nvl(A.WEIGHTAGE,0)";
                               ...
                               // out.println(qry);
                                ...
                                //request.getParameter("ExamCode").toString().trim()
...
//String qrySup="Select nvl(SUPFEES,0)SUPFEES,nvl(PREVEXAMCODE,'')PREVEXAMCODE from exammaster where  examcode='"+mEC+"' and institutecode='"+mInst+"' and nvl(SUPFEES,0)>10";
//ResultSet RsSup=db.getRowset(qrySup);

//if(RsSup.next()){

   // String PrevEXAM=RsSup.getString("PREVEXAMCODE").toString().trim();

    //session.setAttribute("PrevEXAM", PrevEXAM);
  %>
