...
qrymass="   select MASSCUTS,TATOTAL,MARKSAWARDED from  STUDENTGRADEMASSCUTS where fstid='"+rs1.getString("fstid")+"' and studentid='"+rs1.getString("studentid")+"'  and examcode='"+mEC+"'  " ;
...
qrymass="   select ATTENDANCEPERCENTAGE,MASSCUTS,TATOTAL,MARKSAWARDED from  STUDENTGRADEMASSCUTS where fstid='"+rs1.getString("fstid")+"' and studentid='"+rs1.getString("studentid")+"'  and examcode='"+mEC+"'  " ;
rsmass=db.getRowset(qrymass);
