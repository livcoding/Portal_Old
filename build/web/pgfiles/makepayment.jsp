...
TransactionRequestBean objTransactionRequestBean = new TransactionRequestBean();
    ...
    objTransactionRequestBean.setStrMerchantCode("L554891");  //T2835 for test and amount must be 2 user will be test and password will be test
    objTransactionRequestBean.setMerchantTxnRefNumber(strTranID);
    //objTransactionRequestBean.setStrAmount(feeAmt);
    pHostelType="N";
    objTransactionRequestBean.setStrAmount(strTxnAmount);                        // to be change
    ...
    String schema="FIRST_"+strTxnAmount+"_0.0";
   ...
   // objTransactionRequestBean.set
    ...
    objTransactionRequestBean.setStrReturnURL("https://webkiosk.jiit.ac.in/pgfiles/tempaction.jsp");//http://172.16.5.219:8084 //https://webkiosk.juet.ac.in
